-- ===========================================================
-- ملف موحد: رفع migrations 0278 + 0279 + 0333 للإنتاج
-- المشروع: ujzzvqsodyhnnnpkoaml
-- التاريخ: 2026-08-12
-- طريقة الاستخدام:
...
-- تسجيل migrations في schema_migrations
INSERT INTO supabase_migrations.schema_migrations(version, name, statements) VALUES
  ('0278', 'weekly_rest_comp_and_holidays_hardening', 'applied via dashboard'),
  ('0279', 'friday_weekend_attendance_fix', 'applied via dashboard'),
  ('0333', 'friday_work_override_and_comp_submission', 'applied via dashboard')
ON CONFLICT (version) DO NOTHING;

-- تحديث PostgREST لتفعيل RPCs الجديدة/المعدّلة
NOTIFY pgrst, 'reload schema';

COMMIT;

-- ===========================================================
-- انتهى. تحقق بالاستعلامات التالية:
-- SELECT code, affects_balance, is_active FROM leave_types WHERE code = 'weekly_rest_comp';
-- SELECT (public.get_attendance_dashboard('2026-08-07'))->>'isWeekend' as friday_weekend;
-- SELECT (public.get_attendance_dashboard('2026-08-07'))->>'absent' as friday_absent;
-- ===========================================================
