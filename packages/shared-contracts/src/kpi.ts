...
export const kpiWorkflowStatusSchema = z.enum([
  ...
  'OVERDUE',
  'NOT_STARTED',
  'EMPLOYEE_INPUT_IN_PROGRESS',
  'HR_DATA_PENDING',
  'SESSION_SCHEDULED',
  'SESSION_COMPLETED',
  'MANAGER_EVALUATION_IN_PROGRESS',
  'HR_EVALUATION_IN_PROGRESS',
  'EMPLOYEE_ACKNOWLEDGEMENT_PENDING',
...
export const kpiEvaluationSummarySchema = z.object({
  ...
  workflowStatus: kpiWorkflowStatusSchema.catch('DRAFT'),
  locked: z.boolean().optional(),
  editable: kpiStageSchema.nullable().optional(),
  finalScore: z.number().nullable(),
  finalRating: z.string().nullable(),
  finalBreakdown: z.record(kpiCriterionCodeSchema, z.number()).nullable().optional(),
  managerComment: z.string().nullable().optional(),
  hrComment: z.string().nullable().optional(),
  criteria: z.array(kpiCriterionSchema).optional(),
