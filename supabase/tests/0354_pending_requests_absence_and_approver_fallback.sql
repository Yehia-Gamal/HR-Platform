...
-- يغطي: توسيع أنواع سير العمل، تعريفات التشغيل الافتراضية، المعتمِد البديل
-- (fallback) عند غياب المدير المباشر، عرض «بانتظار الاعتماد» في كشف الشهر،
-- وتفعيل إعفاء الفاندي بعد الاعتماد.
...
-- =====================================================================
-- (2) تعريفات سير العمل الافتراضية للتشغيل أُنشئت في Migration 0353.
-- =====================================================================
select is(
  ...
  3,
  'تعريفات سير عمل تشغيلية افتراضية (مأمورية/قافلة/فاندي)');
...
select ok(
  ...
  'اعتماد الفاندي يُنشئ حضورًا ليوم 07-13');
