-- 0188: إصلاح عرض صلاحيات الأدوار ذات الوصول الكامل
-- ═══════════════════════════════════════════════════════════════════
-- المشكلة: get_access_admin_catalog يستعلم فقط من role_permissions
-- لجلب صلاحيات كل دور. الأدوار ذات is_full_access=true (مثل admin
-- و executive-secretary) ليس لديها صفوف في role_permissions — تعتمد
-- على current_is_full_access() لتجاوز كل الفحوصات. نتيجة: تظهر
-- "0 صلاحية" في واجهة الإدارة.
--
-- الحل: إضافة CASE في الاستعلام — إذا كان الدور full_access يعيد
-- كل الصلاحيات من الكتالوج.
-- ═══════════════════════════════════════════════════════════════════
