-- 0072: Fix log_audit_event call signature in request_live_location
-- Migration 0071 called log_audit_event with 4 args but the function requires 8.
-- This migration redeploys the function with the correct call signature.
...
begin
  ...
  -- استدعاء صحيح: 8 معاملات (event_type, category, severity, table, id, summary, description, metadata)
