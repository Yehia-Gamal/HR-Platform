-- 0179: إصلاح سياسة الحضور لأدوار الإدارة الرئيسية
-- الأدوار الإدارية (admin, executive-secretary, ...) لا تحتاج بصمة حضور
-- يصلح اختبار 0045 test 43: "executive secretary uses Main Admin web without attendance"
...
begin
  ...
  return jsonb_build_object(
    ...
    'attendancePolicy', jsonb_build_object(
      -- البصمة تظهر لكل الموظفين ما عدا التنفيذي والأدمن الرئيسي
