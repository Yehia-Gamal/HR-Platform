-- ============================================================================
-- 0189 — update_employee_admin: دعم إدخال المسمى الوظيفي والدرجة كنص حر
--   • jobTitleName: نص حر → يبحث عن مسمى موجود أو ينشئ جديداً
--   • gradeName: نص حر → يبحث عن درجة موجودة أو ينشئ جديدة
--   المفاتيح النصية تُحوَّل لمعرّفات UUID قبل تطبيق UPDATE
-- ============================================================================
...
-- الصلاحيات — نفس التوقيع، لا حاجة لإعادة REVOKE/GRANT
-- (التوقيع لم يتغير: uuid, jsonb, text)
