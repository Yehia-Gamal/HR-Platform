-- Migration 0176: V23 §14 — توسيع كشف الحضور الشهري
-- إضافة حقول V23 المطلوبة في shared-contracts:
--   يومي: isAbsent, isOfficialHoliday, hasLatePermit, hasEarlyPermit, notes, penalties
--   ملخص: totalRequiredHours, attendanceRate, hoursComplianceRate
begin;
...
comment on function public._build_attendance_statement(uuid, integer, integer) is
  'V23 §14: دالة مشتركة تبني كشف الحضور والانصراف الشهري مع حقول V23 (isAbsent, isOfficialHoliday, hasLatePermit, hasEarlyPermit, notes, penalties, totalRequiredHours, attendanceRate, hoursComplianceRate).';

-- الصلاحيات لم تتغير — _build محظورة أصلاً
