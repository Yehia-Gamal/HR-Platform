-- ============================================================================
-- 0472: ملخص HR بتوقيت القاهرة — إغلاق آخر بند في تدقيق فئة حدود اليوم
-- ============================================================================
-- get_hr_reports_summary كانت تحسب «اليوم» و«هذا الشهر» وحالة الإجازة
-- بتوقيت UTC: بين 00:00 و03:00 فجراً تُنسب أحداث المساء ليومٍ سابق،
-- ويُصنَّف الموظف العاطل إجازته اليوم «غير عاطل» (تواريخ الإجازة قاهرية).
-- التوحيد على توقيت القاهرة في الموضعين الأربعة.
-- ============================================================================
