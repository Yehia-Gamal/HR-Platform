...
-- =====================================================================
-- 0219 — فهارس Trigram للبحث العربي + فهارس أداء إضافية
-- =====================================================================
--
-- لا يمكن تشغيل CREATE INDEX CONCURRENTLY داخل كتلة BEGIN/COMMIT،
-- لذلك يستخدم هذا الملف التوجيه `supabase:no-transaction` أعلاه
-- لمنع Supabase CLI من لفّ الملف في معاملة تلقائية.
--
