-- =====================================================================
-- 0150: إصلاح صلاحية request_live_location — السماح لأدوار full-access.
-- =====================================================================
-- المشكلة: الدالة في 0128 تتحقق فقط من أدوار executive / executive-director
-- باستخدام current_has_active_role، لكن المستخدم بدور admin (full-access)
-- لا يملك هذين الدورين فيُرفض طلبه بخطأ 42501.
-- الحل: إضافة current_is_full_access() كشرط بديل.
