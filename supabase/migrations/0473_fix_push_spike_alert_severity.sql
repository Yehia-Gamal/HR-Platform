-- =====================================================================
-- 0473: إصلاح خطورة تنبيه فيض الإشعارات — P2 غير مسموح بقيد system_alerts
-- ---------------------------------------------------------------------
-- الجذر: 0467 أدخل تنبيه notification_push_failures_spike بخطورة 'P2'
-- لكن قيد system_alerts_severity_check يسمح فقط بـ ('P0','P1') — فانهارت
-- الدالة عند أول محاولة رفع التنبيه (رُصد في CI بتشغيل الاختبارات).
-- الإصلاح: استبدال قياسي كامل للدالة بخطورة 'P1' للفيض، مع بقاء
-- dispatch_stalled وoutbox_lag على 'P1' كما هي. لا تغيير سلوكي آخر.
-- =====================================================================
