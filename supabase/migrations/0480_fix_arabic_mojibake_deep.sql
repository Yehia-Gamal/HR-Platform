-- 0480: إصلاح جذري لترميز الحروف العربية المكسورة في مصادر الدوال (119+ دالة نُشرت عبر مسار مكسور الترميز)
-- العكس: WIN1252 → UTF8 انتقائياً على المقاطع المطابقة فقط — العربي السليم لا يُمس
-- دوال مُصلحة: 299

-- can_view_live_location_video(uuid)
...
AS $function$
begin
  -- V12 §9: ا�?ف�?د�?�? �?�?غ�? �?�?ائ�?�?ا �? ترجع false دائ�?�?ا.
  return false;
end $function$;

-- close_kpi_cycle(uuid)
...
AS $function$
begin
 return public.manage_kpi_cycle(p_cycle_id,'close','إغ�?ا�? �?�? أ�?ر ا�?ت�?اف�? ا�?�?عت�?د',null);
end $function$;

-- send_kpi_notifications_admin(uuid)
CREATE OR REPLACE FUNCTION public.send_kpi_notifications_admin(p_cycle_id uuid DEFAULT NULL::uuid)
 RETURNS integer
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
  -- أ) ا�?د�?ا�? ا�?�?ساعدة + د�?ا�? KPI ا�?حرجة
  ...
  -- �?�?) ص�?اح�?ات EXECUTE ع�?�? �?�? ا�?ت�?�?�?عات ا�?�?�?ش�?رة
  ...
  -- �?) �?بضة بس�?طة �? استدعاء get_kpi_admin_catalog ا�?ح�?�?�?�?
  begin
  ...
  -- ز) �?بضة بس�?طة �? استدعاء create_kpi_cycle_admin ا�?ح�?�?�?�? �?ع فرض rollback
  if v_template_id is not null and v_policy_id is not null then
    ...
    exception when others then
      ...
      if v_sqlerrm like '__DIAG_FORCE_ROLLBACK__%' then
        v_cycle_attempt := 'OK �? �?جحت ا�?دا�?ة (�?�? تُحفظ ا�?د�?رة بسبب ا�?تراجع ا�?تشخ�?ص�?)';
      else
        v_cycle_attempt := format('ERR %s: %s | %s', v_sqlstate, v_sqlerrm, v_ctx);
      end if;
    end;
  else
    v_cycle_attempt := 'SKIPPED �? �?ا �?ا�?ب رس�?�? �?شط أ�? �?ا س�?اسة �?شطة';
  end if;
...
-- withdraw_escalation(uuid,text)
CREATE OR REPLACE FUNCTION public.withdraw_escalation(p_request_id uuid, p_reason text)
 RETURNS requests
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
  ...
  values(p_request_id, public.current_employee_id(), 'comment',
    coalesce(p_reason, 'سحب ا�?تصع�?د'));

  perform public.log_audit_event('request.escalation.withdrawn', 'workflow', 'info',
    'requests', p_request_id, 'سحب تصع�?د ا�?ط�?ب', p_reason, '{}'::jsonb);
  return v_req;
end $function$;

-- process_request_sla(integer)
...
begin
  ...
  loop
    -- �?�? ا�?خط�?ة ا�?�?�?ائ�?ة (أب�? ع�?ار أ�? أ�? �?رح�?ة >= 2): �?ا تر�?�?ة أبعد �?�?
    --    ف�?ط تذ�?�?ر د�?ر�? �?أب�? ع�?ار �?إعادة ضبط ا�?�?�?�?ة (24 ساعة).
    if v_row.step_order >= 2 then
      if v_ops_emp is not null then
        ...
        perform public.notify_employee(
          v_ops_emp,
          'تذ�?�?ر: ط�?ب �?�? �?ُبت�?�? ف�?�? بعد',
          coalesce(v_row.title, '') || ' �? �?حتاج �?رار�? ا�?آ�? (ا�?�?د�?ر).
ا�?�?د�?ر ا�?�?باشر �?�? �?بت�? �?ا�?ط�?ب �?ح�?�?�?�? �?�? �?�?رار �?�?ائ�?.',
      ...
      -- صفِ�?ر deadline �?�?�?ع ت�?رار ا�?تذ�?�?ر ا�?ف�?ر�? (24 ساعة �?�? ا�?آ�?)
      update public.request_steps
    ...
    -- �?�? ا�?خط�?ة 1 (ا�?�?د�?ر ا�?�?باشر): تصع�?د إ�?�? ا�?خط�?ة 2 (أب�? ع�?ار) �?�?
    select * into v_next
    ...
    -- �?س�?�? ا�?خط�?ة ا�?حا�?�?ة �?�? escalated + خ�?�?�? �?�?�?ت�?ا 24 ساعة.
    -- (0465: �?ا�? �?ُتر�? deadline ف�? ا�?�?اض�? ف�?ع�?د ا�?�?cron اخت�?ار�?ا �?�? 5 د�?ائ�?!)
    update public.request_steps
    ...
    if v_next.id is not null then
      ...
      -- فع�?�? ا�?خط�?ة ا�?تا�?�?ة (أب�? ع�?ار) �? �?�?�?ة ساعت�?�?
      update public.request_steps
        set status = 'active',
      ...
      insert into public.request_actions(
        ...
        'تصع�?د ت�?�?ائ�? �? تجا�?ز �?�?�?ة ا�?�?د�?ر ا�?�?باشر (ساعتا�?)',
        jsonb_build_object('tier', v_next.step_order, 'targetRole', v_role)
      );

      -- إشعار أب�? ع�?ار (ا�?خط�?ة 2)
      if v_target is not null then
        perform public.notify_employee(
          v_target,
          'ط�?ب �?ح�?�?�?�? إ�?�?�? �? �?د�?ر ا�?تشغ�?�? 1',
          coalesce(v_row.title, '') || ' �? �?�?�?�?�? ا�?بت ف�?�? ا�?آ�?.',
          'request', 'high', 'request', v_row.request_id,
          jsonb_build_object(
            'escalation', v_role,
            'deepLink', '/requests/' || v_row.request_id
      ...
      -- إشعار ا�?�?د�?ر ا�?ت�?ف�?ذ�? (�?ا�?�? ا�?شاشة) ع�?د ا�?تصع�?د ا�?أ�?�? ف�?ط
      ...
      -- �?ا ت�?جد خط�?ة تا�?�?ة (ط�?ب �?د�?�? ب�?ا ب�?�?ة): تصع�?د عا�?
      update public.requests
...
begin
  if v_me is null then
    raise exception '�?ا �?�?جد �?�?ظف �?رتبط بحساب�?' using errcode = '42501';
  end if;
  if p_latitude is null or p_longitude is null then
    raise exception 'ا�?إحداث�?ات �?ط�?�?بة' using errcode = '22023';
  end if;
  if p_latitude not between -90 and 90 or p_longitude not between -180 and 180 then
    raise exception 'ا�?إحداث�?ات خارج ا�?�?طا�?' using errcode = '22023';
  end if;

  v_duration := greatest(1, least(coalesce(p_duration_minutes, 60), 1440));

  -- �?§�?�?�?�?�?¯�?�?�?± �?§�?�?�?ª�?�?�?�?�?�?°�?�? �?§�?�?�?�?�?³�?ª�?�?�?¯�? (�?§�?�?�?¥�?¹�?¯�?§�?¯ leave_escalation_notify_role �?º�?�?�?± �?�?�?�?�?§�?³�?¨ �?�?�?�?�?§ â�?�?
  -- �?�?�?³�?ª�?®�?¯�?�? executive_director_role �?�?�?¨�?§�?´�?±�?© �?¨�?¯�?�?�?± executive-director)
  ...
  if exists (
    ...
    raise exception '�?د�?�? �?شار�?ة �?�?�?ع �?شطة با�?فع�?' using errcode = '23505';
  end if;
  ...
  insert into public.live_location_requests (
    ...
    v_me, v_exec_emp, trim(coalesce(p_reason, '�?�?�?´�?§�?±�?�?�?© �?�?�?�?�?�?�?¹ �?§�?³�?ª�?¨�?§�?�?�?�?�?©')),
    'active', 'safety',
  ...
  if v_exec_emp is not null then
    ...
    if v_exec_user is not null then
      insert into public.notifications (
        ...
        format(
          '%s �?�?�?´�?§�?±�?�?�?�? �?�?�?�?�?�?�?¹�?�? �?§�?�?�?¢�?�?%s',
          coalesce((select full_name_ar from public.employees where id = v_me), '�?�?�?�?�?¸�?'),
...
-- batch_decide_requests(uuid[],text,text)
CREATE OR REPLACE FUNCTION public.batch_decide_requests(p_request_ids uuid[], p_decision text, p_comment text DEFAULT NULL::text)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
BEGIN
  ...
  IF p_decision NOT IN ('approved', 'rejected') THEN
    RAISE EXCEPTION 'ERR_INVALID_DECISION: �?جب أ�? �?�?�?�? approved أ�? rejected';
  END IF;
  ...
  PERFORM public.log_audit_event(
    ...
    'requests',
    NULL,
    '�?رار ج�?اع�? ع�?�? ' || v_count || ' ط�?ب (' || p_decision || ')',
...
-- list_credentials(text,boolean)
CREATE OR REPLACE FUNCTION public.list_credentials(p_category text DEFAULT NULL::text, p_active_only boolean DEFAULT true)
 RETURNS TABLE(key_name text, category text, secret_hint text, metadata jsonb, is_active boolean, rotated_at timestamp with time zone, expires_at timestamp with time zone, created_at timestamp with time zone)
 LANGUAGE plpgsql
 SECURITY DEFINER
...
BEGIN
  IF NOT public.current_is_full_access() THEN
    RAISE EXCEPTION 'ERR_FORBIDDEN'
      USING HINT = 'list_credentials �?تط�?ب ص�?اح�?ة full-access';
  END IF;
...
begin
  if v_actor_id is null then
    raise exception 'غ�?ر �?صرح' using errcode = '42501';
  end if;
...
begin
  ...
  if v_req.employee_id = v_me
    ...
    raise exception 'ا�?اعت�?اد ا�?ذات�? غ�?ر �?س�?�?ح' using errcode = '42501';
  end if;

  -- �?§�?�?�?®�?·�?�?�?© �?§�?�?�?­�?§�?�?�?�?�?©: �?�?�?�?¶�?�?�?�? �?§�?�?�?®�?·�?�?�?© �?§�?�?�?�?�?´�?·�?© (active)�?�? �?�?�?¥�?�? �?�?�?�? �?ª�?�?�?¬�?¯ �?�?�?£�?®�?°
  -- �?£�?�?�?�? escalated/pending (�?¥�?µ�?�?�?§�?­ 0403).
  select * into v_step
  from public.request_steps
  ...
  -- â�?�?â�?�? �?§�?�?�?µ�?�?�?§�?­�?�?�?© â�?�?â�?�?
  -- �?§�?�?�?�?�?¯�?�?�?± �?§�?�?�?�?�?¨�?§�?´�?± + HR (0441) + full_access: �?¯�?§�?¦�?�?�?§�?�? (�?£�?�? �?�?�?±�?­�?�?�?©�?�? �?£�?�? �?�?�?�?�?ª)
  -- �?£�?¨�?�? �?¹�?�?�?§�?± (operations-manager-1): �?�?�?�? �?§�?�?�?®�?·�?�?�?© 2 �?�?�?�?§ �?�?�?�?�?�?�? �?£�?�? �?¹�?�?�?¯�?�?�?§ �?ª�?�?�?�?�?�? �?�?�?�?�?�?�?©
  --   �?§�?�?�?®�?·�?�?�?©/�?§�?�?�?·�?�?�?¨ �?�?�?ª�?¬�?§�?�?�?²�?© (�?·�?�?�?¨�?§�?ª �?�?�?¯�?�?�?�?�?© �?¹�?§�?�?�?�?�?© â�?�? 0440).
  if not found then
    v_authorized :=
...
-- record_attendance_local_biometric(uuid,text,double precision,double precision,double precision,boolean)
...
begin
  ...
  -- 0460: �?�? �?�?³ �?¥�?µ�?�?�?§�?­ record_attendance_event (::timestamp �?§�?�?�?µ�?±�?Š�?­ �?�?�?¨�?�? at time zone).
  ...
  -- Accuracy fallback chain: geofence.max_accuracy â�? �? settings â�? �? 100
  ...
  perform public.log_audit_event(
    ...
    'attendance_events', v_event_id, '�?¨�?µ�?�?¦�?© �?�?¦�?­�?�?�?Š�?© �?�?¦�?�?�?«�?�?�?© �?¯�?§�?®�?�? �?�? �?·�?§�?�? �?§�?�?�?�?¦�?¬�?�?¦�?¹', null,
    jsonb_build_object(
...
-- execute_admin_action(uuid,text)
CREATE OR REPLACE FUNCTION public.execute_admin_action(p_case_id uuid, p_notes text)
 RETURNS void
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO ''
...
begin
  ...
  perform public.log_audit_event(
    ...
    'ت�?ف�?ذ إجراء: ' || v.approved_administrative_action,
    trim(p_notes),
    jsonb_build_object(
...
begin
  ...
  if p_employee_id is null then
    raise exception 'ا�?�?�?ظف �?ط�?�?ب' using errcode = '22023';
  end if;
  ...
  if p_request_type not in ('leave','mission','convoy','fundraising') then
    raise exception 'تر�?�?ز ا�?�?�?�? �?دع�? ا�?إجازة �?ا�?�?أ�?�?ر�?ة �?ا�?�?اف�?ة �?ا�?فا�?د�? ف�?ط' using errcode = '22023';
  end if;
  ...
  if p_request_type = 'leave' then
    ...
    if v_leave_type not in ('annual','casual','sick','unpaid','weekly_rest_comp') then
      raise exception '�?�?ع إجازة غ�?ر �?دع�?�?' using errcode = '22023';
    end if;
  ...
  if p_request_type = 'leave' then
    ...
    if v_leave_type = 'casual' then
      ...
      perform public.log_audit_event(
        ...
        '�?ª�?�?�?�?�?�?° �?�?�?�?±�?�? �?�?�?¥�?¬�?§�?²�?© �?¹�?§�?±�?¶�?©',
        format('�?�?�?�? %s �?¥�?�?�?�? %s', v_start_date, v_end_date),
...
begin
  if v_manager_id is null then
    raise exception '�?ا �?�?جد �?�?ف �?�?ظف �?رتبط بحساب�?' using errcode = '42501';
  end if;

  if p_from is null or p_to is null or p_to < p_from or p_to > p_from + 45 then
    raise exception '�?طا�? ت�?ار�?خ ا�?ع�?�?�?ات غ�?ر صا�?ح' using errcode = '22023';
  end if;
...
-- tg_notify_awareness_on_request_submit()
...
begin
  ...
  -- ا�?�?د�?ر ا�?ت�?ف�?ذ�? (�?�?إط�?اع ف�?ط�? بد�?�? ص�?اح�?ة �?رار ف�? �?ذ�? ا�?�?رح�?ة)
  for v_emp_id in
  ...
  -- HR (�?�?�?تابعة ف�?ط�? بد�?�? ص�?اح�?ة �?رار إ�?ا بعد 6 ساعات)
  for v_emp_id in
    select distinct e.id
    from public.employees e
    join public.user_roles ur on ur.user_id = e.user_id
...
begin
  if not (public.current_is_full_access() or public.has_any_permission(array['system.settings.read','settings.read','system.manage','system.error.view'])) then
    raise exception '�?ص�?�? �?ظرة ا�?�?ظا�? �?رف�?ض' using errcode = '42501';
  end if;
  return jsonb_build_object(
...
begin
  if v_user_id is null then
    raise exception '�?�?ز�? تسج�?�? ا�?دخ�?�? أ�?�?ا�?' using errcode = '28000';
  end if;

  select p.employee_id, coalesce(e.full_name_ar, '�?�?�?³�?ª�?®�?¯�?�? �?§�?�?�?�?�?¸�?§�?�?'), e.employee_code, e.photo_url
  ...
  if not found then
    raise exception '�?ا �?�?جد �?�?ف �?�?ظف �?شط' using errcode = '42501';
  end if;
  ...
  if v_is_executive then
    ...
    raise exception '�?ا ت�?جد �?ساحة ع�?�? �?ع�?�?ة' using errcode = '42501';
  end if;
...
CREATE OR REPLACE FUNCTION public.get_cron_health()
 RETURNS TABLE(job_name text, last_run timestamp with time zone, minutes_ago numeric, last_status text, is_healthy boolean)
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
AS $function$
BEGIN
  -- �?س�?�?ح ف�?ط �?�?: full-access أ�? service_role
  IF auth.role() <> 'service_role' AND NOT public.current_is_full_access() THEN
...
begin
 ...
 if not v_locked then
  ...
  -- استث�?اءات HR �?تاحة ف�? أ�? �?رح�?ة غ�?ر �?�?ف�?ة (0470)
 ...
 if v_editable='manager_review' and v_eval.workflow_status='SUBMITTED_TO_DIRECT_MANAGER' then
  ...
  perform public.log_audit_event('kpi.manager.review_started','workflow','info','kpi_evaluations',v_eval.id,'بدء ا�?�?د�?ر ا�?�?باشر �?راجعة ا�?ت�?�?�?�?',null,null);
 end if;
...
begin
  if length(trim(coalesce(p_reason,''))) < 10 then raise exception '�?رج�? إدخا�? ا�?سبب' using errcode='22023'; end if;
  if not (public.current_is_full_access() or public.has_permission('system.release.manage')) then
    raise exception 'سحب ا�?ج�?از �?رف�?ض' using errcode='42501';
  end if;
  ...
  if not found then raise exception '�?�? �?ت�? ا�?عث�?ر ع�?�? ا�?ج�?از' using errcode='P0002'; end if;
...
begin
  ...
  if v_result is null then
    raise exception '�?�?ف ا�?�?�?ظف غ�?ر �?�?ج�?د' using errcode = 'P0002';
  end if;
...
-- tg_work_assignment_participant_link()
    ...
    if extract(isodow from v_day) = 5 then
      ...
      if v_type_id is not null then
        ...
        perform public.apply_leave_ledger_entry(
          ...
          null,
          'رص�?د بد�? راحة أسب�?ع�? ع�? ت�?�?�?ف ع�?�? �?�?�? ا�?ج�?عة ' || to_char(v_day, 'YYYY-MM-DD'),
...
-- issue_dispute_decision(uuid,uuid,text,text,text,uuid,timestamp with time zone)
CREATE OR REPLACE FUNCTION public.issue_dispute_decision(p_case_id uuid, p_session_id uuid, p_text text, p_rationale text, p_outcome text, p_owner_id uuid DEFAULT NULL::uuid, p_due_at timestamp with time zone DEFAULT NULL::timestamp with time zone)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
 ...
 if p_owner_id is not null then
  ...
  perform public.enqueue_dispute_notification(p_case_id,p_owner_id,'implementation:'||v_id::text,'إجراء �?ط�?�?ب �?ت�?ف�?ذ �?رار','�?رج�? ت�?ف�?ذ ا�?إجراء ا�?�?س�?د �?تسج�?�? إثبات ا�?ت�?ف�?ذ.',case when p_due_at is not null and p_due_at<now()+interval '48 hours' then 'urgent' else 'high' end);
 else
 ...
 perform public.log_audit_event('dispute.decision_issued','workflow','warning','dispute_decisions',v_id,'إصدار �?رار ا�?�?ج�?ة',null,jsonb_build_object('caseId',p_case_id,'decisionNumber',v_number));
 perform public.enqueue_dispute_notification(p_case_id,v_case.actor_employee_id,'decision:actor:'||v_id::text,'صدر �?رار ف�? ا�?�?ش�?�?ة','�?�?�?�?�? ا�?اط�?اع ع�?�? ا�?�?رار �?تأ�?�?د است�?ا�?�? �?�? �?س�? ا�?ش�?ا�?�?.','high');
 perform public.enqueue_dispute_notification(p_case_id,dp.employee_id,'decision:party:'||v_id::text,'صدر �?رار ف�? ا�?�?ش�?�?ة','�?�?�?�?�? ا�?اط�?اع ع�?�? ا�?جزء ا�?�?صرح ب�? �?�? ا�?�?رار.','high') from public.dispute_parties dp where dp.case_id=p_case_id and dp.party_type in ('respondent','related') and dp.notified_at is not null;
 return v_id;
end $function$;
...
begin
  if p_action_id is null or p_kind is null or position(v_prefix in lower(p_action_id)) <> 1 then
    raise exception '�?عر�?ف إجراء غ�?ر صا�?ح' using errcode = '22023';
  end if;
  ...
  case lower(p_kind)
    when 'request' then
      ...
      if not v_allowed then raise exception '�?ا ت�?�?�? ص�?اح�?ة ع�?�? �?ذا ا�?�?�?ظف' using errcode='42501'; end if;
...
-- admin_activate_employee_after_password_set(uuid)
...
begin
  ...
  -- �?�?رأ حا�?ة ا�?�?�?ظف �?ب�? ا�?تعد�?�? (�?أغراض ا�?تد�?�?�?) �?�?�?ت�?ط user_id ا�?�?رتبط.
  ...
  -- إذا �?ا�? �?�?ا�?�?ا �?شطا�? با�?فع�?�? �?ا ش�?ء �?فع�?�? �? �?ُع�?د �?ب�?را�?.
  ...
  -- �?ُفع�?�? ا�?�?�?ظف ف�?ط �?�? �?ا�? ف�? حا�?ة �?ا �?ب�? ا�?تفع�?�?. �?�? �?ا�? ف�? حا�?ة
  -- �?ت�?د�?ة (�?ث�? suspended / notice_period) �?ا �?غ�?�?ر�?ا �? �?�?�? �?ض�?�? is_active=true
  -- حت�? �?ا تُ�?ف�? ب�?�?ابة identifier-sign-in ا�?فرع�?ة ف�? is_active.
  ...
  -- �?ُفع�?�? profile �?�?ُز�?�? ع�?�? temporary_password.
  -- tg_profiles_protect_sensitive تس�?ح �?�? service_role بت�?ر�?ر أ�? تغ�?�?ر
  -- �?أ�? current_is_full_access()=true ف�? �?ذا ا�?س�?ا�?.
  ...
  -- �?سج�?�? ا�?حدث ف�? سج�? ا�?تد�?�?�? �?�?ض�?ح ا�?رغبة ا�?إدار�?ة.
  perform public.log_audit_event(
    ...
    'employees',
    p_employee_id,
    'تفع�?�? حساب بعد تع�?�?�? �?�?�?ة �?ر�?ر �?د�?�?ا�? �?�? ا�?إدارة',
    null,
    jsonb_build_object(
...
begin
  if p_employee_id is null or p_user_id is null or nullif(trim(p_credential_id), '') is null then
    raise exception '�?�?�?ة ج�?از �?�?ث�?�? �?ط�?�?بة' using errcode = '22023';
  end if;
  if not exists (
    select 1 from public.employees
  ...
  -- passkey_credentials �?ª�?¨�?�?�?�? active (�?�?�?�? credential �?�?�?�?�?�?©�?�? �?�?�?�?�?³�?ª �?³�?�?�?§�?³�?© �?�?�?�?�?§�?�?�?�?©)
  insert into public.passkey_credentials(
    ...
    p_transports, left(coalesce(p_device_label, '�?�?�?§�?ª�? �?§�?�?�?�?�?�?�?¸�?'), 120),
  ...
  insert into public.employee_devices(
    ...
    left(coalesce(p_device_label, '�?�?�?§�?ª�? �?§�?�?�?�?�?�?�?¸�?'), 120), 'android', 'pending', now(),
    jsonb_build_object(
      'serverVerified', true,
...
begin
 ...
 if p_target_stage<>'self' or v_eval.current_stage<>'manager_review' then
   raise exception 'KPI_FLOW_SIMPLIFIED: ا�?إرجاع ا�?�?تاح ف�?ط manager_review �? self' using errcode='22023';
 end if;
 ...
 perform public.log_audit_event('kpi.stage_returned','workflow','notice','kpi_evaluations',v_eval.id,
  'إعادة ا�?ت�?�?�?�? �?�?�?�?ظف (0470)',p_note,null);
 return v_eval;
end $function$;

-- tg_notify_manager_late_arrival()
...
begin
  ...
  -- ج�?ب ا�?�?د�?ر ا�?�?باشر (أ�?�? �?د�?ر ف�? manager_relations)
  ...
  v_late_text := case
    when new.late_minutes >= 60 then
      (new.late_minutes / 60)::text || ' ساعة ' || (new.late_minutes % 60)::text || ' د�?�?�?ة'
    else
      new.late_minutes::text || ' د�?�?�?ة'
  end;

  -- إدراج ا�?إشعار �? ا�?�? trigger trg_notifications_queue_jobs �?ُض�?ف notification_jobs ت�?�?ائ�?ا�?
  insert into public.notifications (
    recipient_user_id,
    ...
    v_manager.user_id,
    v_manager.id,
    '�?�?ظف �?تأخر: ' || coalesce(v_employee.full_name_ar, 'غ�?ر �?حدد'),
    'سج�?�? ' || coalesce(v_employee.full_name_ar, 'ا�?�?�?ظف') || ' حض�?ر�? �?تأخرا�? ب�?�?دار ' || v_late_text || '.',
    'system',
    'normal',
    'attendance_event',
    new.id,
...
exception
  when others then
    -- ا�?إشعار اخت�?ار�? �? �?ا �?عط�?�? تسج�?�? ا�?حض�?ر
    return new;
end;
$function$;

-- save_kpi_compliance_metric(uuid,text,integer,integer,integer,integer,text)
CREATE OR REPLACE FUNCTION public.save_kpi_compliance_metric(p_evaluation_id uuid, p_metric text, p_required integer, p_actual integer, p_exempt integer DEFAULT 0, p_cancelled integer DEFAULT 0, p_note text DEFAULT NULL::text)
 RETURNS numeric
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
 select * into strict v_eval from public.kpi_evaluations where id=p_evaluation_id for update;
 -- 0470: �?ا ب�?ابة �?راح�? �? �?�?ف�? أ�? �?�?�?�? ا�?ت�?�?�?�? غ�?ر �?�?ف�? �?ا�?�?ُدخ�? �?�? �?راجع�? HR
 ...
 perform public.log_audit_event('kpi.compliance.calculated','workflow','info','kpi_evaluations',p_evaluation_id,'احتساب �?ع�?ار HR',null,jsonb_build_object('metric',p_metric,'score',v_score));
 return v_score;
end $function$;
...
begin
  if length(trim(coalesce(p_idempotency_key,''))) < 8 then raise exception '�?فتاح �?�?ع ا�?ت�?رار �?ط�?�?ب' using errcode='22023'; end if;
...
-- grant_weekly_rest_credit(uuid,date,integer)
CREATE OR REPLACE FUNCTION public.grant_weekly_rest_credit(p_employee_id uuid, p_work_date date, p_days integer DEFAULT 1)
 RETURNS integer
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
  ...
  while v_count < p_days loop
    ...
    perform public.apply_leave_ledger_entry(
      ...
      null,
      '�?�?ح بد�? راحة �?د�?�? ع�? �?�?�? ' || to_char(v_day, 'YYYY-MM-DD'),
...
AS $function$
begin
  -- ع�?د �?ضع إدارة �?أساس�?ة�? أز�? ا�?ع�?ا�?ة �?�? ا�?إدارات ا�?أخر�? �?�?فس ا�?�?�?ظف
...
begin
  ...
  -- �?�? إجازة �?عت�?دة: on_leave (�?ع ح�?ا�?ة أ�?ا�? ا�?ع�?�? ا�?�?عت�?دة ا�?أخر�?) �?�?
  if new.request_type = 'leave' and new.status = 'approved' then
    ...
    while v_day <= v_lr.end_date loop
      -- �?�?�? �?غط�?�? ب�?أ�?�?ر�?ة/�?اف�?ة/فا�?د�?/ت�?�?�?ف �?عت�?د = �?�?�? ع�?�? �? �?ا �?ُع�?�?�?�? إجازة
      v_covered := exists (
        select 1 from public.requests r
  ...
  if new.request_type in ('mission','convoy','fundraising') and new.status = 'approved' then
    ...
    if v_start is null then
      ...
      -- ضبط ا�?خا�?ات ا�?خاصة با�?ط�?ب �?�? payload (�?ت�?اف�?ة �?ع �?راءة ا�?�?شف �?ا�?تراجع)
      if new.request_type = 'mission'
        ...
        values (
          ...
          (case when new.payload->>'endTime' is not null
                ...
                else null end), -- endDate �?حد�? => �?�?تصف �?�?�? �?�?ا�?ت�?; �?فس ا�?�?�?�? ب�?ا endTime => NULL (�?ا �?خر�? ck_convoy_period)
          new.created_by
        );
      end if;
    end if;
    ...
    v_day := v_start;
    while v_day <= v_end loop
      -- بص�?ة حض�?ر ف�? أ�?�? �?�?�? (�?�? �?�?ت بدء ا�?�?أ�?�?ر�?ة إ�? �?ُجد �? بد�?�? بص�?ة = حض�?ر �?ُسج�?�?�?)
      v_punch := null;
      ...
      -- بص�?ة ا�?صراف ف�? آخر �?�?�? (�?�?ت �?�?ا�?ة ا�?�?أ�?�?ر�?ة إ�? �?ُجد �? �?ُسج�?�?�? ا�?ا�?صراف ع�?د ا�?ا�?تداد خارج ا�?ع�?�?)
      ...
      -- بد�? ا�?راحة ا�?أسب�?ع�?: ا�?ج�?عة خ�?ا�? �?أ�?�?ر�?ة/�?اف�?ة/فا�?د�?
      if extract(isodow from v_day) = 5 then
        select id into v_type_id from public.leave_types where code = 'weekly_rest_comp';
        if v_type_id is not null then
          v_year := extract(year from v_day)::integer;
          perform public.apply_leave_ledger_entry(
            ...
            null,
            'بد�? راحة أسب�?ع�? ع�? �?�?�? ع�?�? ف�? ' || new.request_type || ' بتار�?خ ' || to_char(v_day, 'YYYY-MM-DD'),
    ...
    perform public.log_audit_event(
      ...
      'ت�? تع�?�?�? أ�?ا�? ' || new.request_type || ' ا�?�?عت�?دة �?حض�?ر ع�?�? (present) ب�?ا خص�?',
      format('�?�? %s إ�?�? %s', v_start, v_end),
...
-- _build_attendance_statement_v186(uuid,integer,integer)
  ...
  while v_day <= v_end loop
    ...
    -- �?�? �?�? ر�?ستر راحة/عط�?ة�?
      ...
      v_status := case (select rd.day_status from public.roster_days rd
                   ...
                   when 'rest' then 'راحة أسب�?ع�?ة'
                   else 'عط�?ة رس�?�?ة' end;
      if v_status = 'راحة أسب�?ع�?ة' then v_rest_days := v_rest_days + 1;
      else
        v_holiday_days := v_holiday_days + 1;
        v_is_holiday := true;
      end if;
      ...
      if exists (
        ...
        v_status := coalesce(
          (select case wa.assignment_type
                   when 'MISSION' then '�?أ�?�?ر�?ة ع�?�?'
                   when 'CONVOY' then '�?اف�?ة'
                   when 'FUNDRAISING' then 'فا�?د�?'
                 end
           ...
           limit 1),
          '�?أ�?�?ر�?ة ع�?�?');
        if v_status = '�?أ�?�?ر�?ة ع�?�?' then v_mission_days := v_mission_days + 1;
        else v_convoy_fundi_days := v_convoy_fundi_days + 1; end if;
      -- �?أ�?�?ر�?ة �?د�?�?ة (missions table)?
      elsif exists (
      ...
      -- �?أ�?�?ر�?ة/�?اف�?ة/فا�?د�? �?�? payload ا�?ط�?بات (ا�?�?صدر ا�?حا�?�? �?�?تطب�?�?)?
      elsif exists (
        select 1 from public.requests r
      ...
      -- حاضر/�?تأخر/جزئ�?/غائب
        ...
        v_status := case v_row.status
          ...
          when 'late' then '�?تأخر'
          when 'partial' then 'حض�?ر �?ا�?ص'
          when 'pending' then '�?حتاج �?راجعة'
          when 'absent' then 'غائب د�?�? إذ�?'
          else coalesce(v_row.status, 'غائب د�?�? إذ�?')
        end;
    ...
    if exists (select 1 from public.attendance_corrections c
      ...
      if v_status = 'غائب د�?�? إذ�?' or v_status = '�?حتاج �?راجعة' then
        v_status := 'تصح�?ح �?عت�?د';
        -- ا�?تصح�?ح �?ُ�?غ�? ا�?غ�?اب
        if v_is_absent then
          v_is_absent := false;
    ...
    if v_row.id is not null and v_row.status not in ('on_leave','holiday','weekend')
       and v_status not like '%عط�?ة%' and v_status not like '%راحة%'
       and v_status <> 'إجازة �?عت�?دة' and v_status not like '%�?أ�?�?ر�?ة%'
       and v_status not like '%�?اف�?ة%' and v_status not like '%فا�?د�?%' then
    ...
    v_day_obj := jsonb_build_object(
      ...
      'dayNameAr', case extract(isodow from v_day)
        when 1 then 'ا�?اث�?�?�?' when 2 then 'ا�?ث�?اثاء' when 3 then 'ا�?أربعاء'
        when 4 then 'ا�?خ�?�?س' when 5 then 'ا�?ج�?عة' when 6 then 'ا�?سبت' when 7 then 'ا�?أحد' end,
...
-- acknowledge_kpi_evaluation(uuid,text,text)
CREATE OR REPLACE FUNCTION public.acknowledge_kpi_evaluation(p_evaluation_id uuid, p_note text DEFAULT NULL::text, p_appeal_reason text DEFAULT NULL::text)
 RETURNS kpi_evaluations
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
 ...
 if coalesce(trim(p_appeal_reason),'')<>'' then
  ...
  perform public.log_audit_event('kpi.result.acknowledged','workflow','notice','kpi_evaluations',v_eval.id,
   'إ�?رار ا�?�?�?ظف ب�?ت�?جة ت�?�?�?�?�?',nullif(trim(p_note),''),null);
 end if;
 return v_eval;
end $function$;

-- remove_employee_department(uuid,uuid)
CREATE OR REPLACE FUNCTION public.remove_employee_department(p_employee_id uuid, p_department_id uuid)
 RETURNS boolean
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
  ...
  --   live_location_request (�?¨�?§�?�?�?¥�?¶�?§�?�?© �?¥�?�?�?�? �?§�?�?�?µ�?�?�?º�?© �?§�?�?�?¬�?�?�?¹�?�?�?© live_location_requests)
  ...
  if v_resolved_kind = 'live_location_request' then
    ...
    if not (
      ...
      raise exception '�?ا ت�?�?�? ص�?اح�?ة ع�?�? �?ذا ا�?�?�?ظف' using errcode = '42501';
    end if;
...
begin
  ...
  if p_employee_ids is null or array_length(p_employee_ids, 1) is null then
    raise exception '�?�?ظف �?احد ع�?�? ا�?أ�?�? �?ط�?�?ب' using errcode = '22023';
  end if;
...
-- add_kpi_evidence(uuid,uuid,text,text,text,text,text)
CREATE OR REPLACE FUNCTION public.add_kpi_evidence(p_evaluation_id uuid, p_criterion_id uuid, p_type text, p_title text, p_description text DEFAULT NULL::text, p_storage_path text DEFAULT NULL::text, p_external_url text DEFAULT NULL::text)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
 ...
 perform public.log_audit_event('kpi.evidence.added','workflow','info','kpi_evidence',v_id,'إضافة د�?�?�? إ�?�? ا�?ت�?�?�?�?',null,jsonb_build_object('evaluationId',p_evaluation_id,'criterionId',p_criterion_id));
 return v_id;
end $function$;
...
begin
 ...
 loop
  ...
  insert into public.kpi_scores(evaluation_id,criterion_id,score,reviewer_stage,note,created_by)
  values(v_eval.id,v_eval.criterion_id,v_score,'hr','�?حس�?ب آ�?�?�?ا �?�? ا�?حض�?ر �?ا�?ا�?صراف �?ا�?استث�?اءات �?ا�?ت�?�?�?فات ا�?�?عت�?دة',auth.uid())
  ...
  if v_old is distinct from v_score then
   perform public.log_audit_event('kpi.attendance.recalculated','workflow','notice','kpi_evaluations',v_eval.id,'إعادة حساب درجة ا�?حض�?ر',null,jsonb_build_object('oldScore',v_old,'newScore',v_score,'late',v_late,'earlyLeave',v_early,'absence',v_absent,'missingPunch',v_missing,'shortagePenalty',v_shortage,'pending',v_pending));
  end if;
  v_count:=v_count+1;
 end loop;
 return v_count;
...
begin
  ...
  -- â�?â�?â�? �?§�?�?�?­�?¶�?�?�?± â�?â�?â�?
  -- attendance_events: event_type = 'CHECK_IN'/'CHECK_OUT' (�?£�?­�?±�? �?�?�?¨�?�?�?±�?©)
  -- event_at (timestamptz) â�?�? �?�?�?§ �?�?�?�?�?¬�?¯ �?¹�?�?�?�?�?¯ event_date
  ...
  -- â�?â�?â�? �?§�?�?�?¥�?¬�?§�?²�?§�?ª â�?â�?â�?
  -- leave_requests �?�?�?§ �?�?�?­�?ª�?�?�?�? �?¹�?�?�?�? �?¹�?�?�?�?�?¯ status â�?�? �?§�?�?�?­�?§�?�?�?© �?�?�? �?¬�?¯�?�?�?�? requests �?¹�?¨�?± request_id
  select jsonb_build_object(
    'totalRequests', count(*),
  ...
  -- â�?â�?â�? �?§�?�?�?ª�?�?�?�?�?�?�?�?§�?ª â�?â�?â�?
  -- work_assignments.status �?¨�?£�?­�?±�? �?�?�?¨�?�?�?±�?©: APPROVED, IN_PROGRESS, COMPLETED, DRAFT, SUBMITTED, PENDING_APPROVAL ...
  select jsonb_build_object(
    'total',     count(*),
  ...
  -- â�?â�?â�? �?�?�?¤�?´�?±�?§�?ª �?§�?�?�?£�?¯�?§�?¡ â�?â�?â�?
  -- kpi_cycles.status: draft, open, in_review, suspended, finalized, locked (�?£�?­�?±�? �?µ�?º�?�?�?±�?©)
  -- kpi_evaluations �?�?�?§ �?�?�?­�?ª�?�?�?�? �?¹�?�?�?�? �?¹�?�?�?�?�?¯ status â�?�? �?�?�?³�?ª�?®�?¯�?�? workflow_status (�?£�?­�?±�? �?�?�?¨�?�?�?±�?©)
  select jsonb_build_object(
...
-- kpi_resolve_approver_for_employee(uuid)
...
begin
  ...
  -- بد�?�? 1: أ�?�? �?�?ظف فع�?ا�? بد�?ر hr-manager
  ...
  -- بد�?�? 2: أ�?�? �?�?ظف فع�?ا�? بد�?ر executive-secretary
  select e.id into v_mgr
    from public.employees e
    join public.profiles pr on pr.employee_id = e.id and pr.status = 'active'
    join public.user_roles ur on ur.user_id = pr.id
...
-- create_my_dispute(text,text,text,uuid,text,boolean)
CREATE OR REPLACE FUNCTION public.create_my_dispute(p_title text, p_description text, p_case_type text DEFAULT 'other'::text, p_respondent_employee_id uuid DEFAULT NULL::uuid, p_severity text DEFAULT 'normal'::text, p_confidential boolean DEFAULT true)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
 return public.submit_my_dispute(p_title,p_description,
  ...
  '[]'::jsonb,null,null,null,'�?تابعة ا�?�?ش�?�?ة �?اتخاذ ا�?إجراء ا�?�?�?اسب',p_confidential,true,true);
end $function$;

-- can_view_isolated_employee(uuid)
...
begin
  ...
  -- �?فس ا�?�?س�? ا�?�?عز�?�? (ز�?�?�? ف�? ا�?إدارة ا�?طب�?ة)
  if exists (
    select 1
  ...
  -- ا�?�?د�?ر ا�?�?باشر (ع�?ا�?ة إشراف سار�?ة)
  if exists (
...
-- tg_work_assignment_attendance_link()
...
begin
  ...
  -- اعت�?اد (ب�?ا ف�?�? ا�?إ�?شاء بحا�?ة APPROVED �?�? create_work_assignment)
  if new.status = 'APPROVED' then
    ...
    loop
      ...
      while v_day <= v_end loop
        ...
        -- بد�? ا�?راحة ا�?أسب�?ع�? ع�? ا�?ج�?عة ض�?�? ا�?ت�?�?�?ف
        if extract(isodow from v_day) = 5 then
          select id into v_type_id from public.leave_types where code = 'weekly_rest_comp';
          if v_type_id is not null then
            v_year := extract(year from v_day)::integer;
  ...
  -- إ�?غاء/رفض بعد اعت�?اد: تراجع ع�? ا�?أ�?ا�? غ�?ر ا�?�?ثبتة �?ا �?�? �?غط�?�?ا اعت�?اد آخر
...
-- can_see_directory_entry(uuid,uuid)
...
begin
  ...
  return coalesce((
    ...
    where e.is_active  = true
     ...
     and public.can_see_directory_entry(public.current_employee_id(), e.id)  -- 0444: �?ªº�?ª�?�?ª¬�?ª¿�?ª�?£�?ªº�?ª» �?ªº�?ä�?à�?ª»�?è�?ª�? �?ªº�?ä�?ª¬�?å�?ü�?è�?ª�?�?è
      and (
        v_search is null
...
begin
  ...
  -- �?ª�?�?�?§�?�?�? �?®�?�?�?�?�?: emergency â�?�? casual (�?�?�?�?³ submit_my_request 0401).
  ...
  v_row := public._submit_request_for(
    ...
    null,
    v_manager,
    coalesce(nullif(trim(p_title),''), '�?¥�?¬�?§�?²�?© ' || p_leave_type),
    trim(p_reason),
    v_payload);
  ...
  if p_leave_type = 'casual' then
    ...
    perform public.log_audit_event(
      'leave.casual.immediate', 'workflow', 'info', 'requests', v_row.id,
      '�?ª�?�?�?�?�?�?° �?�?�?�?±�?�? �?�?�?¥�?¬�?§�?²�?© �?¹�?§�?±�?¶�?© (�?¥�?�?�?´�?§�?¡ �?¥�?¯�?§�?±�?�?)',
      format('�?�?�?�? %s �?¥�?�?�?�? %s', p_start_date, p_end_date),
      jsonb_build_object('days', v_days, 'employeeId', p_employee_id));
  end if;
...
-- get_attendance_day_roster(date,text,text,uuid,uuid,uuid,text,text,integer,integer)
...
begin
  ...
  with visible_employees as (
    ...
    select distinct on (e.employee_id) e.employee_id,
           case
             when e.verification_status = 'failed' then '�?ü�?ª�?¤�?ä �?ªº�?ä�?ª¬�?ª¡�?é�?é �?à�?å �?ªº�?ä�?ç�?ê�?è�?ª�?'
             when e.latitude is null or e.longitude is null then '�?ä�?ªº �?è�?ê�?ª¼�?ª» �?à�?ê�?é�?ª�?£ �?à�?ªñ�?â�?ª»'
             when e.accuracy_meters is not null and e.accuracy_meters > 100 then '�?ª»�?é�?ª�? GPS �?à�?å�?ª«�?ü�?ª�?¢�?ª�?'
             when e.distance_meters is not null and e.distance_meters > 0 then '�?ª«�?ªº�?ª�?�?ª¼ �?ªº�?ä�?å�?ª�?�?ªº�?é �?ªº�?ä�?à�?ª�?£�?ª¬�?à�?ª»'
             when e.status = 'flagged' then '�?ªú�?�?�?ª�?¤�?ª�?£�?�?�?ª�? �?ª¬�?ä�?é�?ªº�?ªª�?è�?ï�?ªº �?ä�?ä�?à�?ª�?�?ªº�?ª¼�?ª�?£�?ª�?'
             else '�?è�?ª¡�?ª¬�?ªº�?ª¼ �?à�?ª�?�?ªº�?ª¼�?ª�?£�?ª�? �?ª¿�?ª�?¤�?ª�?�?è�?ª�?'
           end as reason
      from events_day e
...
-- _cleanup_user_sessions_and_push(uuid,text)
CREATE OR REPLACE FUNCTION public._cleanup_user_sessions_and_push(p_user_id uuid, p_reason text DEFAULT 'device_revoked'::text)
 RETURNS void
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
  if not public.current_is_full_access() then
    raise exception '�?ا ت�?�?�? ص�?اح�?ة �?اف�?ة �?�?ذا ا�?إجراء' using errcode = '42501';
  end if;
  ...
  if v_device is null then
    raise exception '�?�? �?ت�? ا�?عث�?ر ع�?�? ا�?ج�?از' using errcode = 'P0002';
  end if;
...
-- tg_mission_execution_close_on_cancel()
  ...
  if new.status in ('rejected','cancelled','withdrawn','expired') then
    update public.mission_executions
       set status     = 'completed',
           ...
           report     = coalesce(report, 'أُ�?غ�? ا�?ط�?ب �?ب�? إت�?ا�? ا�?ت�?ف�?ذ'),
           updated_at = now()
...
-- start_offboarding_case(uuid,text,text,date,date,uuid,jsonb)
CREATE OR REPLACE FUNCTION public.start_offboarding_case(p_employee_id uuid, p_reason_type text, p_reason text, p_notice_date date, p_last_working_date date, p_handover_employee_id uuid DEFAULT NULL::uuid, p_clearance_items jsonb DEFAULT NULL::jsonb)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
 ...
 if p_clearance_items is null then p_clearance_items:='[{"category":"manager","title":"تس�?�?�? ا�?�?�?ا�? �?ا�?�?عرفة"},{"category":"assets","title":"إعادة ج�?�?ع ا�?ع�?د"},{"category":"it","title":"إ�?غاء ا�?�?ص�?�? ا�?ت�?�?�?"},{"category":"hr","title":"�?راجعة ا�?�?�?ف �?ا�?�?ست�?دات"},{"category":"finance","title":"ا�?تس�?�?ة ا�?�?ا�?�?ة ا�?�?�?ائ�?ة"}]'::jsonb; end if;
...
begin
  if not (
    ...
    raise exception 'غ�?ر �?صرح بتغ�?�?ر حا�?ة ا�?�?�?ظف' using errcode = '42501';
  end if;
...
begin
  if auth.uid() is null or v_employee_id is null then
    raise exception '�?�?ز�? حساب �?�?ظف �?سج�?�? ا�?دخ�?�?' using errcode = '42501';
  end if;
...
begin
  ...
  if not (v_is_executive or v_has_attendance_access) then
    raise exception 'ص�?اح�?ة ت�?ف�?ذ�? أ�? حض�?ر �?ط�?�?بة' using errcode = '42501';
  end if;
  ...
  return coalesce((
    ...
    where e.status = 'active'
      and e.is_deleted = false
      and not public.is_employee_executive(e.id)  -- 0444: �?§�?³�?ª�?¨�?¹�?§�?¯ �?§�?�?�?�?�?¯�?�?�?± �?§�?�?�?ª�?�?�?�?�?�?°�?�?
      -- �?�?�?�?ª�?± �?§�?�?�?�?�?³�?�?
      and (p_department_id is null or e.department_id = p_department_id)
      -- �?�?�?�?ª�?± �?§�?�?�?¨�?­�?«
      and (v_search is null
...
-- transition_job_offer_admin(uuid,text)
CREATE OR REPLACE FUNCTION public.transition_job_offer_admin(p_offer_id uuid, p_action text)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
...
begin
  ...
  perform public.log_audit_event('recruitment.offer_'||v_next,'workflow','info','job_offers',p_offer_id,
    'ا�?ت�?ا�? حا�?ة عرض ت�?ظ�?ف', null, jsonb_build_object('applicationId',v_app,'from',v_current,'to',v_next));
  return jsonb_build_object('offerId', p_offer_id, 'status', v_next);
end $function$;

-- hire_from_application_admin(uuid)
CREATE OR REPLACE FUNCTION public.hire_from_application_admin(p_application_id uuid)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'auth'
...
begin
  ...
  perform public.log_audit_event('recruitment.application_hired','workflow','notice','applications',p_application_id,
    'اعت�?اد تع�?�?�? �?رشح', null, jsonb_build_object('candidateName',v_candidate.full_name));
  return jsonb_build_object(
...
declare
  ...
  v_end        date      := (v_local::date) - 1;   -- �?£�?�?�?³
  v_start      date      := v_end - 6;            -- �?¢�?®�?± 7 �?£�?�?�?§�?�? �?´�?§�?�?�?�?�?©
...
begin
  ...
  -- �?µ�?�?�?§�?º�?© �?¬�?³�?�? �?§�?�?�?¥�?´�?¹�?§�?± (�?¹�?±�?¨�?�?�?�? �?�?�?®�?ª�?µ�?±).
  v_body := '�?§�?�?�?�?�?�?�?®�?µ �?§�?�?�?£�?³�?¨�?�?�?¹�?�? �?�?�?�?�?­�?¶�?�?�?± (' || to_char(v_start, 'DD/MM/YYYY') || ' - '
             || to_char(v_end, 'DD/MM/YYYY') || '): '
             || '�?­�?¶�?�?�?± ' || coalesce((v_summary->>'present')::text,'0')
             || '�?�? �?ª�?£�?®�?± ' || coalesce((v_summary->>'late')::text,'0')
             || '�?�? �?º�?�?�?§�?¨ ' || coalesce((v_summary->>'absent')::text,'0')
             || '�?�? �?¥�?¬�?§�?²�?© ' || coalesce((v_summary->>'onLeave')::text,'0')
             || '. �?�?�?³�?¨�?© �?§�?�?�?ª�?£�?®�?± ' || coalesce((v_summary->>'lateRate')::text,'0') || '%'
             || '�?�? �?�?�?³�?¨�?© �?§�?�?�?º�?�?�?§�?¨ ' || coalesce((v_summary->>'absentRate')::text,'0') || '%.'
             || ' �?£�?¹�?�?�?�? �?§�?�?�?�?�?ª�?£�?®�?±�?�?�?�?: ' || coalesce(
  ...
  -- �?¥�?¯�?±�?§�?¬ �?¥�?´�?¹�?§�?± �?�?�?�?�?�? �?�?�?³�?ª�?®�?¯�?�? �?�?�?�?�?�?�?�? reports.attendance.read �?£�?�? �?¯�?�?�?± full-access.
  -- �?�?�?�?­�?¯�?�?�?¯ �?§�?�?�?�?�?³�?ª�?®�?¯�?�?�?�?�?�? �?¹�?¨�?± user_roles �?§�?�?�?�?�?±�?ª�?¨�?·�?© �?¨�?�? role_permissions/permissions
  -- �?£�?�? �?¨�?�? roles.is_full_access=true. �?�?�?�?�?­�?�?�?�? employee_id �?¹�?¨�?± profiles.
  with recipients as (
    -- full-access
  ...
  perform public.log_audit_event(
    ...
    'attendance_daily', null, '�?ª�?�?�?�?�?�?�?¯ �?§�?�?�?�?�?�?�?®�?µ �?§�?�?�?ª�?�?�?�?�?�?°�?�? �?§�?�?�?£�?³�?¨�?�?�?¹�?�? �?�?�?�?�?­�?¶�?�?�?±', null,
    jsonb_build_object(
      'periodId', v_period_id,
...
declare
  ...
  v_isodow     integer   := extract(isodow from v_local)::integer;  -- 1=إث�?�?�?..7=أحد
  v_sent       integer   := 0;
  v_rec        record;
  v_notif_id   uuid;
begin
  -- 0477: �?ف�? استشار�? �? ت�?ح�?د �?ع 0461 �?�?�?ع سبا�? ا�?تشغ�?�?ات ا�?�?تزا�?�?ة
  -- (فحص-ث�?-إدراج) ا�?ذ�? �?د �?�?رر ت�?ب�?�? تأخر ا�?�?�?ظف �?�?�?د�?ر �?فس�?.
  perform pg_advisory_xact_lock(hashtext('auto_notify_late_attendance'));
  -- ا�?استدعاء ا�?�?د�?�? �?تط�?ب ص�?اح�?ة�? ا�?�?ر�?�? (auth.uid() is null) �?س�?�?ح.
  if auth.uid() is not null
     and not (public.current_is_full_access()
  ...
  -- عط�?ة �?�?ا�?ة ا�?أسب�?ع: ا�?ج�?عة(5) �?ا�?سبت(6). �?ا ش�?ء �?�?فع�?�?.
  ...
  for v_rec in
    ...
    from public.attendance_daily ad
    join public.employees e   on e.id = ad.employee_id
    -- ا�?�?د�?ر ا�?�?باشر ا�?�?ح�?د �?�?�? �?�?ظف: �?فض�?�? 'primary' ث�? أ�? ع�?ا�?ة فع�?ا�?ة.
    left join lateral (
    ...
    where ad.work_date = v_today
      ...
      and not exists (
        -- �?�?ع ا�?ت�?رار: إشعار ساب�? �?�?فس (ا�?�?د�?ر/ا�?�?�?ظف/ا�?�?�?�?)
        select 1
        from public.notifications n
    ...
    order by e.full_name_ar
  loop
    -- ا�?�? trigger trg_notifications_queue_jobs �?ُض�?ف notification_jobs ت�?�?ائ�?ا�?.
    insert into public.notifications (
      recipient_user_id,
      recipient_employee_id,
      title,
      ...
      'ت�?ب�?�? تأخر �?�?ظف',
      coalesce(v_rec.employee_name, 'ا�?�?�?ظف') || ' تأخر ع�? �?�?اج�?ة ا�?�?رد�?ة ب�?�?دار ' ||
        v_rec.late_minutes::text || ' د�?�?�?ة',
      'system',
      'urgent',
      '/attendance',
...
exception
  when others then
    -- �?ا �?عط�?�? ا�?�?ر�?�?�? �?سج�?�? ا�?حادث �?�?ُرجع 0.
    perform public.log_audit_event(
      'attendance.late_alert_failed', 'operations', 'warning',
      'attendance_daily', null, 'فش�? ت�?ب�?�? ا�?تأخر ا�?ت�?�?ائ�?', null,
...
declare
  ...
  v_manager_id uuid;
begin
  -- ف�?ط �?ط�?بات ا�?إجازة ا�?ت�? �?�?ا خط�?ة �?�?اف�?ة (step_order >= 1)
  if new.request_type = 'leave' and new.current_step_order >= 1 then
    -- ج�?ب ا�?�?د�?ر ا�?�?سؤ�?�? ع�? ا�?خط�?ة ا�?حا�?�?ة
...
-- assign_employee_department(uuid,uuid,text,boolean,text,integer,date,date,uuid)
CREATE OR REPLACE FUNCTION public.assign_employee_department(p_employee_id uuid, p_department_id uuid, p_job_title text DEFAULT NULL::text, p_is_primary boolean DEFAULT false, p_note text DEFAULT NULL::text, p_allocation_percentage integer DEFAULT NULL::integer, p_start_date date DEFAULT NULL::date, p_end_date date DEFAULT NULL::date, p_functional_manager_id uuid DEFAULT NULL::uuid)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
  ...
  -- إذا �?�? ت�?�? �?د�?�? إدارات ساب�?ة�? اجع�?�?ا أساس�?ة ت�?�?ائ�?ا�?
  if not v_has_any then
    p_is_primary := true;
  end if;

  -- �?سبة ا�?تخص�?ص: ا�?أساس�? = 100 افتراض�?�?ا
...
begin
  if not (public.current_is_full_access() or public.has_any_permission(array['onboarding.journey.read','onboarding.journey.manage'])) then
    raise exception '�?ص�?�? �?تا�?�?ج ا�?ت�?�?ئة �?رف�?ض' using errcode = '42501';
  end if;
  return jsonb_build_object(
    'journeys', coalesce((
...
begin
  if not (
    ...
    raise exception '�?ص�?�? �?تا�?�?ج ا�?�?�?�?�? �?رف�?ض' using errcode = '42501';
  end if;
...
begin
  ...
  if p_decision not in ('keep','revoke') then raise exception '�?رار غ�?ر صا�?ح' using errcode='22023'; end if;
  if length(trim(coalesce(p_reason,''))) < 5 then raise exception '�?رج�? إدخا�? ا�?سبب' using errcode='22023'; end if;
  select * into v_item from public.access_review_items where id=p_item_id for update;
  if not found then raise exception 'ع�?صر ا�?�?راجعة غ�?ر �?�?ج�?د' using errcode='P0002'; end if;
  if v_item.decision <> 'pending' then raise exception 'ع�?صر ا�?�?راجعة �?ُ�?رر ع�?�?�? با�?فع�?' using errcode='P0001'; end if;
  ...
  perform public.log_audit_event('access.review.decided','access',case when p_decision='revoke' then 'warning' else 'info' end,
    'access_review_items',v_item.id,'�?�?�?±�?§�?± �?�?�?±�?§�?¬�?¹�?© �?µ�?�?�?§�?­�?�?�?©',p_reason,jsonb_build_object('decision',p_decision,'userRoleId',v_item.user_role_id));
  perform public.notify_user(
    v_item.user_id,
    case p_decision when 'revoke' then '�?£�?�?�?�?º�?�?�?ª �?µ�?�?�?§�?­�?�?�?© �?�?�?�? �?­�?³�?§�?¨�?�?' else '�?ª�?£�?�?�?�?�?¯ �?µ�?�?�?§�?­�?�?�?© �?�?�?�? �?­�?³�?§�?¨�?�?' end,
    format('�?�?�?±�?§�?± �?�?�?±�?§�?¬�?¹�?© �?§�?�?�?µ�?�?�?§�?­�?�?�?§�?ª: %s.%s', case p_decision when 'revoke' then '�?£�?�?�?�?º�?�? �?¯�?�?�?±' else '�?£�?�?¨�?�?�?�? �?¹�?�?�?�? �?¯�?�?�?±' end, E'\n'||p_reason),
...
begin
  ...
  -- �?§�?�?�?ª�?®�?�?�?�?�?�?: �?µ�?§�?­�?¨ �?§�?�?�?·�?�?�?¨�?�? �?£�?�? full-access�?�? �?£�?�? �?µ�?�?�?§�?­�?�?�?© approve
  if not (
    v_req.employee_id = v_me
    or public.current_is_full_access()
    or public.has_permission('requests.approve')
  ) then
    raise exception 'غ�?ر �?صرح �?�? بإ�?غاء �?ذا ا�?ط�?ب' using errcode = '42501';
  end if;
...
-- decide_attendance_correction(uuid,text,text)
CREATE OR REPLACE FUNCTION public.decide_attendance_correction(p_id uuid, p_decision text, p_note text DEFAULT NULL::text)
 RETURNS void
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
 ...
 perform public.log_audit_event('attendance.correction.'||p_decision,'workflow',case when p_decision='approved' then 'notice' else 'warning' end,'attendance_corrections',p_id,'�?رار تصح�?ح حض�?ر',p_note,jsonb_build_object('employeeId',v_row.employee_id,'workDate',v_row.work_date));
 perform public.notify_employee(
   v_row.employee_id,
   case p_decision when 'approved' then 'ت�? �?ب�?�? تصح�?ح ا�?حض�?ر' else 'ت�? رفض تصح�?ح ا�?حض�?ر' end,
   format('تصح�?ح حض�?ر بتار�?خ %s%s', v_row.work_date, case when p_note is not null then E'\n'||p_note else '' end),
...
begin
  if not (
    ...
    raise exception '�?ص�?�? ا�?ح�?�?�?ة �?رف�?ض' using errcode = '42501';
  end if;
...
-- decide_overtime_record(uuid,text,integer,text)
CREATE OR REPLACE FUNCTION public.decide_overtime_record(p_id uuid, p_decision text, p_approved_minutes integer DEFAULT NULL::integer, p_note text DEFAULT NULL::text)
 RETURNS void
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
 ...
 perform public.log_audit_event('attendance.overtime.'||p_decision,'workflow',case when p_decision='approved' then 'notice' else 'warning' end,'overtime_records',p_id,'�?رار ساعات إضاف�?ة',p_note,jsonb_build_object('employeeId',v_row.employee_id,'workDate',v_row.work_date,'approvedMinutes',v_min));
 perform public.notify_employee(
   v_row.employee_id,
   case p_decision when 'approved' then 'ت�? اعت�?اد ساعات�? ا�?إضاف�?ة' else 'ت�? رفض ساعات�? ا�?إضاف�?ة' end,
   format('ساعات إضاف�?ة بتار�?خ %s (%s د�?�?�?ة)%s', v_row.work_date, v_min, case when p_note is not null then E'\n'||p_note else '' end),
   'attendance', case p_decision when 'approved' then 'normal' else 'high' end,
...
begin
  if not (public.current_is_full_access() or public.has_permission('privacy.request.manage')) then raise exception 'إدارة ا�?خص�?ص�?ة �?رف�?ضة' using errcode='42501'; end if;
  if p_status not in ('in_review','waiting_requester','approved','rejected','completed') then raise exception 'حا�?ة غ�?ر صا�?حة' using errcode='22023'; end if;
  if p_status in ('rejected','completed') and length(trim(coalesce(p_reason,''))) < 5 then raise exception '�?رج�? إدخا�? ا�?سبب' using errcode='22023'; end if;
  ...
  if not found then raise exception 'ط�?ب ا�?خص�?ص�?ة غ�?ر �?�?ج�?د' using errcode='P0002'; end if;
  perform public.log_audit_event('privacy.request.updated','data','notice','privacy_requests',v_row.id,'�?ª�?­�?¯�?�?�?« �?·�?�?�?¨ �?®�?µ�?�?�?µ�?�?�?©',p_reason,jsonb_build_object('status',p_status));
  perform public.notify_user(
    v_row.requester_user_id,
    '�?ª�?­�?¯�?�?�?« �?­�?§�?�?�?© �?·�?�?�?¨ �?§�?�?�?®�?µ�?�?�?µ�?�?�?©',
    format('�?£�?µ�?¨�?­ �?·�?�?�?¨�?�? �?¨�?­�?§�?�?�?© %s.%s', p_status, case when p_reason is not null then E'\n'||p_reason else '' end),
...
-- schedule_interview_admin(uuid,text,timestamp with time zone,text,uuid[],uuid)
CREATE OR REPLACE FUNCTION public.schedule_interview_admin(p_application_id uuid, p_mode text, p_scheduled_at timestamp with time zone, p_location_or_link text DEFAULT NULL::text, p_panelists uuid[] DEFAULT NULL::uuid[], p_interview_id uuid DEFAULT NULL::uuid)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'auth'
...
begin
  ...
  perform public.log_audit_event('recruitment.interview_scheduled','workflow','info','interviews',v_id,
    'جد�?�?ة/تحد�?ث �?�?اب�?ة ت�?ظ�?ف', null, jsonb_build_object('applicationId',p_application_id,'mode',p_mode));
...
begin
  ...
  if v_row.id is null then
    raise exception 'ا�?إشعار غ�?ر �?�?ج�?د أ�? �?�?س �?�?' using errcode = '42501';
  end if;
...
-- tg_attendance_daily_notify_manager()
...
declare
  ...
  v_body text;
begin
  -- ع�?د إدراج جد�?د أ�? تحد�?ث �?أ�?�?ات ا�?دخ�?�?/ا�?خر�?ج
  if tg_op = 'INSERT' then
    ...
    -- UPDATE: ف�?ط ع�?د تغ�?�?ر �?�?�?ة ا�?دخ�?�?/ا�?خر�?ج
  ...
  -- ا�?اس�? ا�?أ�?�? �?�?ع�?�?ا�? ا�?شخص�? (�?ص�? �?صطف�?�?¦) �?ع احت�?اط ع�?د غ�?اب ا�?اس�?
  v_first := coalesce(nullif(split_part(coalesce(v_emp_ar, ''), ' ', 1), ''), '�?�?ظف');

  -- 0449: ا�?�?�?ت ب�?ظا�? 12 ساعة �?ع ص/�? بد�? HH24
  v_time := to_char(
    ...
    case when v_event = 'attendance_check_in' then new.first_check_in else new.last_check_out end
      at time zone 'Africa/Cairo')) < 12 then ' ص' else ' �?' end;

  -- 0446: ع�?�?ا�? شخص�? باس�? ا�?�?�?ظف بد�? ا�?ص�?غة ا�?عا�?ة
  v_title := case when v_event = 'attendance_check_in'
              then format('�?ص�? %s �?�?ع�?�? با�?�?ج�?ع', v_first)
              else format('خرج %s �?�? ا�?�?ج�?ع', v_first) end;
  v_body := format(
    '%s ا�?ساعة %s',
    case when v_event = 'attendance_check_in' then 'دخ�?' else 'ا�?صرف' end,
    v_time
  );

  -- إشعار ا�?�?�?ظف �?فس�? (تأ�?�?د تسج�?�? ا�?حض�?ر/ا�?ا�?صراف)
  perform public.notify_employee(
    new.employee_id,
    case when v_event = 'attendance_check_in' then 'ت�? تسج�?�? حض�?ر�?'
         else 'ت�? تسج�?�? ا�?صراف�?' end,
    format(
      'ت�? تسج�?�? %s ا�?ساعة %s',
      case when v_event = 'attendance_check_in' then 'حض�?ر�?' else 'ا�?صراف�?' end,
      v_time
    ),
  ...
  -- إشعار ا�?�?د�?ر ا�?�?باشر (أ�?�?�?�?ة �?�?خفضة �? ع�?�?ا�? شخص�? 0446)
  ...
  if v_manager is not null then
    perform public.notify_employee(
      v_manager,
      v_title,
      format('%s �? %s', coalesce(v_emp_ar, '�?�?ظف'), v_body),
  ...
  -- 0446: إشعار ا�?�?د�?ر ا�?ت�?ف�?ذ�? بإشعار «عاد�?» (�?ا عاج�? �?�?ا full-screen)
  -- حت�? �?ا تغر�? إشعارات ا�?حض�?ر ا�?ر�?ت�?�?�?ة �?س�? «ت�?ب�?�?ات عاج�?ة»�? تب�?�? ف�?
  -- �?ائ�?ة ا�?إشعارات ا�?عا�?ة. �?ا �?ُشعر ا�?ت�?ف�?ذ�? ع�? حض�?ر/ا�?صراف �?فس�?.
  v_exec_emp := public.first_active_employee_for_role('executive-director');
...
begin
  if not (public.current_is_full_access() or public.has_permission('recruitment.requisition.manage')) then
    raise exception 'إدارة ط�?بات ا�?تع�?�?�? �?رف�?ضة' using errcode = '42501';
  end if;
  if p_department_id is null or nullif(trim(p_title), '') is null or coalesce(p_headcount, 0) <= 0 then
    raise exception 'ا�?�?س�? �?ا�?�?�?صب �?عدد �?�?جب �?ط�?�?بة' using errcode = '22023';
  end if;
...
begin
  if not (public.current_is_full_access() or public.has_permission('access.break_glass.approve')) then raise exception 'اعت�?اد ا�?استث�?اء ا�?طارئ �?رف�?ض' using errcode='42501'; end if;
  select * into v_req from public.break_glass_requests where id=p_request_id for update;
  if not found then raise exception '�?�? �?ت�? ا�?عث�?ر ع�?�? ا�?ط�?ب' using errcode='P0002'; end if;
  if v_req.status <> 'pending' then raise exception 'ا�?ط�?ب �?�?س �?�?د ا�?ا�?تظار' using errcode='P0001'; end if;
  if v_req.requested_by=auth.uid() then raise exception '�?�?ز�? اعت�?اد شخص�?�? (أربع ع�?�?�?)' using errcode='42501'; end if;
  if length(trim(coalesce(p_reason,''))) < 5 then raise exception 'سبب ا�?اعت�?اد �?ط�?�?ب' using errcode='22023'; end if;
  if exists (
    ...
    raise exception 'ا�?�?ستخد�? �?�?�?�? ا�?د�?ر ا�?�?ط�?�?ب �?شطا�? با�?فع�?' using errcode='P0001';
  end if;
  ...
  perform public.notify_user(
    v_req.requested_by,
    '�?ª�?�? �?�?�?¨�?�?�?�? �?·�?�?�?¨ Break Glass',
    format('�?�?�?�?�?�?­ �?�?�?µ�?�?�?�? �?§�?³�?ª�?«�?�?�?§�?¦�?�? �?�?�?¯�?�?�?± %s �?­�?ª�?�? %s.', coalesce(v_role_slug,''), v_req.active_until),
...
begin
  if not (public.current_is_full_access() or public.has_permission('access.break_glass.approve')) then raise exception 'رفض ا�?استث�?اء ا�?طارئ �?رف�?ض' using errcode='42501'; end if;
  if length(trim(coalesce(p_reason,''))) < 5 then raise exception '�?رج�? إدخا�? ا�?سبب' using errcode='22023'; end if;
  ...
  if not found then raise exception 'ا�?ط�?ب ا�?�?ع�?�? غ�?ر �?�?ج�?د' using errcode='P0002'; end if;
...
-- get_employees_enriched(text,text,integer)
  ...
  RETURN coalesce((
    ...
    FROM (
      ...
      WHERE e.is_deleted = false
        AND NOT public.is_employee_executive(e.id)  -- 0444: استبعاد ا�?�?د�?ر ا�?ت�?ف�?ذ�?
...
-- resolve_request_approver(uuid,date)
CREATE OR REPLACE FUNCTION public.resolve_request_approver(p_employee_id uuid, p_as_of date DEFAULT ((now() AT TIME ZONE 'Africa/Cairo'::text))::date)
 RETURNS uuid
 LANGUAGE plpgsql
 STABLE SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
  ...
  -- �?�?ع ا�?�?�?اف�?ة ا�?ذات�?ة: �?�? صار ا�?�?د�?ر �?�? ا�?�?ُ�?دِ�?�? �?فس�?�? اصعد �?�?د�?ر�?
  ...
  -- V17 §1.2: ت�?ج�?�? ط�?بات ا�?تشغ�?�? �?�?�?د�?ر ا�?ت�?ف�?ذ�?
  ...
  -- ص�?اح�?ة requests.approve: أ�? �?�?ظف �?شط �?�?�?�? ص�?اح�?ة ا�?�?�?اف�?ة ع�?�? ا�?ط�?بات
  ...
  -- س�?�?ط HR: �?ض�?�? أ�?ا تُ�?ت�? ا�?�?�?�?ة ب�?ا �?عت�?د (0385)
  if v_mgr is null then
    select e.id into v_mgr
    from public.employees e
    join public.user_roles ur on ur.user_id = e.user_id
...
BEGIN
  ...
  WITH RECURSIVE
  -- ج�?�?ع ا�?�?�?ظف�?�? غ�?ر ا�?�?حذ�?ف�?�? �?غ�?ر ا�?�?�?ت�?�?�? (ب�?ا ف�?�?�? ا�?�?�?�?�?ف�?�? �?ا�?�?دع�?�?�? �?فترة ا�?إخطار)
  emp_base AS (
    SELECT
      e.id,
      e.full_name_ar,
  ...
  -- ا�?ع�?ا�?ات ا�?�?شطة ف�?ط (�?د�?ر رئ�?س�? �?شط)
  ...
  -- ا�?شجرة ا�?�?ر�?�?ة ا�?�?ت�?ررة بدء�?ا �?�? ا�?جذ�?ر (�?�?ظف�?�? ب�?ا �?د�?ر رئ�?س�?)
  org_tree AS (
    -- ا�?جذ�?ر: �?�?ظف�?�? �?�?س �?د�?�?�? �?د�?ر رئ�?س�? �?شط
    SELECT
      eb.id,
      eb.full_name_ar,
      eb.full_name_en,
    ...
    -- ا�?أب�?اء: �?�?ظف�?�? �?د�?ر�?�? �?�?ج�?د با�?فع�? ف�? ا�?شجرة
    SELECT
      eb.id,
      eb.full_name_ar,
      eb.full_name_en,
...
-- get_location_directory(text,integer)
...
-- open_annual_leave_entitlement(uuid,integer)
CREATE OR REPLACE FUNCTION public.open_annual_leave_entitlement(p_employee_id uuid, p_year integer DEFAULT (EXTRACT(year FROM (now() AT TIME ZONE 'Africa/Cairo'::text)))::integer)
 RETURNS integer
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
  ...
  if v_annual_id is not null then
    perform public.apply_leave_ledger_entry(
      ...
      null, 'فتح رص�?د ا�?إجازة ا�?اعت�?اد�?ة ا�?س�?�?�?',
  ...
  if v_casual_id is not null then
    perform public.apply_leave_ledger_entry(
      ...
      null, 'فتح رص�?د ا�?إجازة ا�?عارضة ا�?س�?�?�?',
      jsonb_build_object('entitlement', v_ent));
    v_count := v_count + 1;
  end if;

  -- ا�?�?رض�?ة: �?ا �?فتح رص�?دا�? ثابتا�? �? أصبحت بد�?�? حد. تُسج�?�? ع�?د ا�?حاجة ف�?ط.
  -- (�?ُتر�? �?رجع�?ا�? فارغا�? د�?�? ledger entry�? رص�?د�?ا غ�?ر �?حد�?د.)

  perform public.log_audit_event(
    'leave.entitlement.opened', 'workflow', 'info',
    'leave_balance_accounts', p_employee_id,
    'فتح ا�?رص�?د ا�?س�?�?�? �?�?إجازات (بد�?�? �?رض�?ة ثابتة)',
    format('ا�?س�?ة %s', p_year),
    jsonb_build_object('year', p_year, 'entitlement', v_ent));
  return v_count;
end;
$function$;

-- save_shift_admin(uuid,text,time without time zone,time without time zone,integer,integer,integer,boolean)
CREATE OR REPLACE FUNCTION public.save_shift_admin(p_shift_id uuid, p_name text, p_start time without time zone, p_end time without time zone, p_break_minutes integer DEFAULT 0, p_grace_in integer DEFAULT 15, p_grace_out integer DEFAULT 0, p_active boolean DEFAULT true)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
  if p_shift_id is null then
    -- �?�?د �?شت�? فر�?د (�?ا �?ظ�?ر ف�? ا�?�?�?حة�? �?�?ت�?�?�?ز ا�?داخ�?�? ف�?ط).
  ...
  -- �?ع�?د ا�?استخدا�? �?�?�? overload ا�?أص�?�? (�?فحص ا�?ص�?اح�?ة �?�?�?تب سج�? ا�?تد�?�?�?).
...
begin
  ...
  -- 4.1 [P0] طاب�?ر ت�?ا�?�? Dead-letter > 0
  ...
  if coalesce(v_val,0) > 0 then
    ...
    values ('queue_dead_letter', 'P0', 'queue',
            'رسائ�? ت�?ا�?�? ف�? Dead-letter',
            format('%s رسا�?ة ف�? dead_letter تحتاج تدخ�?�?ا �?د�?�?�?ا', v_val),
  ...
  -- 4.2 [P1] طاب�?ر ت�?ا�?�? failed �?تأخر (overdue > 20)
  ...
  if coalesce(v_val,0) > 20 then
    ...
    values ('queue_overdue', 'P1', 'queue',
            'طاب�?ر ت�?ا�?�? �?تأخر ع�? ا�?�?عا�?جة',
            format('%s رسا�?ة تجا�?زت �?�?عد إعادة ا�?�?حا�?�?ة ب�?15 د�?�?�?ة', v_val),
            v_val, 20, '{}'::jsonb)
    on conflict (alert_key) where status = 'open'
    do update set last_seen_at = now(), occurrences = a.occurrences + 1,
                  metric_value = excluded.metric_value;
  ...
  if coalesce(v_val,0) > 0 then
    ...
    values ('errors_fatal', 'P0', 'error',
            'أخطاء fatal ف�? ا�?تطب�?�?',
            format('%s خطأ fatal خ�?ا�? ا�?ساعة ا�?أخ�?رة', v_val),
            v_val, 0, '{}'::jsonb)
    on conflict (alert_key) where status = 'open'
    do update set last_seen_at = now(), occurrences = a.occurrences + 1,
                  metric_value = excluded.metric_value;
  ...
  -- 4.4 [P1] ارتفاع ا�?أخطاء (error+ > 50/ساعة)
  ...
  if coalesce(v_val,0) > 50 then
    ...
    values ('errors_spike', 'P1', 'error',
            'ارتفاع �?عد�?�? ا�?أخطاء',
            format('%s خطأ خ�?ا�? ا�?ساعة ا�?أخ�?رة (ا�?حد 50)', v_val),
            v_val, 50, '{}'::jsonb)
    on conflict (alert_key) where status = 'open'
    do update set last_seen_at = now(), occurrences = a.occurrences + 1,
                  metric_value = excluded.metric_value;
  ...
  -- 4.5 [P0] أحداث أ�?�?�?ة حرجة ف�? آخر ساعة
  ...
  if coalesce(v_val,0) > 0 then
    ...
    values ('security_critical', 'P0', 'security',
            'أحداث أ�?�?�?ة حرجة',
            format('%s حدث أ�?�?�? بخط�?رة critical خ�?ا�? ا�?ساعة ا�?أخ�?رة', v_val),
            v_val, 0, '{}'::jsonb)
    on conflict (alert_key) where status = 'open'
    do update set last_seen_at = now(), occurrences = a.occurrences + 1,
                  metric_value = excluded.metric_value;
  ...
  -- 4.6 [P1] إشعارات عا�?�?ة (queued > 30 د�?�?�?ة)
  select stuck into v_val from public.v_monitor_notifications;
  if coalesce(v_val,0) > 0 then
    insert into public.system_alerts as a
      (alert_key, severity, source, title, detail, metric_value, threshold, context)
    values ('notifications_stuck', 'P1', 'notification',
            'إشعارات عا�?�?ة ف�? ا�?طاب�?ر',
            format('%s إشعار ف�? حا�?ة queued �?أ�?ثر �?�? 30 د�?�?�?ة', v_val),
            v_val, 0, '{}'::jsonb)
    on conflict (alert_key) where status = 'open'
    do update set last_seen_at = now(), occurrences = a.occurrences + 1,
                  metric_value = excluded.metric_value;
  ...
  -- 4.7 [P1] فش�? �?�?ا�? cron (آخر تشغ�?�? failed) �? إ�? ت�?ف�?ر cron
  if exists (select 1 from pg_extension where extname = 'pg_cron') then
    begin
      ...
      loop
        ...
        values ('cron_failed:'||v_rec.jobname, 'P1', 'cron',
                'فش�? �?�?�?ة �?جد�?�?ة: '||v_rec.jobname,
                'آخر تشغ�?�? �?�?�?�?�?ة ا�?ت�?�? بحا�?ة failed', jsonb_build_object('job', v_rec.jobname))
        on conflict (alert_key) where status = 'open'
        do update set last_seen_at = now(), occurrences = a.occurrences + 1;
        v_raised := v_raised + 1;
      end loop;
    exception
      when insufficient_privilege or undefined_table then
        null;  -- �?ا ص�?اح�?ة cron.* ف�? �?ذا ا�?د�?ر �? �?تجا�?ز بأ�?ا�? ف�?ط �?�?ذ�? ا�?حا�?ة
      -- أ�? خطأ آخر (فش�? �?تابة/�?ف�?/timeout) �?ُتر�? �?�?ُطرح: �?ا �?ُخف�? فش�? ا�?ت�?ب�?�?ات �?�?جاح
    end;
  end if;
  ...
  perform public.log_audit_event(
    ...
    'فحص ا�?ت�?ب�?�?ات ا�?آ�?�?', format('رُصدت/حُدِ�?ثت %s حا�?ة', v_raised),
...
begin
  ...
  if v_has_cron then
    ...
    exception
      when insufficient_privilege or undefined_table then
        v_cron := '[]'::jsonb;  -- �?ا ص�?اح�?ة ع�?�? cron.* ف�? بعض ا�?أد�?ار �? فارغ صح�?ح
      when others then
        -- خطأ ح�?�?�?�? (timeout/تغ�?�?ر �?خطط) �? �?ا �?ُخف�?�? �?�?"�?ا �?�?ا�?"�? ب�? �?ُبرز�?
...
-- generate_punch_reminders(integer)
...
declare
  ...
  v_dow integer := extract(isodow from v_local)::integer;  -- 1=إث�?�?�? .. 7=أحد
  ...
  v_body text;
begin
  -- 0460: �?ف�? استشار�? �?�?�?ع تشغ�?�?�?�?�? �?تزا�?�?�?�? �?�?�?ظ�?فة �? سبا�? ا�?فحص-ث�?-ا�?إدراج
  -- ب�?�? تشغ�?�?�?�? �?ت�?ارب�?�? �?ا�? �?�?رر ت�?ب�?�?ات «�?س�?ت ا�?بص�?ة» ب�?فس ا�?�?حظة.
  perform pg_advisory_xact_lock(hashtext('generate_punch_reminders'));  -- �?س�?�?ح ف�?ط �?ع�?�?�?ة خاد�?�?ة (service_role) أ�? �?ا�?�? ص�?اح�?ة إرسا�? ا�?إشعارات.
  if not (public.current_is_full_access()
  ...
  -- ا�?ج�?عة ف�?ط عط�?ة (�?�?�? ا�?ع�?�?: ا�?سبت=6 �?ا�?أحد=7 �?ا�?إث�?�?�?..ا�?خ�?�?س=1..4).
  if v_dow = 5 then
    return 0;
  end if;

  -- ا�?�?رد�?ة ا�?رس�?�?ة ا�?حا�?�?ة: ا�?�?شطة ا�?أحدث تحد�?ث�?ا (تبد�?�? ر�?ضا�? �?د�?�?).
  select * into v_shift
  from public.shifts
  where is_active = true
  ...
  for v_emp in
    ...
    where e.is_active = true
      ...
      and e.status = 'active'
      and e.user_id is not null
      -- V17 §7: استث�?اء ا�?�?د�?ر ا�?ت�?ف�?ذ�? �?�? تذ�?�?رات ا�?حض�?ر
      and not exists (
        select 1 from public.user_roles ur
        join public.roles r on r.id = ur.role_id
  ...
  loop
    -- سج�? ا�?�?�?�? (إ�? �?ُجد) �?�?�?�?ظف: �?صدر ا�?ح�?�?�?ة �?بص�?ة ا�?دخ�?�?/ا�?خر�?ج.
    select * into v_daily
    from public.attendance_daily
    where employee_id = v_emp.employee_id
      and work_date = v_today;

    -- تحد�?د �?�?ع ا�?تذ�?�?ر حسب ا�?ت�?�?�?ت
    v_kind := null;
    if v_now_time >= (v_shift.start_time - make_interval(mins := v_lead))
      ...
      v_kind := 'before_in';
      v_title := 'تذ�?�?ر با�?حض�?ر';
      v_body := 'ا�?ترب �?�?ت ا�?حض�?ر (' || (to_char(v_shift.start_time, 'hh12:mi') || case when extract(hour from v_shift.start_time) < 12 then ' ص' else ' �?' end) || '). �?ا ت�?س�? تسج�?�? ا�?بص�?ة.';
          ...
          and (v_daily.id is null or v_daily.first_check_in is null) then
      v_kind := 'late_in';
      v_title := '�? � تأخ�?ر ف�? ا�?حض�?ر';
      v_body := '�?�? تُسج�?�?�? بص�?ة حض�?ر�? حت�? ا�?آ�?. سج�?�? ا�?بص�?ة ف�? أ�?رب �?�?ت.';
      ...
      v_kind := 'before_out';
      v_title := 'تذ�?�?ر با�?ا�?صراف';
      v_body := 'ا�?ترب �?�?ت ا�?ا�?صراف (' || (to_char(v_shift.end_time, 'hh12:mi') || case when extract(hour from v_shift.end_time) < 12 then ' ص' else ' �?' end) || '). �?ا ت�?س�? تسج�?�? بص�?ة ا�?ا�?صراف.';
    end if;
    ...
    -- �?�?ع ا�?ت�?رار: �?فس (ا�?�?ستخد�?/ا�?�?�?�?/ا�?�?�?ع) �?رة �?احدة.
    if exists (
...
begin
  if p_actor_user_id is null or p_user_id is null then
    raise exception 'ا�?�?�?ف�?ذ �?ا�?�?ستخد�? �?ط�?�?با�?';
  end if;
  ...
  if v_employee_code is null then
    raise exception '�?�?د ا�?�?�?ظف أ�? ا�?�?اتف �?ط�?�?ب' using errcode = '22023';
  end if;
  ...
  if exists (
    ...
    raise exception '�?�?د ا�?�?�?ظف �?�?ج�?د �?سب�?ا�?' using errcode = '23505';
  end if;

  -- �?�?­�?µ �?ª�?�?�?±�?§�?± �?§�?�?�?�?�?§�?ª�? �?µ�?±�?�?�?­ �?�?�?¹ �?±�?³�?§�?�?�?© �?�?�?�?�?�?�?�?�?�?© (�?¨�?¯�?�? �?§�?�?�?§�?¹�?ª�?�?�?§�?¯ �?¹�?�?�?�? constraint �?®�?§�?�?).
  ...
  if p_manager_employee_id is not null and not exists (
    ...
    raise exception 'ا�?�?د�?ر �?�?س �?�?ظفا�? �?شطا�?' using errcode = '23503';
  end if;
...
-- set_dispute_committee(uuid,jsonb)
...
begin
 ...
 for v_item in select * from jsonb_array_elements(p_members) loop
  ...
  values(p_case_id,'�?ج�?ة ح�? ا�?�?ش�?�?ات �?ا�?خ�?افات',v_emp,v_role,auth.uid());
 end loop;
 ...
 perform public.log_audit_event('dispute.committee_assigned','workflow','notice','dispute_cases',p_case_id,'تش�?�?�? �?ج�?ة ا�?�?ش�?�?ة',null,jsonb_build_object('members',jsonb_array_length(p_members)));
end $function$;
...
begin
  ...
  if nullif(trim(coalesce(p_comment, '')), '') is null then
    raise exception 'ا�?تع�?�?�? �?ط�?�?ب' using errcode = '22023';
  end if;
  ...
  if not found then
    raise exception '�?�? �?ت�? ا�?عث�?ر ع�?�? ا�?ت�?ر�?ر ا�?�?�?�?�?' using errcode = 'P0002';
  end if;
...
declare
  v_blocked constant text[] := array[
    'maternity','childcare','child_care','maternity_leave','�?ضع','رعا�?ة_طف�?'
  ];
begin
  -- �?س�?ح ف�?ط بإب�?ائ�?ا �?عط�?�?ة (is_active=false)�? �?�?�?ع تفع�?�?�?ا أ�? إ�?شاء�?ا �?شطة.
  if new.code = any (v_blocked) and coalesce(new.is_active, true) = true then
    raise exception 'LEAVE_TYPE_DISABLED_BY_POLICY: % (إجازة ا�?�?ضع/رعا�?ة ا�?طف�? �?�?غاة با�?س�?اسة)', new.code
      using errcode = '42501';
  end if;
  return new;
end $function$;

-- process_kpi_cycle_schedule(timestamp with time zone)
CREATE OR REPLACE FUNCTION public.process_kpi_cycle_schedule(p_at timestamp with time zone DEFAULT now())
 RETURNS integer
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
 for v_cycle in select * from public.kpi_cycles where status='draft' and scheduled_open_at<=p_at and p_at<=coalesce(extended_until,deadline_at) for update loop
  ...
  perform public.log_audit_event('kpi.cycle.auto_opened','workflow','notice','kpi_cycles',v_cycle.id,'فتح د�?رة KPI ت�?�?ائ�?�?ا',null,jsonb_build_object('at',p_at));
  v_count:=v_count+1;
 end loop;
 ...
 for v_cycle in select * from public.kpi_cycles where status='open' and p_at>coalesce(extended_until,deadline_at) for update loop
  ...
  perform public.log_audit_event('kpi.cycle.auto_closed','workflow','warning','kpi_cycles',v_cycle.id,'إغ�?ا�? د�?رة KPI ت�?�?ائ�?�?ا بعد ا�?�?�?عد',null,jsonb_build_object('at',p_at));
  v_count:=v_count+1;
 end loop;
...
-- save_kpi_goal(uuid,uuid,text,text,numeric,numeric,text,numeric,date,text,text,text,text)
CREATE OR REPLACE FUNCTION public.save_kpi_goal(p_evaluation_id uuid, p_goal_id uuid, p_title text, p_description text, p_target_value numeric, p_achieved_value numeric, p_unit text, p_weight numeric, p_due_date date, p_evidence_source text, p_employee_note text, p_manager_note text, p_status text)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
 ...
 perform public.log_audit_event('kpi.goal.saved','workflow','info','kpi_goals',v_id,'حفظ �?دف ت�?�?�?�? ا�?أداء',null,jsonb_build_object('evaluationId',p_evaluation_id,'status',p_status));
 return v_id;
end $function$;
...
declare v_row public.privacy_requests;
begin
  if auth.uid() is null then raise exception '�?�?ز�? تسج�?�? ا�?دخ�?�? أ�?�?ا�?' using errcode='42501'; end if;
  if p_request_type not in ('access','correction','export','restriction','deletion','objection') then raise exception '�?�?ع ط�?ب خص�?ص�?ة غ�?ر صا�?ح' using errcode='22023'; end if;
  ...
  perform public.log_audit_event('privacy.request.submitted','data','notice','privacy_requests',v_row.id,'�?ª�?�?�?¯�?�?�?�? �?·�?�?�?¨ �?®�?µ�?�?�?µ�?�?�?©',null,jsonb_build_object('requestType',p_request_type));
  perform public.notify_employees_with_permission(
    'privacy.request.manage',
    '�?·�?�?�?¨ �?®�?µ�?�?�?µ�?�?�?© �?¬�?¯�?�?�?¯',
    format('�?·�?�?�?¨ %s �?�?�?�? �?�?�?�?�?¸�?.', p_request_type),
...
-- get_kpi_validation_errors(uuid)
...
begin
  ...
  if exists(
    ...
    v_errors := array_append(v_errors, '�?�? ت�?ت�?�? درجات ا�?ب�?�?د ا�?سبعة.');
  end if;
  ...
  if not exists(
    ...
    v_errors := array_append(v_errors, 'ا�?ت�?�?�?�? ا�?ذات�? �?�?ب�?�?د غ�?ر �?�?ت�?�?.');
  end if;

  if nullif(trim(coalesce(v_eval.manager_comment, '')), '') is null then
    v_errors := array_append(v_errors, '�?�?احظة ا�?�?د�?ر �?ط�?�?بة �?ب�? ا�?اعت�?اد ا�?�?�?ائ�?.');
  end if;

  v_total := public.kpi_total_score(p_evaluation_id);
  if v_total < 0 or v_total > 100 then
    v_errors := array_append(v_errors, 'ا�?�?ج�?�?ع ا�?�?�?ائ�? �?جب أ�? �?�?�?�? ب�?�? صفر �?100.');
  end if;

  return v_errors;
end $function$;

-- transition_dispute_case(uuid,text,text,jsonb)
CREATE OR REPLACE FUNCTION public.transition_dispute_case(p_case_id uuid, p_action text, p_reason text DEFAULT NULL::text, p_metadata jsonb DEFAULT '{}'::jsonb)
 RETURNS text
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
 ...
 if p_action='extend_review' then
  ...
  perform public.log_audit_event('dispute.review_extended','workflow','warning','dispute_cases',p_case_id,'ت�?د�?د �?�?�?ة �?راجعة ا�?�?ش�?�?ة',trim(p_reason));
  return v.status;
 end if;
 ...
 if p_action='change_priority' then
  ...
  perform public.log_audit_event('dispute.priority_changed','workflow','warning','dispute_cases',p_case_id,'تغ�?�?ر أ�?�?�?�?ة ا�?�?ش�?�?ة',trim(p_reason),jsonb_build_object('from',v.severity,'to',v_priority));
  return v.status;
 end if;
 ...
 if p_action='close' then
  -- V23 + 0202: إضافة 'executed' �?�?س�?اح بإغ�?ا�? ا�?�?ضا�?ا بعد ت�?ف�?ذ ا�?إجراء ا�?إدار�?
 ...
 if p_action='accept' then
  ...
  update public.dispute_cases set shareable_summary=coalesce(nullif(trim(p_metadata->>'summary'),''),shareable_summary,'ت�?جد �?ش�?�?ة تتط�?ب إفادت�?'),respondent_notified_at=case when p_action='request_respondent_statement' then coalesce(respondent_notified_at,now()) else respondent_notified_at end where id=p_case_id;
  perform public.enqueue_dispute_notification(p_case_id,v_target,p_action||':'||v_target::text,
   case when p_action='request_witness_statement' then 'ط�?ب إفادة شا�?د' else 'ط�?ب إفادة بشأ�? �?ش�?�?ة' end,
   coalesce(nullif(trim(p_metadata->>'summary'),''),'�?رج�? فتح �?س�? ا�?ش�?ا�?�? �?ت�?د�?�? إفادت�?.'),'high');
  ...
  for v_target in select distinct e.id from public.employees e join public.user_roles ur on ur.user_id=e.user_id join public.roles r on r.id=ur.role_id where r.slug='executive-director' and ur.effective_from<=now() and (ur.effective_to is null or ur.effective_to>now()) loop
   perform public.enqueue_dispute_notification(p_case_id,v_target,'escalated:'||v_target::text,'�?ض�?ة �?صعدة �?�?�?د�?ر ا�?ت�?ف�?ذ�?',coalesce(trim(p_reason),'تتط�?ب �?راجعة ت�?ف�?ذ�?ة'),'urgent');
  end loop;
 ...
 perform public.log_audit_event('dispute.'||p_action,'workflow',case when p_action in ('escalate','force_status') then 'warning' else 'notice' end,'dispute_cases',p_case_id,'تغ�?�?ر �?سار ا�?�?ش�?�?ة',p_reason,jsonb_build_object('from',v.status,'to',v_next));
 ...
 if v.actor_employee_id is not null and p_action in ('accept','reject','request_more_information','escalate','return_to_committee','close','reopen','resolve_friendly') then
  perform public.enqueue_dispute_notification(p_case_id,v.actor_employee_id,p_action||':actor',
   case p_action when 'accept' then 'ت�? �?ب�?�? ا�?�?ش�?�?ة �?�?دراسة' when 'reject' then 'ت�? رفض ا�?�?ش�?�?ة ش�?�?�?�?ا' when 'request_more_information' then '�?ط�?�?ب است�?�?ا�? ب�?ا�?ات ا�?�?ش�?�?ة' when 'escalate' then 'ت�? تصع�?د ا�?�?ش�?�?ة' when 'return_to_committee' then 'أع�?دت ا�?�?ش�?�?ة إ�?�? ا�?�?ج�?ة' when 'close' then 'ت�? إغ�?ا�? ا�?�?ش�?�?ة' when 'resolve_friendly' then 'ت�? ح�? ا�?�?ش�?�?ة �?د�?�?ا' else 'أع�?د فتح ا�?�?ش�?�?ة' end,
   coalesce(nullif(trim(p_reason),''),'�?�?�?�?�? �?تابعة ا�?حا�?ة �?�? �?س�? ا�?ش�?ا�?�?.'),case when p_action in ('reject','request_more_information') then 'high' else 'normal' end);
 end if;
 return v_next;
end $function$;

-- get_dispute_operations_catalog(text)
CREATE OR REPLACE FUNCTION public.get_dispute_operations_catalog(p_status text DEFAULT NULL::text)
 RETURNS jsonb
 LANGUAGE plpgsql
 STABLE SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
 ...
 return jsonb_build_object(
  'cases',coalesce((select jsonb_agg(
   -- ا�?جزء ا�?أ�?�?: ا�?ب�?ا�?ات ا�?أساس�?ة (30 ز�?ج = 60 �?س�?ط)
   jsonb_build_object(
   ...
   ||
   -- ا�?جزء ا�?ثا�?�?: ح�?�?�? ا�?إجراء ا�?إدار�? + ا�?ع�?ا�?ات (22 ز�?ج = 44 �?س�?ط)
   jsonb_build_object(
   ...
   ||
   -- ا�?جزء ا�?ثا�?ث: ا�?ج�?سات + ا�?�?رار + ا�?إجراءات + ا�?تس�?�?ات + ا�?طع�?�? (5 أز�?اج = 10 �?سائط)
   jsonb_build_object(
...
begin
  if p_status not in ('pending','in_progress','done') then
    raise exception 'حا�?ة �?�?�?ة غ�?ر �?دع�?�?ة' using errcode = '22023';
  end if;

  select * into v_task from public.tasks where id = p_task_id for update;
  if found then
    if v_task.assignee_employee_id is distinct from v_employee_id then
      raise exception 'ا�?�?�?�?ة خارج �?طا�?�?' using errcode = '42501';
    end if;
    if v_task.status = 'cancelled' then
      raise exception 'ا�?�?�?�?ة ا�?�?�?غاة �?ا تتغ�?ر' using errcode = 'P0001';
    end if;
    if v_task.status = 'done' and p_status <> 'done' then
      raise exception 'إعادة فتح ا�?�?�?�?ة ا�?�?�?ت�?�?ة �?صاحب�?ا أ�? ا�?إدارة ف�?ط' using errcode = '42501';
    end if;
  ...
  for update;
  if not found then raise exception 'ا�?�?�?�?ة غ�?ر �?�?ج�?دة' using errcode = 'P0002'; end if;
  ...
  if not (
    ...
    or (v_onboarding.assignee_id is null and v_journey.employee_id = v_employee_id and lower(coalesce(v_onboarding.owner_role, '')) in ('employee','�?�?�?�?�?¸�?'))
  ) then
    raise exception '�?�?�?ة ا�?ت�?�?ئة خارج �?طا�?�?' using errcode = '42501';
  end if;
  if v_onboarding.status in ('completed','skipped') and p_status <> 'done' then
    raise exception 'ا�?�?�?ظف �?ا �?ع�?د فتح �?�?�?ة ت�?�?ئة �?�?ت�?�?ة' using errcode = '42501';
  end if;
...
AS $function$
  with task_rows as (
    ...
    select
      ...
      ot.title,
      concat_ws(' · ', '�?�?�?ة ض�?�? رح�?ة ا�?إ�?حا�?', nullif(ot.owner_role, '')) description,
      'high'::text priority,
    ...
    where j.status in ('not_started','in_progress','completed')
      and (
        ...
        or (
          ...
          and lower(coalesce(ot.owner_role, '')) in ('employee','�?�?ظف')
        )
      )
  ), limited as (
...
-- decide_dispute_appeal(uuid,text,text)
...
begin
 ...
 perform public.enqueue_dispute_notification(v.case_id,v.appellant_employee_id,'appeal-decision:'||p_appeal_id::text,case when p_decision='accepted' then 'ت�? �?ب�?�? ا�?اعتراض �?إعادة فتح ا�?�?ش�?�?ة' else 'ت�? رفض ا�?اعتراض' end,trim(p_resolution),'high');
 perform public.log_audit_event('dispute.appeal_'||p_decision,'workflow','warning','dispute_appeals',p_appeal_id,'ا�?بت ف�? اعتراض',trim(p_resolution));
end $function$;

-- submit_my_dispute(text,text,text,text,timestamp with time zone,text,jsonb,jsonb,boolean,boolean,text,text,boolean,boolean,boolean)
CREATE OR REPLACE FUNCTION public.submit_my_dispute(p_title text, p_description text, p_case_type text, p_priority text DEFAULT 'normal'::text, p_incident_at timestamp with time zone DEFAULT NULL::timestamp with time zone, p_incident_location text DEFAULT NULL::text, p_parties jsonb DEFAULT '[]'::jsonb, p_witnesses jsonb DEFAULT '[]'::jsonb, p_direct_manager_contacted boolean DEFAULT NULL::boolean, p_amicable_attempted boolean DEFAULT NULL::boolean, p_amicable_result text DEFAULT NULL::text, p_requested_action text DEFAULT NULL::text, p_confidential boolean DEFAULT true, p_truth_confirmed boolean DEFAULT false, p_confidentiality_accepted boolean DEFAULT false)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
 ...
 values(v_id,'submit','submitted','ت�? ت�?د�?�? ا�?�?ش�?�?ة',v_emp,auth.uid(),jsonb_build_object('priority',p_priority));
 perform public.log_audit_event('dispute.submitted','workflow','notice','dispute_cases',v_id,'ت�?د�?�? �?ش�?�?ة جد�?دة',null,jsonb_build_object('caseNumber',v_number,'priority',p_priority));
 perform public.notify_dispute_admins(v_id,'submitted','�?ش�?�?ة جد�?دة ت�?تظر ا�?�?راجعة',v_number||' �? '||trim(p_title),case when p_priority='urgent' then 'urgent' else 'high' end);
 return v_id;
end $function$;

-- get_kpi_admin_catalog(date)
CREATE OR REPLACE FUNCTION public.get_kpi_admin_catalog(p_month date DEFAULT (date_trunc('month'::text, (now() AT TIME ZONE 'Africa/Cairo'::text)))::date)
 RETURNS jsonb
 LANGUAGE plpgsql
 STABLE SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
-- finalize_dispute_session_v2(uuid,text,jsonb,text,jsonb)
CREATE OR REPLACE FUNCTION public.finalize_dispute_session_v2(p_session_id uuid, p_minutes text, p_attendance jsonb, p_outcome text DEFAULT NULL::text, p_minutes_data jsonb DEFAULT '{}'::jsonb)
 RETURNS void
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
 ...
 perform public.log_audit_event('dispute.session_completed','workflow','notice','dispute_sessions',p_session_id,'حفظ �?حضر ج�?سة ا�?�?ش�?�?ة',null,jsonb_build_object('caseId',v_case.id,'present',v_present));
end $function$;
...
-- discipline_action_type_label(text)
...
AS $function$
  select case p_type
    when 'verbal_warning' then 'ت�?ب�?�? شف�?�?'
    when 'written_warning' then 'إ�?ذار �?تاب�?'
    when 'salary_deduction' then 'خص�? �?�? ا�?راتب'
    when 'suspension' then 'إ�?�?اف �?ؤ�?ت'
    when 'termination' then 'إ�?�?اء خد�?ة'
...
begin
  ...
  if not found then raise exception '�?�? �?ت�? ا�?عث�?ر ع�?�? ا�?ت�?�?�?ف' using errcode='P0002'; end if;
  if v_asg.assignment_type <> 'FUNDRAISING' then
    raise exception 'ف�?ط ج�?ع ا�?تبرعات �?رتبط ب�?دف �?ا�?�?' using errcode='22023';
  end if;
  if v_asg.target_amount is null or v_asg.target_amount <= 0 then
    raise exception 'ا�?ت�?�?�?ف ب�?ا �?دف �?ا�?�?' using errcode='22023';
  end if;
  ...
  if v_row.id is null then
    raise exception 'ASSIGNMENT_ALREADY_COUNTED (�?�?�?�?�?¹ �?§�?�?�?§�?­�?ª�?³�?§�?¨ �?§�?�?�?�?�?²�?¯�?�?�?¬)' using errcode='23505';
  end if;
  ...
  values(
    p_evaluation_id, format('�?�?�?³�?ª�?�?�?¯�? �?�?§�?�?�?¯�?�?: %s', v_asg.title), p_note,
  ...
  perform public.log_audit_event(
    ...
    'kpi_evaluations', p_evaluation_id, '�?±�?¨�?· �?�?§�?�?�?¯�?�? �?¨�?�?�?³�?ª�?�?�?¯�? �?�?�?§�?�?�?�?', p_note,
...
begin
  if auth.uid() is null then
    raise exception '�?�?ز�? تسج�?�? ا�?دخ�?�? أ�?�?ا�?' using errcode = '42501';
  end if;
  if length(trim(coalesce(p_installation_id, ''))) < 12 then
    raise exception '�?عر�?ف ج�?از غ�?ر صا�?ح' using errcode = '22023';
  end if;
  ...
  if v_existing_user is not null and v_existing_user <> auth.uid() then
    raise exception 'ا�?ج�?از �?سج�? ع�?�? حساب آخر' using errcode = '42501';
  end if;
...
-- finalize_verified_attendance(uuid,uuid,uuid,uuid,uuid,uuid,text,double precision,double precision,double precision,bigint,text,boolean)
CREATE OR REPLACE FUNCTION public.finalize_verified_attendance(p_operation_id uuid, p_correlation_id uuid, p_challenge_id uuid, p_credential_id uuid, p_employee_id uuid, p_user_id uuid, p_event_type text, p_latitude double precision, p_longitude double precision, p_accuracy_meters double precision, p_new_sign_count bigint, p_selfie_path text DEFAULT NULL::text, p_is_mock boolean DEFAULT false)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'extensions', 'pg_temp'
...
begin
  ...
  -- p_selfie_path اخت�?ار�?�? ع�?د �?ج�?د�? �?جب أ�? �?�?�?�? �?فتاح �?ائ�? داخ�? حا�?�?ة س�?�?ف�?
  -- ا�?حض�?ر�? �?�?�?�?�?دا�? ب�?ج�?�?د ا�?�?�?ظف صاحب ا�?بص�?ة:  <p_employee_id>/<yyyy>/<اس�?_ا�?�?�?ف>
  if p_selfie_path is not null then
    ...
    -- ا�?�?�?�?�?ة: �?جب أ�? �?بدأ ا�?�?سار ب�?ج�?�?د ا�?�?�?ظف �?فس�?  "<p_employee_id>/"
    -- (errcode 42501 �?طاب�?ة�? �?�? register_live_location_video). �?�?�?ة uuid ثابتة
    -- ا�?ط�?�? (36 �?حرفا�?) �?�?ا تح�?�? % أ�? _ ف�?ا خطر �?�? �?حارف LIKE.
    if p_selfie_path not like p_employee_id::text || '/%' then
      raise exception 'invalid_selfie_path_scope' using errcode = '42501';
    end if;
    -- تثب�?ت ا�?بِ�?�?ة:  <employee>/<yyyy>/<filename>  ب�?�?اطع غ�?ر فارغة �?ط�?�? �?حارف آ�?�?.
    -- ا�?�?رساة ^...$ تربط بدا�?ة/�?�?ا�?ة ا�?س�?س�?ة (�?ا ا�?سطر) ف�? POSIX regex ا�?خاص ب�? Postgres.
  ...
  if not v_device_exists then
    -- إذا �?�? �?�?�? �?�?ا�? ج�?از �?شط�? �?�?شئ ج�?از بحا�?ة pending
    -- �?�?رفض تسج�?�? ا�?حض�?ر حت�? �?ُعت�?د ا�?ج�?از �?�? ا�?�?سؤ�?�?.
    insert into public.employee_devices(
      employee_id, user_id, device_identifier_hash, credential_id, public_key,
      device_name, platform, status, registered_at, metadata
    ) values (
      ...
      coalesce(v_credential.device_label, '�?اتف ا�?�?�?ظف'), 'android', 'pending', now(),
    ...
    -- إعادة فحص: �?�? أصبح ا�?ج�?از �?شطا�? بعد ا�?�? upsert�?
    select exists (
      select 1 from public.employee_devices d
      where d.employee_id = p_employee_id
        and d.user_id = p_user_id
...
begin
 ...
 return jsonb_build_object(
  'cases',coalesce((select jsonb_agg(jsonb_build_object(
   'id',c.id,'caseNumber',c.case_number,'title',case when c.actor_employee_id=v_emp then c.title else 'ط�?ب إفادة �?�? �?ج�?ة ح�? ا�?�?ش�?�?ات' end,
...
begin
  ...
  if p_decision not in ('approved','rejected') then
    raise exception '�?رار غ�?ر صا�?ح' using errcode = '22023';
  end if;
  ...
  perform public.log_audit_event(
    ...
    case when p_decision = 'approved' then '�?ª�?�? �?§�?¹�?ª�?�?�?§�?¯ �?§�?�?�?¥�?¬�?±�?§�?¡ �?§�?�?�?ª�?£�?¯�?�?�?¨�?�?' else '�?ª�?�? �?±�?�?¶ �?§�?�?�?¥�?¬�?±�?§�?¡ �?§�?�?�?ª�?£�?¯�?�?�?¨�?�?' end,
    null,
...
begin
  ...
  if not found then
    raise exception 'ا�?تع�?�?�? غ�?ر �?�?ج�?د' using errcode = 'P0002';
  end if;

  if v_owner is distinct from v_me and not public.current_is_full_access() then
    raise exception 'غ�?ر �?صرح �?�? بحذف �?ذا ا�?تع�?�?�?' using errcode = '42501';
  end if;
...
begin
  ...
  if not v_allowed then
    raise exception '�?ص�?�? ا�?�?�?ظف�?�? ا�?ت�?ف�?ذ�? �?رف�?ض' using errcode = '42501';
  end if;
...
begin
  if not (public.current_is_full_access()
    ...
    raise exception 'غ�?ر �?صرح �?�? بإدارة ا�?أد�?ار' using errcode = '42501';
  end if;

  -- �?�?�?�?�?­ full-access �?�?�?­�?µ�?�?�?± �?¨�?�?super-admin �?�?�?�?·
  if p_is_full_access and not public.current_is_super_admin() then
    raise exception 'ا�?�?د�?ر ا�?أع�?�? ف�?ط �?�?�?ح ا�?�?ص�?�? ا�?�?ا�?�?' using errcode = '42501';
  end if;
  ...
  if p_id is not null then
    ...
    update public.roles set
      ...
      -- is_full_access �?�?�?ª�?º�?�?�?�?�?± �?�?�?�?· �?¨�?�?�?§�?³�?·�?© super-admin�?�? �?®�?�?�?§�? �?°�?�?�?�? �?�?�?¨�?�?�?�? �?�?�?�?�?§ �?�?�?�?
...
begin
  ...
  if not found then
    raise exception '�?�? تبدأ �?ذ�? ا�?�?أ�?�?ر�?ة بعد' using errcode = 'P0002';
  end if;
  if v_exec.employee_id <> v_me then
    raise exception '�?ذ�? ا�?�?أ�?�?ر�?ة �?�?ست �?س�?دة إ�?�?�?' using errcode = '42501';
  end if;
  if v_exec.status <> 'in_progress' then
    raise exception 'ت�? إ�?�?اء �?ذ�? ا�?�?أ�?�?ر�?ة با�?فع�?' using errcode = '22023';
  end if;
  if length(trim(coalesce(p_report, ''))) < 3 then
    raise exception '�?رج�? �?تابة ت�?ر�?ر �?ختصر ع�? ا�?�?أ�?�?ر�?ة (3 أحرف ع�?�? ا�?أ�?�?)' using errcode = '22023';
  end if;
...
begin
  if not (public.current_is_full_access() or public.has_permission('organization.department.manage') or public.has_permission('organization.unit.manage')) then
    raise exception 'إدارة ا�?أ�?سا�? �?رف�?ضة' using errcode = '42501';
  end if;
  if nullif(trim(p_code), '') is null or nullif(trim(p_name), '') is null then
    raise exception '�?�?د �?اس�? ا�?�?س�? �?ط�?�?با�?' using errcode = '22023';
  end if;
  if p_legal_entity_id is null then
    raise exception 'ا�?�?�?ا�? ا�?�?ا�?�?�?�? �?ط�?�?ب' using errcode = '22023';
  end if;
  if p_id is not null and p_parent_id = p_id then
    raise exception 'ا�?�?س�? �?ا �?تبع �?فس�?' using errcode = '22023';
  end if;
  ...
  if p_id is not null and p_parent_id is not null then
    ...
    if v_cycle then
      raise exception 'د�?رة ف�? تس�?س�? ا�?أ�?سا�?' using errcode = '22023';
    end if;
  end if;
  ...
  if p_id is null then
    ...
    where id = p_id
    returning id into v_id;
    if v_id is null then raise exception 'ا�?�?س�? غ�?ر �?�?ج�?د' using errcode = 'P0002'; end if;
  end if;
  return v_id;
end;
$function$;
...
begin
  ...
  -- 0457: �?§�?³�?ª�?®�?¯�?§�?�? resolve_request_approver �?¨�?¯�?�?�?§�?�? �?�?�?�? lookup �?�?�?¨�?§�?´�?±.
  -- �?�?�?¶�?�?�?�? �?§�?�?�?ª�?�?�?¬�?�?�?�? �?§�?�?�?µ�?­�?�?�?­ �?�?�?·�?�?�?¨�?§�?ª �?§�?�?�?ª�?´�?º�?�?�?�?â�?�?�?ª�?�?�?�?�?�?°�?�? + �?§�?�?�?³�?�?�?�?�?· �?¹�?�?�?�? HR + �?�?�?�?�?¹ �?§�?�?�?�?�?�?�?§�?�?�?�?© �?§�?�?�?°�?§�?ª�?�?�?©.
...
begin
  ...
  if not (public.can_manage_assignment_type(v_row.assignment_type)
    ...
    raise exception 'غ�?ر �?صرح �?�? بحس�? �?ذا ا�?ت�?�?�?ف' using errcode = '42501';
  end if;
  ...
  loop
    perform public.notify_employee(
      v_part,
      case p_decision when 'approve' then '�?ª�?�? �?§�?¹�?ª�?�?�?§�?¯ �?ª�?�?�?�?�?�?�?�?�?' else '�?ª�?�? �?±�?�?¶ �?ª�?�?�?�?�?�?�?�?�?' end,
      format('%s: %s', case v_row.assignment_type
                         when 'MISSION' then '�?�?�?£�?�?�?�?�?±�?�?�?©'
                         when 'CONVOY' then '�?�?�?§�?�?�?�?©'
                         else '�?�?§�?�?�?¯�?�?' end, v_row.title),
...
begin
  if length(trim(coalesce(p_report,''))) < 3 then
    raise exception 'ا�?ت�?ر�?ر �?ط�?�?ب' using errcode = '22023';
  end if;
...
-- _build_attendance_statement_v266(uuid,integer,integer)
...
begin
  ...
  loop
    ...
    v_is_scheduled := v_status not in ('راحة أسب�?ع�?ة', 'عط�?ة رس�?�?ة');
    v_is_excused :=
        ...
        if not v_is_excused then
          if v_daily.first_check_in is not null then
            ...
            if v_daily.last_check_out is not null then
              ...
              v_status := 'حاضر �? با�?تظار ا�?ا�?صراف';
            else
              -- Overdue without checkout: it is due and flagged.
              v_is_due := true;
              v_missing_out := true;
              v_missing_checkout := v_missing_checkout + 1;
              v_status := 'حض�?ر �?ا�?ص �? �?�? �?سج�? ا�?ا�?صراف';
            end if;
  ...
  v_result := v_result || jsonb_build_object(
    ...
    'summary', (v_result->'summary') || jsonb_build_object(
      ...
      -- ا�?ا�?تزا�? با�?ساعات �?�? د�?ائ�? ا�?أ�?ا�? ا�?�?ُ�?ف�?ة ف�?ط
...
begin
  ...
  if p_updates is null or jsonb_typeof(p_updates) <> 'object' then
    raise exception 'ا�?تحد�?ثات �?جب أ�? ت�?�?�? �?ائ�? JSON' using errcode='22023';
  end if;
...
-- get_executive_attendance_overview(date)
...
begin
  ...
  -- �?�?�? �?راءة �?�? ا�?�? materialized view ع�?د ط�?ب ا�?�?�?�? ا�?حا�?�? �?�?�?
  ...
  classified as (
    select *,
      case
        ...
        when extract(isodow from v_date) = 5 then 'weekend'  -- 0447: fallback أخ�?ر (0333/0402)
        else 'not_yet'
      end as derived_status
    from base
  )
...
begin
  ...
  if p_action_type not in ('verbal_warning','written_warning','salary_deduction','suspension','termination') then
    raise exception '�?�?ع إجراء غ�?ر صا�?ح' using errcode = '22023';
  end if;

  if p_action_type = 'salary_deduction' and (p_amount is null or p_amount <= 0) then
    raise exception 'ا�?�?ب�?غ �?ط�?�?ب �?�?خص�? �?�? ا�?راتب' using errcode = '22023';
  end if;
  ...
  perform public.notify_employee(
    p_employee_id,
    '�?¥�?¬�?±�?§�?¡ �?ª�?£�?¯�?�?�?¨�?�? �?¨�?§�?�?�?ª�?¸�?§�?± �?§�?�?�?�?�?±�?§�?¬�?¹�?©',
    '�?ª�?�? �?ª�?³�?¬�?�?�?�? �?¥�?¬�?±�?§�?¡ (' || public.discipline_action_type_label(p_action_type) || ') �?¹�?�?�?�? �?�?�?�?�?�?�? �?�?�?�?�?�? �?¨�?§�?�?�?ª�?¸�?§�?± �?§�?�?�?§�?¹�?ª�?�?�?§�?¯.',
...
declare
  ...
  v_deep_link text;
begin
  if v_me is null then raise exception '�?ا �?�?جد �?�?ف �?�?ظف �?صاحب ا�?ط�?ب' using errcode='42501'; end if;
  if not (public.current_is_full_access() or public.current_has_active_role(array['executive', 'executive-director'])) then
    raise exception 'ا�?�?د�?ر ا�?ت�?ف�?ذ�? ف�?ط �?ط�?ب �?�?�?ع ا�?�?�?ظف' using errcode='42501';
  end if;
  if p_employee_id = v_me then raise exception '�?ا �?�?�?�?�? ط�?ب �?�?�?ع�?' using errcode='22023'; end if;

  -- 0444: �?§�?�?�?�?�?¯�?�?�?± �?§�?�?�?ª�?�?�?�?�?�?°�?�? �?�?�?§ �?�?�?�?·�?�?�?¨ �?�?�?�?�?�?�?¹�?�? â�?�? �?�?�?�? �?�?�?�?· �?�?�?�? �?�?�?·�?�?�?¨ �?�?�?�?�?§�?�?�?¹ �?§�?�?�?¢�?®�?±�?�?�?�?
  if public.is_employee_executive(p_employee_id) then
    raise exception '�?ا �?�?�?�? ط�?ب �?�?�?ع ا�?�?د�?ر ا�?ت�?ف�?ذ�?' using errcode='22023';
  end if;
  ...
  if not exists (
    ...
    raise exception 'ا�?�?�?ظف غ�?ر �?شط أ�? ب�?ا حساب �?رتبط' using errcode='P0002';
  end if;
  ...
  perform public.log_audit_event(
    ...
    'live_location_requests', v_req.id, '�?ª�?�? �?·�?�?�?¨ �?§�?�?�?�?�?�?�?�?�?¹ �?§�?�?�?�?�?­�?¸�?�?', null,
...
begin
  ...
  if v_row.id is null then raise exception 'ا�?جزاء غ�?ر �?�?ج�?د أ�? غ�?ر �?اب�? �?�?إس�?اط' using errcode='P0002'; end if;

  perform public.log_audit_event(
    'penalty.waived', 'financial', 'info',
    'employee_penalties', v_row.id, '�?¥�?³�?�?�?§�?· �?�?�?®�?§�?�?�?�?© �?�?�?§�?�?�?�?�?©', null,
...
begin
  ...
  if p_amount is null or p_amount < 0 then raise exception '�?ب�?غ غ�?ر صا�?ح' using errcode='22023'; end if;
  if nullif(trim(p_penalty_type), '') is null then raise exception '�?�?ع جزاء غ�?ر صا�?ح' using errcode='22023'; end if;
  if nullif(trim(p_reason), '') is null then raise exception 'reason is required' using errcode='22023'; end if;
  ...
  perform public.log_audit_event(
    ...
    'employee_penalties', v_row.id, '�?¥�?µ�?¯�?§�?± �?�?�?®�?§�?�?�?�?© �?�?�?§�?�?�?�?�?©', null,
...
begin
  ...
  if not exists (
    ...
    raise exception '�?جب اعت�?اد أ�? ترح�?�? د�?رة ا�?ر�?اتب' using errcode='P0002';
  end if;
  ...
  if v_count = 0 then raise exception '�?ا �?سائ�? �?اب�?ة �?�?دفع بأر�?ا�? �?�?اتف' using errcode='P0002'; end if;
  ...
  perform public.log_audit_event(
    ...
    'payroll_instapay_batches', v_batch.id, '�?ª�?�?�?�?�?�?�?¯ �?¯�?�?¹�?© InstaPay �?�?�?µ�?±�? �?§�?�?�?±�?�?�?§�?ª�?¨', null,
...
begin
  ...
  select * into v_req from public.requests where id = p_request_id;
  if not found then
    raise exception '�?�? �?ت�? ا�?عث�?ر ع�?�? ط�?ب ا�?�?أ�?�?ر�?ة' using errcode = 'P0002';
  end if;
  if v_req.employee_id <> v_me then
    raise exception '�?ذ�? ا�?�?أ�?�?ر�?ة �?�?ست �?س�?دة إ�?�?�?' using errcode = '42501';
  end if;
  if v_req.request_type not in ('mission','convoy','fundraising') then
    raise exception '�?ذا ا�?ط�?ب �?�?س �?أ�?�?ر�?ة أ�? ت�?�?�?فا�?' using errcode = '22023';
  end if;
  if v_req.status <> 'approved' then
    raise exception '�?جب اعت�?اد ا�?�?أ�?�?ر�?ة �?ب�? بدئ�?ا �? راجع ا�?إدارة' using errcode = '22023';
  end if;
  ...
  if exists (
    ...
    raise exception 'ت�? بدء �?ذ�? ا�?�?أ�?�?ر�?ة �?سب�?�?ا' using errcode = '22023';
  end if;
  ...
  if v_end is not null and v_today > v_end then
    raise exception '�?ا �?�?�?�? بدء ا�?�?أ�?�?ر�?ة بعد ا�?ت�?اء �?دت�?ا' using errcode = '22023';
  end if;
...
AS $function$
begin
  -- فارغة ع�?دا�?: ت�?ف�?ر ا�?�?�?ظف�?�? �?ت�? صراحة�? �?�?�?س عبر �?حف�?ز auth.users.
  return new;
end;
$function$;

-- tg_employees_protect_job_fields()
...
BEGIN
  ...
  IF (
    ...
    IF NOT (
      ...
      RAISE EXCEPTION 'ERR_FORBIDDEN: تعد�?�? ا�?ح�?�?�? ا�?حساسة �?تط�?ب ص�?اح�?ة people.employee.update_sensitive'
        USING ERRCODE = '42501';
    END IF;
  END IF;
...
-- adjust_leave_balance(uuid,uuid,integer,numeric,text)
CREATE OR REPLACE FUNCTION public.adjust_leave_balance(p_employee_id uuid, p_leave_type_id uuid, p_year integer, p_units numeric, p_reason text)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
  ...
  perform public.log_audit_event('leave.balance.adjusted','hr','warning','leave_balance_accounts',v_entry.account_id,'تعد�?�? رص�?د إجازة',p_reason,jsonb_build_object('employeeId',p_employee_id,'leaveTypeId',p_leave_type_id,'units',p_units,'year',p_year));
  return v_entry.id;
end $function$;

-- can_access_employee(uuid)
...
-- _build_attendance_statement(uuid,integer,integer)
...
begin
  ...
  -- طب�?ة 0354: أع�?ا�? ا�?ط�?بات ا�?�?ع�?�?�?ة + إ�?غاء ا�?غ�?اب + «با�?تظار ا�?اعت�?اد» +
  -- ح�?�?�? ا�?عرض ا�?�?�?س�?�?ة (ف�?�? days �?�? v286).
  ...
  loop
    ...
    -- �?�?�? ع�?�?�? ط�?ب �?ع�?�?�? �?�?ا تغط�?�? �?اعدة أخر�? (حض�?ر فع�?�?/ط�?ب �?عت�?د/عط�?ة) �? «با�?تظار ا�?اعت�?اد»
    if (v_pending_leave or v_pending_mission or v_pending_convoy)
       and v_is_absent
       and v_ci is null then
      v_status := case
        when v_pending_leave then 'با�?تظار اعت�?اد إجازة'
        when v_pending_mission then 'با�?تظار اعت�?اد �?أ�?�?ر�?ة'
        else 'با�?تظار اعت�?اد ت�?�?�?ف'
      end;
      v_is_absent := false;
      v_pending_days := v_pending_days + 1;
    end if;

    -- 0362: adminOverride.leaveType �? إ�? �?ا�? v286 أخرج override �?�?�?�?�?.
...
-- _admin_approve_request_immediately(uuid)
...
begin
  ...
  update public.request_steps
    set status = 'skipped', acted_at = now(), acted_by = v_me,
        comment = 'اعت�?اد إدار�? �?باشر �?�? تصح�?ح �?�?�? ا�?حض�?ر', updated_at = now()
    where request_id = v_row.id and status in ('active','pending');
...
begin
  if not (public.current_is_full_access() or public.has_permission('access.break_glass.request')) then raise exception 'ط�?ب ا�?استث�?اء ا�?طارئ �?رف�?ض' using errcode='42501'; end if;
  ...
  if p_duration_minutes not between 5 and 240 then raise exception 'ا�?�?دة خارج ا�?�?طا�?' using errcode='22023'; end if;
  ...
  perform public.notify_employees_with_permission(
    ...
    '�?·�?�?�?¨ Break Glass �?¨�?§�?�?�?ª�?¸�?§�?± �?§�?¹�?ª�?�?�?§�?¯�?�?',
    format('�?·�?�?�?¨ �?�?�?µ�?�?�?�? �?§�?³�?ª�?«�?�?�?§�?¦�?�? �?�?�?¯�?�?�?± %s �?�?�?�?�?¯�?© %s �?¯�?�?�?�?�?�?�?©.', v_role.slug, p_duration_minutes),
...
begin
  ...
  if not found or v_req.employee_id is distinct from v_me then
    raise exception '�?�? �?ت�? ا�?عث�?ر ع�?�? ا�?ط�?ب' using errcode = 'P0002';
  end if;
  if p_storage_path not like v_me::text || '/' || p_request_id::text || '/%.png' then
    raise exception '�?سار �?�?طة ا�?خر�?طة غ�?ر صا�?ح' using errcode = '42501';
  end if;
  ...
  returning * into v_row;
  if not found then
    raise exception '�?�?طة ا�?�?�?�?ع �?ط�?�?بة �?ب�? �?�?طة ا�?خر�?طة' using errcode = '22023';
  end if;

  perform public.log_audit_event(
    'live_location_map_snapshot_registered', 'security', 'info',
    'location_request_responses', v_row.id, '�?ª�?³�?¬�?�?�?�? �?�?�?�?�?·�?© �?®�?±�?�?�?·�?© �?®�?§�?µ�?©', null,
...
begin
  ...
  if not public.has_permission('alerts.broadcast.send') then
    raise exception 'ص�?اح�?ة ا�?ت�?ب�?�? ا�?شا�?�? �?ط�?�?بة' using errcode = '42501';
  end if;
  if length(trim(coalesce(p_message, ''))) < 3
     or length(trim(p_message)) > 300 then
    raise exception 'ا�?رسا�?ة �?جب أ�? ت�?�?�? ب�?�? 3 �?300 حرف' using errcode = '22023';
  end if;
...
-- save_kpi_review_session(uuid,jsonb)
...
begin
 ...
 returning id into v_id;
 perform public.log_audit_event('kpi.session.saved','workflow','notice','kpi_review_sessions',v_id,'تسج�?�? ج�?سة ت�?�?�?�? ا�?�?�?ظف �?ا�?�?د�?ر',null,jsonb_build_object('evaluationId',p_evaluation_id));
 return v_id;
end $function$;
...
begin
  ...
  for update;
  if not found then
    raise exception '�?ا �?�?جد ط�?ب �?شط' using errcode = 'P0002';
  end if;
  ...
  if v_mode in ('snapshot','location_video') and not exists (
    ...
    raise exception '�?�?طة ا�?�?�?�?ع �?ط�?�?بة' using errcode = '22023';
  end if;
...
begin
  ...
  if v_result is null then
    raise exception 'ط�?ب ا�?�?�?�?ع غ�?ر �?�?ج�?د أ�? غ�?ر �?رئ�?' using errcode = 'P0002';
  end if;
  return v_result;
end;
$function$;
...
begin
  ...
  if v_credential.id is null then
    raise exception '�?فتاح ا�?ج�?از غ�?ر �?�?ج�?د' using errcode='P0002';
  end if;
...
begin
  if not (public.current_is_full_access() or public.has_any_permission(array['access.role.read','access.role.update','access.role.assign'])) then
    raise exception '�?ص�?�? �?تا�?�?ج ا�?ص�?اح�?ات �?رف�?ض' using errcode = '42501';
  end if;
...
begin
  ...
  if not (
    ...
    raise exception 'ص�?اح�?ة �?ر�?ز ا�?ع�?�?�?ات �?ط�?�?بة' using errcode = '42501';
  end if;
  ...
  from (
    select jsonb_build_object(
      ...
      'assigneeName', coalesce(a.full_name_ar, '�?º�?�?�?± �?�?�?¹�?�?�?�?�?�?'),
      'priority', t.priority,
      'dueDate', t.due_date,
      'status', t.status
    ) as j
  ...
  from (
    select jsonb_build_object(
      'id', m.id,
      'employeeName', coalesce(me.full_name_ar, '�?�?�?�?�?¸�?'),
  ...
  from (
    select jsonb_build_object(
      'id', c.id,
      'employeeName', coalesce(ce.full_name_ar, '�?�?�?�?�?¸�?'),
      'name', c.convoy_name,
      'origin', c.origin,
...
begin
  ...
  perform public.log_audit_event(
    ...
    'employees',
    v_employee_id,
    'تفع�?�? ا�?�?�?ظف بعد أ�?�? دخ�?�? �?تغ�?�?ر �?�?�?ة ا�?�?ر�?ر',
    null,
...
begin
  if v_manager_id is null or p_employee_id is null then
    raise exception 'س�?ا�? ا�?�?�?ظف �?ط�?�?ب' using errcode = '42501';
  end if;
  if p_employee_id=v_manager_id then
    raise exception 'استخد�? �?سار ا�?�?�?ا�? ا�?شخص�?ة �?�?�?ا�?�?' using errcode = '22023';
  end if;
  if length(trim(coalesce(p_title,''))) < 3 then
    raise exception 'ع�?�?ا�? ا�?�?�?�?ة �?ط�?�?ب' using errcode = '22023';
  end if;
  if p_priority not in ('low','medium','high','urgent') then
    raise exception 'أ�?�?�?�?ة �?�?�?ة غ�?ر �?دع�?�?ة' using errcode = '22023';
  end if;
  if not (
    public.current_is_full_access()
    ...
    raise exception '�?طا�? إس�?اد ا�?�?�?ا�? �?رف�?ض' using errcode = '42501';
  end if;
...
begin
  ...
  if not found then raise exception '�?�? �?ت�? ا�?عث�?ر ع�?�? ا�?ط�?ب' using errcode = 'P0002'; end if;
  if v_req.status <> 'pending' then
    raise exception 'ا�?ط�?بات �?�?د ا�?ا�?تظار ف�?ط تُعاد إس�?اد�?ا' using errcode = '22023';
  end if;
  if p_new_manager_id = v_req.employee_id then
    raise exception '�?ا �?�?�?�? تع�?�?�? صاحب ا�?ط�?ب �?عت�?دا�? �?�?' using errcode = '42501';
  end if;
  ...
  perform public.notify_employee(p_new_manager_id, '�?£�?�?³�?�?�?¯ �?¥�?�?�?�?�?�? �?·�?�?�?¨ �?�?�?�?�?�?�?±�?§�?±',
    format('�?ª�?�? �?�?�?�?�?�? �?§�?�?�?·�?�?�?¨ #%s �?¥�?�?�?�?�?�?.', p_request_id), 'request', 'high', 'requests', p_request_id);

  perform public.log_audit_event('request.reassigned', 'workflow', 'warning',
    'requests', p_request_id, '�?�?�?�?�?�? �?·�?�?�?¨ �?�?�?�? �?�?�?¯�?�?�?± �?¥�?�?�?�? �?¢�?®�?±', p_reason,
    jsonb_build_object('previousManagerId', v_old, 'newManagerId', p_new_manager_id));
  return v_req;
end $function$;
...
-- change_employee_manager_admin(uuid,uuid,text)
CREATE OR REPLACE FUNCTION public.change_employee_manager_admin(p_employee_id uuid, p_manager_id uuid, p_reason text)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
  ...
  perform public.log_audit_event(
    ...
    'تغ�?�?ر ا�?�?د�?ر ا�?�?باشر',trim(p_reason),jsonb_build_object(
...
-- _build_attendance_statement_v286(uuid,integer,integer)
...
-- submit_kpi_appeal(uuid,text,text)
CREATE OR REPLACE FUNCTION public.submit_kpi_appeal(p_evaluation_id uuid, p_reason text, p_requested_outcome text DEFAULT NULL::text)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
 ...
 returning id into v_id;
 perform public.log_audit_event('kpi.appeal.submitted','workflow','warning','kpi_appeals',v_id,'ت�?د�?�? اعتراض ع�?�? KPI',trim(p_reason),jsonb_build_object('evaluationId',p_evaluation_id));
 return v_id;
end $function$;

-- _fmt_minutes_ar(integer)
...
AS $function$
  select case
    ...
    else (p_minutes / 60) || ' س �? ' || (p_minutes % 60) || ' د'
  end;
$function$;

-- _fmt_time_12h(time without time zone)
CREATE OR REPLACE FUNCTION public._fmt_time_12h(p_time time without time zone)
 RETURNS text
 LANGUAGE sql
 IMMUTABLE
AS $function$
  select case
    ...
    when extract(hour from p_time) = 12
      then '12:' || lpad(extract(minute from p_time)::text, 2, '0') || ' �?'
    else lpad((extract(hour from p_time) - 12)::text, 2, '0') || ':' || lpad(extract(minute from p_time)::text, 2, '0') || ' �?'
  end;
$function$;
...
begin
  -- �?§�?�?�?³�?�?�?§�?�?�?§�?ª �?§�?�?�?�?�?�?�?«�?�?�?�?�?© �?ª�?�?�?± �?�?�?¨�?§�?´�?±�?©. �?�?�?§ �?�?�?³�?ª�?®�?¯�?�? current_user �?�?�?�?�?§ �?�?�?£�?�?�?�? �?¯�?§�?®�?�? �?¯�?§�?�?�?©
  -- security definer �?�?�?¹�?�?�?¯ �?¨�?§�?³�?�? �?§�?�?�?�?�?§�?�?�?�? (postgres) �?¯�?§�?¦�?�?�?§�?�? â�?�? �?¨�?�? �?�?�?³�?ª�?®�?¯�?�? auth.role()
  -- �?§�?�?�?�?�?³�?ª�?®�?±�?¬�?© �?�?�?�? JWT �?§�?�?�?·�?�?�?¨ (�?�?�?�?�?· �?�?�?·�?¨�?�?�?�? �?�?�? 0026/0033).
  ...
  if new.primary_role_id is distinct from old.primary_role_id then
    raise exception 'غ�?ر �?صرح بتغ�?�?ر ا�?د�?ر ا�?أساس�?' using errcode = '42501';
  end if;
  if new.employee_id is distinct from old.employee_id then
    raise exception 'غ�?ر �?صرح بتغ�?�?ر �?عر�?ف ا�?�?�?ظف' using errcode = '42501';
  end if;

  -- �?§�?�?�?ª�?�?¹�?�?�?�? �?§�?�?�?°�?§�?ª�?�?: �?§�?�?�?�?�?�?�?¸�? �?�?�?�?¹�?�?�?�? �?�?�?�?�?�?�? �?¨�?�?�?�?³�?�? �?¨�?¹�?¯ �?£�?�?�?�? �?¶�?¨�?· �?�?�?�?�?�?�?© �?�?�?±�?�?�?±
  -- (activate_employee_after_first_login �?�?�?�? �?§�?�?�?�?�?�?�?¨/�?§�?�?�?�?�?�?�?¨�?§�?�?�?�?) â�?�? �?§�?�?�?�?�?³�?§�?± �?§�?�?�?�?�?­�?�?�?¯
  -- �?§�?�?�?�?�?³�?�?�?�?�?­ �?�?�?º�?�?�?± �?§�?�?�?�?�?®�?�?�?�?�?�? �?�?�?ª�?º�?�?�?�?�?± status/temporary_password.
  v_self_activation :=
       new.id = auth.uid()
  ...
  if new.status is distinct from old.status and not v_self_activation then
    raise exception 'غ�?ر �?صرح �?�? بتغ�?�?ر ا�?حا�?ة' using errcode = '42501';
  end if;
  if new.temporary_password is distinct from old.temporary_password and not v_self_activation then
    raise exception 'غ�?ر �?صرح بتغ�?�?ر �?�?�?ة ا�?�?ر�?ر ا�?�?ؤ�?تة' using errcode = '42501';
  end if;
...
AS $function$
  ...
  select case
    ...
    -- أ�? �?خطط (scheme:) �?رف�?ض �? ع�?�? ا�?�?�?�?ة ا�?�?ُ�?ظ�?�?فة (�?ش�?�? ا�?فراغ ا�?بادئ)
    when (select v from n) ~ '^[a-zA-Z][a-zA-Z0-9+.-]*:' then false
    -- رفض ا�?�?سار ا�?�?ط�?�? �?ا�?ر�?ابط ب�?ا-�?خطط (/ أ�? \ أ�? خ�?ط�?�?ا ف�? ا�?بدا�?ة)
...
-- manage_kpi_cycle(uuid,text,text,timestamp with time zone)
CREATE OR REPLACE FUNCTION public.manage_kpi_cycle(p_cycle_id uuid, p_action text, p_reason text, p_extended_until timestamp with time zone DEFAULT NULL::timestamp with time zone)
 RETURNS kpi_cycles
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
 ...
 select * into strict v_cycle from public.kpi_cycles where id=p_cycle_id;
 perform public.log_audit_event('kpi.cycle.'||p_action,'workflow','warning','kpi_cycles',p_cycle_id,'تح�?�? ا�?س�?رت�?ر ا�?ت�?ف�?ذ�? ف�? د�?رة KPI',trim(p_reason),jsonb_build_object('oldStatus',v_old,'newStatus',v_cycle.status,'extendedUntil',p_extended_until));
 return v_cycle;
end $function$;

-- register_employee_document_admin(uuid,text,text,text,text,date,date,text,text,bigint)
CREATE OR REPLACE FUNCTION public.register_employee_document_admin(p_employee_id uuid, p_doc_type text, p_title text, p_storage_path text, p_doc_number text DEFAULT NULL::text, p_issue_date date DEFAULT NULL::date, p_expiry date DEFAULT NULL::date, p_file_hash text DEFAULT NULL::text, p_mime_type text DEFAULT NULL::text, p_size_bytes bigint DEFAULT NULL::bigint)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
 ...
 perform public.log_audit_event('documents.employee.registered','data','notice','employee_documents',v_id,'تسج�?�? �?ست�?د �?�?ظف',null,jsonb_build_object('employeeId',p_employee_id,'docType',p_doc_type)); return v_id;
end $function$;
...
begin
  ...
  if not (public.current_is_full_access() or public.has_permission('access.role.assign')) then
    raise exception 'غ�?ر �?صرح �?�? بإس�?اد ا�?أد�?ار' using errcode = '42501';
  end if;
  ...
  if v_role.is_full_access and not public.current_is_super_admin() then
    raise exception 'ا�?�?د�?ر ا�?أع�?�? ف�?ط �?س�?د د�?ر ا�?�?ص�?�? ا�?�?ا�?�?' using errcode = '42501';
  end if;

  -- �?�?�?�?�?¹ �?�?�?�?�?­ �?§�?�?�?�?�?�?³ �?¯�?�?�?±�?§�?�? �?£�?¹�?�?�?�?
  if p_user_id = auth.uid() and v_role.is_full_access then
    raise exception '�?ا �?�?�?�?�? �?�?ح �?فس�? ا�?�?ص�?�? ا�?�?ا�?�?' using errcode = '42501';
  end if;
  ...
  if public.current_is_hr_only() then
    if v_role.slug = any(array[
      ...
      raise exception 'ا�?�?�?ارد ا�?بشر�?ة تس�?د أد�?ار ا�?�?�?ظف/ا�?�?د�?ر/ا�?ع�?�?�?ات ف�?ط'
        using errcode = '42501';
    end if;
  end if;
  ...
  perform public.log_audit_event(
    ...
    'user_roles',
    p_role_id,
    '�?ª�?�? �?¥�?³�?�?�?§�?¯ �?¯�?�?�?± �?«' || coalesce(v_role.name_ar, v_role.slug) || '�?»',
...
-- create_kpi_cycle_admin_safe(date,uuid,timestamp with time zone,timestamp with time zone,timestamp with time zone,timestamp with time zone,boolean,boolean)
CREATE OR REPLACE FUNCTION public.create_kpi_cycle_admin_safe(p_month date, p_template_id uuid, p_self_due timestamp with time zone, p_manager_due timestamp with time zone, p_secretary_due timestamp with time zone, p_executive_due timestamp with time zone, p_open_now boolean DEFAULT true, p_use_parallel_flow boolean DEFAULT false)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
  if not (public.current_is_full_access() or public.current_is_executive_secretary()) then
    return jsonb_build_object('ok', false, 'errorAr',
      '�?�?س �?د�?�? ص�?اح�?ة إ�?شاء د�?رة KPI. تحتاج د�?ر full-access أ�? س�?رت�?ر ت�?ف�?ذ�?.',
      'code', 'FORBIDDEN');
  end if;
  ...
  exception when others then
    ...
    v_ar_msg := case
      when v_sqlstate = '42501' then '�?�?س �?د�?�? ص�?اح�?ة. تأ�?د �?�? د�?ر�? ف�? جد�?�? user_roles.'
      when v_sqlstate = '23505' then 'ت�?جد د�?رة �?سج�?ة �?�?ذا ا�?ش�?ر با�?فع�?.'
      when v_sqlstate = '23503' then '�?�?جد �?رجع �?�?س�?ر ف�? ا�?ب�?ا�?ات (employee أ�? template غ�?ر صا�?ح).'
      when v_sqlstate = '23502' then 'ح�?�? �?ط�?�?ب فارغ ف�? �?اعدة ا�?ب�?ا�?ات.'
      when v_sqlstate = '23514' then '�?�?�?ة ت�?ت�?�? �?�?د تح�?�? ف�? �?اعدة ا�?ب�?ا�?ات.'
      when v_sqlstate = '22023' then '�?�?�?ة غ�?ر صا�?حة �?رس�?ة �?�?دا�?ة. تأ�?د �?�? ا�?ت�?ار�?خ.'
      when v_sqlstate = '42883' then 'ا�?دا�?ة غ�?ر �?�?ج�?دة با�?ت�?�?�?ع ا�?�?ط�?�?ب �? أعد تح�?�?�? schema cache.'
      when v_sqlstate = '42P01' then 'جد�?�? �?ف�?�?د ف�? �?اعدة ا�?ب�?ا�?ات: ' || coalesce(v_sqlerrm, '')
      when v_sqlstate = '42703' then 'ع�?�?د �?ف�?�?د ف�? �?اعدة ا�?ب�?ا�?ات: ' || coalesce(v_sqlerrm, '')
      when v_sqlstate = 'P0002' then '�?�? �?ُعثر ع�?�? سج�?: ' || coalesce(v_sqlerrm, '')
      else 'خطأ غ�?ر �?ت�?�?ع: ' || coalesce(v_sqlstate, '?') || ' �? ' || coalesce(left(v_sqlerrm, 200), '')
    end;
...
AS $function$
begin
  -- �?ح�?�? إ�?�? ا�?دا�?ة ا�?آ�?�?ة ا�?ت�? تعا�?ج �?�? ا�?تبع�?ات (auth, roles, manager_relations).
  perform public.archive_employee_secure(p_employee_id, 'deprecated soft_delete_employee redirect');
end;
$function$;

-- get_analytics_dashboard(integer)
...
begin
  ...
  from (
    ...
    where extract(isodow from d.day_date) not in (5, 6)   -- ا�?ج�?عة �?ا�?سبت راحة
    group by d.day_date
  ) w;

  -- �?�? 4. �?ت�?سطات KPI (آخر 6 د�?رات �?�?ت�?�?ة) �?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?
  select coalesce(
    jsonb_agg(
      jsonb_build_object(
...
-- tg_leave_settle_on_request_decision()
...
begin
  ...
  -- بد�? ا�?راحة ا�?أسب�?ع�?ة (0428): consume ع�?د ا�?اعت�?اد (إ�? �?ُجد حجز �? ت�?اف�?
  -- �?د�?�? �?�?ط�?بات ا�?�?�?د�?ة �?ب�? 0428)�? refund ع�?د إ�?غاء �?عت�?د�? release خ�?اف ذ�?�?.
    ...
    if new.status='approved' then
      ...
      if v_has_reserve then
        perform public.apply_leave_ledger_entry(
          ...
          'است�?�?ا�? رص�?د بد�? ا�?راحة بعد ا�?اعت�?اد'
        );
      end if;
  ...
  if new.status='approved' then
    perform public.apply_leave_ledger_entry(v_lr.employee_id,v_lr.leave_type_id,v_year,'consume',v_units,'leave:consume:'||new.id,new.id,'خص�? ا�?رص�?د بعد ا�?اعت�?اد');
  elsif new.status in ('rejected','cancelled','withdrawn','expired') then
    -- LEDGER-02: إ�?غاء ط�?ب �?عت�?د �? refund�? إ�?غاء �?�? حا�?ة �?ع�?�?ة �? release.
    if old.status='approved' then
      perform public.apply_leave_ledger_entry(v_lr.employee_id,v_lr.leave_type_id,v_year,'refund',v_units,'leave:refund:'||new.id||':'||new.status,new.id,'استرداد ا�?رص�?د بعد إ�?غاء ط�?ب �?عت�?د ('||new.status||')');
    else
      perform public.apply_leave_ledger_entry(v_lr.employee_id,v_lr.leave_type_id,v_year,'release',v_units,'leave:release:'||new.id||':'||new.status,new.id,'تحر�?ر ا�?حجز بعد '||new.status);
    end if;
  end if;
  return new;
end $function$;
...
begin
  ...
  if p_due_at is null or p_due_at <= now() then raise exception 'تار�?خ استح�?ا�? �?ست�?ب�?�? �?ط�?�?ب' using errcode='22023'; end if;
  ...
  perform public.log_audit_event('access.review.started','access','notice','access_review_campaigns',v_campaign.id,'�?¨�?¯�?¡ �?�?�?±�?§�?¬�?¹�?© �?µ�?�?�?§�?­�?�?�?§�?ª',p_description,jsonb_build_object('dueAt',p_due_at));
  return v_campaign;
end;
$function$;
...
begin
  if v_user_id is null then
    raise exception 'غ�?ر �?صرح' using errcode = 'P0001';
  end if;
...
begin
  if not (public.current_is_full_access() or public.has_any_permission(array['access.role.read','access.audit.read'])) then
    raise exception '�?ص�?�? ا�?�?ظرة ا�?عا�?ة �?رف�?ض' using errcode = '42501';
  end if;
  return jsonb_build_object(
...
-- propose_admin_action(uuid,text,text)
CREATE OR REPLACE FUNCTION public.propose_admin_action(p_case_id uuid, p_action text, p_detail text)
 RETURNS void
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO ''
...
declare v record;
begin
  -- ص�?اح�?ة: �?�?رر ا�?�?ج�?ة أ�? رئ�?س�?ا أ�? full-access
  if not(
    public.current_is_full_access()
...
-- decide_admin_action(uuid,text,text,text,text)
CREATE OR REPLACE FUNCTION public.decide_admin_action(p_case_id uuid, p_decision text, p_reason text, p_modified_action text DEFAULT NULL::text, p_modified_detail text DEFAULT NULL::text)
 RETURNS void
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO ''
...
declare
  ...
  v_new_status      text;
begin
  -- ص�?اح�?ة: ا�?�?د�?ر ا�?ت�?ف�?ذ�? أ�? full-access
  if not(
    public.current_is_full_access()
  ...
  if p_decision = 'approved' then
    ...
    -- rejected / deferred �? إعادة إ�?�? decision_issued �?�?ع�?د ا�?�?�?رر ا�?ا�?تراح
...
declare
  ...
  v_payload jsonb := coalesce(p_payload, '{}'::jsonb);
begin
  if v_me is null then raise exception '�?ا �?�?جد �?�?ظف �?رتبط' using errcode = '42501'; end if;
  if p_assignment_type not in ('MISSION','CONVOY','FUNDRAISING') then
    raise exception '�?�?ع ت�?�?�?ف غ�?ر صا�?ح' using errcode = '22023';
  end if;
  if length(trim(coalesce(p_title,''))) < 3 then
    raise exception 'ا�?ع�?�?ا�? �?ط�?�?ب' using errcode = '22023';
  end if;
  if p_start_at is null or p_end_at is null or p_end_at < p_start_at then
    raise exception 'فترة ت�?�?�?ف غ�?ر صا�?حة' using errcode = '22023';
  end if;
  if p_participant_ids is null or array_length(p_participant_ids,1) is null then
    raise exception '�?شار�? �?احد ع�?�? ا�?أ�?�? �?ط�?�?ب' using errcode = '22023';
  end if;
...
-- publish_announcement(uuid,text)
CREATE OR REPLACE FUNCTION public.publish_announcement(p_announcement_id uuid, p_channel text DEFAULT NULL::text)
...
begin
  ...
  if not (
    ...
    raise exception '�?�?س �?د�?�? ص�?اح�?ة �?شر ا�?�?�?ش�?رات' using errcode = '42501';
  end if;

  if v_channel not in ('web','mobile') then
    raise exception '�?�?اة �?شر غ�?ر صا�?حة: %', v_channel using errcode = '22023';
  end if;
  ...
  if not found then
    raise exception 'ا�?�?�?ش�?ر غ�?ر �?�?ج�?د أ�? �?�?س ف�? حا�?ة �?س�?دة' using errcode = 'P0002';
  end if;
...
begin
  if v_me is null then raise exception '�?ا �?�?جد �?�?ظف �?رتبط بحساب�?' using errcode='42501'; end if;
...
-- unlock_attendance_period(uuid,text)
...
begin
 ...
 perform public.log_audit_event('attendance.period.unlocked','security','warning','attendance_periods',p_period_id,'إعادة فتح فترة حض�?ر',p_reason,jsonb_build_object('period',v.period_month));
end $function$;
...
begin
  if not (public.current_is_full_access() or public.has_permission('organization.position.manage')) then
    raise exception 'إدارة ا�?�?�?اصب �?رف�?ضة' using errcode = '42501';
  end if;
  if p_department_id is null or nullif(trim(p_code), '') is null or nullif(trim(p_name), '') is null then
    raise exception 'ا�?�?س�? �?�?�?د �?اس�? ا�?�?�?صب �?ط�?�?بة' using errcode = '22023';
  end if;
  if coalesce(p_headcount, 0) < 0 then raise exception '�?ا �?�?�?�? أ�? �?�?�?�? ا�?عدد سا�?با�?' using errcode = '22023'; end if;
  if p_id is not null and p_reports_to_id = p_id then raise exception '�?ا �?�?�?�? أ�? �?تبع ا�?�?�?صب �?فس�?' using errcode = '22023'; end if;
  ...
  if p_id is not null and p_reports_to_id is not null then
    ...
    if v_cycle then raise exception 'ت�? رصد د�?رة ف�? تس�?س�? ا�?�?�?اصب' using errcode = '22023'; end if;
  end if;

  if p_team_id is not null and not exists (
    select 1 from public.teams t where t.id = p_team_id and t.department_id = p_department_id
  ) then
    raise exception 'ا�?فر�?�? �?ا �?تبع ا�?�?س�? ا�?�?ختار' using errcode = '22023';
  end if;
  ...
  if p_id is null then
    ...
    if v_id is null then raise exception 'ا�?�?�?صب غ�?ر �?�?ج�?د' using errcode = 'P0002'; end if;
  end if;
  return v_id;
end;
$function$;

-- advance_kpi_stage(uuid,text,jsonb,text)
CREATE OR REPLACE FUNCTION public.advance_kpi_stage(p_evaluation_id uuid, p_action text, p_scores jsonb DEFAULT NULL::jsonb, p_note text DEFAULT NULL::text)
 RETURNS kpi_evaluations
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
 ...
 -- رفض صر�?ح �?أفعا�? ا�?�?سارات ا�?�?د�?�?ة
 if p_action not in ('self','manager_review') then
   raise exception 'KPI_FLOW_SIMPLIFIED: % �?�? �?عد �?سارا�? صا�?حا�? �?�?ذ 0470 (self / manager_review ف�?ط)', p_action
     using errcode='22023';
 end if;
 ...
 if p_action='self' then
  ...
  perform public.log_audit_event('kpi.stage_advanced','workflow','notice','kpi_evaluations',v_eval.id,
   'إرسا�? ا�?ت�?�?�?�? ا�?ذات�? إ�?�? ا�?�?د�?ر (0470)',null,jsonb_build_object('to','manager_review'));
  return v_eval;
 end if;

 -- �?�?�?�?�?�?�?�?�?�? �?¡ ت�?�?�?�? ا�?�?د�?ر �?اعت�?اد�? ا�?�?�?ائ�? ف�? خط�?ة �?احدة �?�?�?�?�?�?�?�?�?�?
 if not public.kpi_can_approve(v_eval) then raise exception 'FORBIDDEN' using errcode='42501'; end if;
 ...
 -- ب�?�?د HR: ا�?حض�?ر �?ُحتسب �?�?ضع�?ا�? �?�?ذا ا�?ت�?�?�?�?�? �?�?ا ب�?�? ب�?ا إدخا�? �?أخذ ا�?درجة ا�?�?ا�?�?ة افتراض�?ا�? (ا�?استث�?اء با�?خص�?)
 for v_att in
 ...
 loop
  ...
  insert into public.kpi_scores(evaluation_id,criterion_id,score,reviewer_stage,note,created_by)
  values(v_eval.id,v_att.criterion_id,greatest(0,least(v_score,v_att.max_score)),'hr','�?حس�?ب آ�?�?ا�? �?�? ا�?حض�?ر (0470)',auth.uid())
  on conflict(evaluation_id,criterion_id,reviewer_stage) do update set score=excluded.score,note=excluded.note,updated_at=now();
 end loop;
 update public.kpi_evaluations set manager_comment=nullif(trim(p_note),''),updated_at=now() where id=v_eval.id;
 insert into public.kpi_scores(evaluation_id,criterion_id,score,reviewer_stage,note,created_by)
 select v_eval.id, c.id, c.max_score, 'hr', '�?�?�?ة افتراض�?ة (0470): �?ا استث�?اء �?سج�?ا�?', auth.uid()
...
on conflict (evaluation_id,criterion_id,reviewer_stage) do nothing;
 ...
 perform public.log_audit_event('kpi.monthly_report.included','workflow','info','kpi_evaluations',v_eval.id,
  'إدراج ا�?ت�?�?�?�? ف�? ا�?ت�?ر�?ر ا�?ش�?ر�?',null,jsonb_build_object('cycleId',v_eval.cycle_id));
 return v_eval;
end $function$;

-- trg_casual_leave_auto_approved_notify()
...
begin
  ...
  perform public.notify_employee(
    new.employee_id,
    'ت�? اعت�?اد إجازت�? ا�?عارضة',
    coalesce(new.title, 'ت�? تسج�?�? ا�?إجازة ا�?عارضة �?ت�?ف�?ذ�?ا �?باشرة.'),
    'request', 'normal', 'request', new.id,
    jsonb_build_object(
...
begin
 ...
 perform public.log_audit_event('dispute.cancelled_by_employee','workflow','notice','dispute_cases',p_case_id,'إ�?غاء ا�?�?ش�?�?ة �?ب�? �?ب�?�?�?ا',trim(p_reason));
end $function$;

-- has_scoped_permission(text,text,uuid)
CREATE OR REPLACE FUNCTION public.has_scoped_permission(p_permission_slug text, p_scope_type text DEFAULT NULL::text, p_scope_id uuid DEFAULT NULL::uuid)
 RETURNS boolean
 LANGUAGE plpgsql
 STABLE SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
-- override_kpi_score(uuid,uuid,numeric,text)
...
begin
 ...
 perform public.log_audit_event('kpi.score.overridden','workflow','warning','kpi_evaluations',p_evaluation_id,'تعد�?�? استث�?ائ�? �?�?ث�? �?درجة KPI',trim(p_reason),jsonb_build_object('criterionId',p_criterion_id,'oldScore',v_old,'newScore',p_score));
 return p_score;
end $function$;

-- get_dispute_case_recommendations(uuid)
...
begin
  -- �?فس ب�?ابة ا�?ص�?اح�?ة ا�?�?ستخد�?ة ف�? get_committee_dispute_portal
  if not(
    public.current_is_full_access()
...
AS $function$
  select coalesce(jsonb_agg(jsonb_build_object(
    ...
    'deviceId', d.id,
    'deviceLabel', coalesce(d.device_name, p.device_label, '�?اتف ا�?�?�?ظف'),
    'status', case
...
-- get_mobile_executive_brief(text)
CREATE OR REPLACE FUNCTION public.get_mobile_executive_brief(p_period text DEFAULT 'morning'::text)
 RETURNS jsonb
 LANGUAGE plpgsql
 STABLE SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
 ...
 return jsonb_build_object(
  ...
  'highlights',jsonb_build_array(
    jsonb_build_object('kind','attendance','title','�?�? �?سج�?�?ا بعد','value',coalesce((v_daily#>>'{attendance,notYet}')::integer,0),'severity','high','detail','�?�? ج�?�?ع ا�?�?�?ظف�?�? ا�?�?ط�?�?ب حض�?ر�?�? ا�?�?�?�?'),
    jsonb_build_object('kind','attendance','title','�?�? �?سج�?�?ا ا�?ا�?صراف','value',coalesce((v_daily#>>'{attendance,missingCheckout}')::integer,0),'severity','high','detail','حا�?ات تحتاج �?تابعة ا�?ت�?ا�? ا�?�?�?�?'),
    jsonb_build_object('kind','kpi','title','ت�?ار�?ر KPI جا�?زة','value',coalesce((v_daily#>>'{kpi,ready}')::integer,0),'severity','normal','detail','ت�?ار�?ر اعت�?د�?ا ا�?�?د�?ر ا�?�?باشر'),
    jsonb_build_object('kind','case','title','�?ضا�?ا جد�?دة','value',coalesce((v_daily#>>'{cases,new}')::integer,0),'severity','high','detail','�?ضا�?ا ت�?تظر بدء ا�?إجراء'),
    jsonb_build_object('kind','location','title','ط�?بات �?�?�?ع ب�?ا استجابة','value',coalesce((v_daily#>>'{followUp,unansweredLocationRequests}')::integer,0),'severity','critical','detail','ط�?بات �?شطة �?�? �?فتح�?ا ا�?�?ست�?�? بعد')
  ),
  'dailyReport',v_daily,'generatedAt',now(),'sourceLabel','�?صادر V10 ا�?تشغ�?�?�?ة ا�?�?باشرة'
 );
end $function$;
...
begin
  ...
  if not v_allowed then
    raise exception '�?ص�?�? �?ر�?ز ا�?�?�?ادة ا�?ت�?ف�?ذ�? �?رف�?ض' using errcode = '42501';
  end if;
...
-- submit_dispute_statement(uuid,text,text,text)
CREATE OR REPLACE FUNCTION public.submit_dispute_statement(p_case_id uuid, p_statement_type text, p_statement_text text, p_visibility text DEFAULT 'committee_only'::text)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
  ...
  -- 0198: ا�?س�?اح �?أصحاب ص�?اح�?ات ا�?�?ج�?ة بت�?د�?�? ت�?ص�?ات حت�? بد�?�? عض�?�?ة �?�?�? �?ض�?ة
  ...
  -- إذا �?�?س عض�? �?ج�?ة �?�?ا صاحب ص�?اح�?ة �?�?ا طرف �? �?�?�?�?ع
  ...
  -- committee_note/recommendation/executive_note تتط�?ب عض�?�?ة أ�? ص�?اح�?ة
  ...
  insert into public.dispute_actions(
    ...
    'ت�?ت إضافة إفادة', v_emp, auth.uid(),
  ...
  perform public.notify_dispute_admins(
    ...
    'إفادة جد�?دة ف�? �?ش�?�?ة',
    coalesce(v_case.case_number,'') || ' �? ت�?ت إضافة إفادة جد�?دة',
    'normal'
  );
...
begin
  if v_target is null or not public.can_access_employee(v_target, 'reports.read') then
    raise exception '�?طا�? ا�?ت�?ار�?ر �?رف�?ض' using errcode = '42501';
  end if;
    ...
    'cases', coalesce((
      select jsonb_agg(jsonb_build_object(
        ...
        case
          ...
          -- 0202: تصح�?ح hearing_scheduled �? session_scheduled
...
-- create_job_offer_admin(uuid,text,numeric,text,date,timestamp with time zone)
CREATE OR REPLACE FUNCTION public.create_job_offer_admin(p_application_id uuid, p_title text DEFAULT NULL::text, p_salary numeric DEFAULT NULL::numeric, p_contract_type text DEFAULT NULL::text, p_start_date date DEFAULT NULL::date, p_expires_at timestamp with time zone DEFAULT NULL::timestamp with time zone)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'auth'
...
begin
  ...
  perform public.log_audit_event('recruitment.offer_created','workflow','info','job_offers',v_id,
    'إ�?شاء عرض ت�?ظ�?ف', null, jsonb_build_object('applicationId',p_application_id,'version',v_version));
...
begin
  ...
  ) then raise exception '�?ص�?�? ا�?ط�?ب �?رف�?ض' using errcode='42501'; end if;
  ...
  if TG_OP = 'INSERT' then
    ...
    if v_employee_id is not null then
      insert into public.notifications(
        ...
        'ت�? �?�?ح�? د�?را�? جد�?دا�?',
        'ت�? �?�?ح�? د�?ر «' || coalesce(v_role_name, 'غ�?ر �?عر�?ف') || '» ف�? ا�?�?ظا�?.',
        'system', 'normal',
        'role', NEW.role_id,
    ...
    if v_employee_id is not null then
      insert into public.notifications(
        ...
        v_user_id, v_employee_id,
        'ت�? سحب د�?ر �?�?�?',
        'ت�? سحب د�?ر «' || coalesce(v_role_name, 'غ�?ر �?عر�?ف') || '» �?�? حساب�?.',
        'system', 'normal',
        'role', OLD.role_id,
...
AS $function$
  with n as (select ltrim($1) as v)
  select case
    -- ا�?فارغ/NULL �?ُس�?ح ب�? (ا�?ع�?�?د اخت�?ار�?)
    when $1 is null or length(trim($1)) = 0 then true
    -- رفض �?حارف ا�?تح�?�?�? �? newline/CR/tab (ع�?�? ا�?�?�?�?ة ا�?خا�?)
    when $1 ~ '[[:cntrl:]]' then false
    -- رفض ا�?�?خططات ا�?خطِرة صراحة�? (ع�?�? ا�?�?�?�?ة ا�?�?ُ�?ظ�?�?فة)
    when lower((select v from n)) ~ '^(data|file|javascript|blob|vbscript|about|filesystem):' then false
    -- رفض أ�? �?خطط غ�?ر https (ع�?�? ا�?�?�?�?ة ا�?�?ُ�?ظ�?�?فة �? �?ش�?�? حا�?ة ا�?فراغ ا�?بادئ)
    when (select v from n) ~ '^[a-zA-Z][a-zA-Z0-9+.-]*:' and lower((select v from n)) !~ '^https://' then false
    -- رفض ا�?ر�?ابط ب�?ا-�?خطط: أ�? �?حرف�?�? / أ�? \ بادئ�?�? (�?�?س�? // \\ /\ \/)
    when (select v from n) ~ '^[/\\]{2}' then false
    -- �?�?ع اجت�?از ا�?�?سار ف�? ا�?�?سارات ا�?�?سب�?ة
    when (select v from n) ~ '(^|/)\.\.(/|$)' then false
    else true
  end;
$function$;

-- is_safe_external_link(text)
...
AS $function$
  ...
  select case
    ...
    when $1 ~ '[[:cntrl:]]' then false
    when lower((select v from n)) ~ '^(data|file|javascript|blob|vbscript|about|filesystem):' then false
    -- رفض أ�? �?خطط عدا http/https (ع�?�? ا�?�?�?�?ة ا�?�?ُ�?ظ�?�?فة)
    when (select v from n) ~ '^[a-zA-Z][a-zA-Z0-9+.-]*:' and lower((select v from n)) !~ '^https?://' then false
    -- رفض ا�?ر�?ابط ب�?ا-�?خطط (// \\ /\ \/)
    when (select v from n) ~ '^[/\\]{2}' then false
    when (select v from n) ~ '(^|/)\.\.(/|$)' then false
...
begin
  if p_workspace not in ('hr','main_admin') then
    raise exception '�?ساحة ع�?�? غ�?ر صا�?حة' using errcode = '22023';
  end if;
  return jsonb_build_object(
...
begin
  if p_password is null or length(p_password) < 12 then
    v_issues := array_append(v_issues, '�?جب أ�? ت�?�?�? 12 حرف�?ا ع�?�? ا�?أ�?�?');
  end if;
  if length(p_password) > 72 then
    v_issues := array_append(v_issues, '�?جب أ�?ا تتجا�?ز 72 حرف�?ا');
  end if;
  if p_password !~ '[A-Z]' then
    v_issues := array_append(v_issues, 'حرف �?ب�?ر �?احد ع�?�? ا�?أ�?�? (A-Z)');
  end if;
  if p_password !~ '[a-z]' then
    v_issues := array_append(v_issues, 'حرف صغ�?ر �?احد ع�?�? ا�?أ�?�? (a-z)');
  end if;
  if p_password !~ '[0-9]' then
    v_issues := array_append(v_issues, 'ر�?�? �?احد ع�?�? ا�?أ�?�? (0-9)');
  end if;
  if p_password !~ '[!@#$%^&*()_\-+=[\]{};''":\\|,.<>/?`~]' then
    v_issues := array_append(v_issues, 'ر�?ز خاص �?احد ع�?�? ا�?أ�?�? (!@#$...)');
  end if;
  if p_password ~ '(.)\1{4,}' then
    v_issues := array_append(v_issues, 'ت�?رار �?فرط �?�?فس ا�?حرف (5+ �?تتا�?�?ة)');
  end if;
...
begin
  if not (public.current_is_full_access() or public.has_permission('system.release.manage')) then
    raise exception 'س�?اسة ا�?إصدار �?رف�?ضة' using errcode='42501';
  end if;
  if length(trim(coalesce(p_reason,''))) < 10 then raise exception '�?رج�? إدخا�? ا�?سبب' using errcode='22023'; end if;
  ...
  perform public.log_audit_event('release.policy.updated','system','warning','app_release_policies',v_row.id,
    '�?ª�?­�?¯�?�?�?« �?³�?�?�?§�?³�?© �?¥�?µ�?¯�?§�?±',p_reason,jsonb_build_object('platform',p_platform,'environment',p_environment,'latestBuild',p_latest_build,'minimumBuild',p_min_supported_build,'maintenance',p_maintenance_enabled));
  return v_row;
end;
$function$;

-- decide_interview_admin(uuid,text)
CREATE OR REPLACE FUNCTION public.decide_interview_admin(p_interview_id uuid, p_status text)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'auth'
...
begin
  ...
  perform public.log_audit_event('recruitment.interview_'||p_status,'workflow','info','interviews',p_interview_id,
    'تحد�?ث حا�?ة �?�?اب�?ة', null, jsonb_build_object('applicationId',v_app,'status',p_status));
  return jsonb_build_object('interviewId', p_interview_id, 'status', p_status);
end $function$;

-- guard_bulk_status_override()
...
AS $function$
begin
  -- إ�? ت�? تعد�?�? أ�?ثر �?�? 50 صف ف�? عبارة UPDATE �?احدة�? ارفض�?ا
  -- (50 �?�? حد �?ع�?�?�? �?تحد�?ث دفعة �?شر�?ع�?ة �?ث�? إعادة تفع�?�? �?�?س�?�?ة)
  if tg_op = 'UPDATE' then
    if pg_typeof(NEW.status) is not null and NEW.status is distinct from OLD.status then
      -- تح�?�?: �?�? �?ذا تحد�?ث شا�?�? أ�? �?حدد�?
      -- �?تح�?�? عبر session variable تُضبط �?�? migrations ا�?�?شر�?عة
      if current_setting('app.allow_bulk_status', true) is null then
        -- ف�?ط �?�?جدا�?�? ا�?حساسة
        if tg_table_name in ('employees', 'profiles') then
          -- إ�? �?ا�? OLD.status �?�?�?ة د�?ا�?�?ة غ�?ر active �?NEW.status='active'
          -- بد�?�? س�?ا�? migration �?شر�?ع�? ارفض
          if OLD.status in ('suspended', 'invited', 'pending', 'probation_failed', 'notice_period')
             and NEW.status = 'active' then
            -- ا�?س�?اح ف�?ط إ�? �?ا�? �?�?ا�? employee_id �?حدد ف�? WHERE
            -- (�?ا �?�?�?�? ا�?تح�?�? �?باشرة �?�?�? �?سج�? ا�?تحذ�?ر)
            raise notice 'guard_bulk_status_override: تح�?�?�? حا�?ة �?�? % إ�?�? active', OLD.status;
          end if;
        end if;
      end if;
    end if;
...
begin
  ...
  -- 0460: `date::timestamp at time zone tz` â�?¬�? �?§�?�?�?ª�?­�?�?�?Š�?�? �?§�?�?�?µ�?±�?Š�?­ �?¥�?�?�?�?° timestamp
  -- (�?¨�?¯�?�?�?�?  �?�?¦�?�? �?·�?�?�?©) �?£�?�?�?�?�?�?¹�?§ �?«�?�?¦ �?ª�?�?³�?Š�?±�?�?¡ �?�?�?ª�?�?�?�?�?Š�?ª �?§�?�?�?�?¦�?�? �?·�?�?�?©�?�?º �?�?�?£�?�?  `date at time zone`
  -- �?�?�?­�?¯�?�?¡ �?Š�?±�?�?�?�?�?�?° �?§�?�?�?ª�?§�?±�?Š�?® �?¥�?�?�?�?° timestamptz �?¹�?¨�?± �?�?¦�?�? �?·�?�?�?© �?§�?�?�?¬�?�?�?³�?© �?�?ª�?�? �?²�?�?�?�? �?§�?�?�?�? �?§�?�?°�?©
  -- 02:00â�?¬�?06:00 �?­�?³�?¨ �?�?¦�?�? �?·�?�?�?© �?§�?�?�?¬�?�?�?³�?© (�?�? �?�?³ �?¹�?�?�?© 0169/0201).
  if v_crosses_midnight and v_shift.id is not null then
    -- Night shift: period = work_date+start_time â�? �? (work_date+1)+end_time
    v_period_start := (v_work_date + v_shift.start_time) at time zone v_tz;
    v_period_end   := ((v_work_date + 1) + v_shift.end_time) at time zone v_tz;
  else
  ...
  perform public.log_audit_event(
    'attendance.' || lower(p_event_type), 'security', 'info',
    'attendance_events', v_event_id, '�?¨�?µ�?�?¦�?© �?�?¦�?�?�?«�?�?�?© �?¯�?§�?®�?�? �?�? �?·�?§�?�? �?§�?�?�?�?¦�?¬�?�?¦�?¹', null,
    jsonb_build_object(
...
-- transition_decision(uuid,text,text,timestamp with time zone)
CREATE OR REPLACE FUNCTION public.transition_decision(p_decision_id uuid, p_action text, p_reason text DEFAULT NULL::text, p_scheduled_for timestamp with time zone DEFAULT NULL::timestamp with time zone)
 RETURNS administrative_decisions
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
AS $function$
...
begin
  ...
  perform public.log_audit_event('decision.'||p_action,'governance',case when p_action='revoke' then 'warning' else 'info' end,'administrative_decisions',p_decision_id,'ا�?ت�?ا�? �?رار �?�? '||v_from||' إ�?�? '||v_to,p_reason,jsonb_build_object('from',v_from,'to',v_to));
  return v_row;
end $function$;
...
begin
 for v_case in select id,case_number,title,review_due_at,severity from public.dispute_cases where status in ('submitted','needs_more_information') and review_due_at<=now()+interval '2 hours' order by review_due_at limit greatest(1,least(coalesce(p_limit,500),2000)) loop
  perform public.notify_dispute_admins(v_case.id,case when v_case.review_due_at<=now() then 'sla-overdue' else 'sla-due-soon' end,
   case when v_case.review_due_at<=now() then 'تجا�?زت �?ش�?�?ة �?�?�?ة ا�?�?راجعة' else 'ا�?ترب ا�?ت�?اء �?�?�?ة �?راجعة �?ش�?�?ة' end,
...
-- submit_dispute_appeal(uuid,text)
...
begin
 ...
 perform public.notify_dispute_admins(v_case.id,'appeal:'||v_id::text,'اعتراض جد�?د ع�?�? �?رار',coalesce(v_case.case_number,'')||' �? �?تط�?ب �?راجعة','high');
 perform public.log_audit_event('dispute.appeal_submitted','workflow','warning','dispute_appeals',v_id,'ت�?د�?�? اعتراض ع�?�? ا�?�?رار',null,jsonb_build_object('caseId',v_case.id));
 return v_id;
end $function$;

-- acknowledge_dispute_decision(uuid)
...
begin
 ...
 perform public.log_audit_event('dispute.decision_acknowledged','workflow','info','dispute_decisions',p_decision_id,'تأ�?�?د ا�?اط�?اع ع�?�? ا�?�?رار');
end $function$;
...
begin
  ...
  if not exists (
    ...
    raise exception 'ا�?�?رار �?�?س �?�?ج�?ا�? �?�?ذا ا�?�?�?ظف' using errcode = '42501';
  end if;
...
AS $function$
  ...
  begin
    ...
    if v_row.status <> 'pending' or v_row.expires_at <= now() then
      raise exception 'ا�?ط�?ب �?�? �?عد �?�?د ا�?ا�?تظار' using errcode = '22023';
    end if;

    if p_accept then
      -- V25: �?�?�?§ �?ª�?�?�?�? �?�?�?§�?�?°�?© �?§�?�?�?¬�?�?�?³�?© �?¹�?�? 5 �?¯�?�?�?§�?¦�?�? �?­�?ª�?�? �?�?�?�? �?�?�?§�?�? duration_minutes=1
      -- (�?�?�?�?�?·�?©). �?�?�?§�?�?�?ª �?§�?�?�?¯�?�?�?�?�?�?�?© �?§�?�?�?�?�?§�?­�?¯�?© �?ª�?�?´�?�? �?§�?�?�?¥�?±�?³�?§�?�? �?¹�?�?�?¯ �?ª�?£�?®�?± GPS �?�?�?ª�?¨�?�?�?�? �?§�?�?�?·�?�?�?¨
      -- active�?�? �?�?ª�?³�?ª�?�?�?± �?¥�?¹�?§�?¯�?© �?¥�?±�?³�?§�?�? �?§�?�?�?¥�?´�?¹�?§�?± �?¥�?�?�?�? �?§�?�?�?£�?¨�?¯.
...
begin
  perform public.log_audit_event(
    ...
    'geofences', new.id,
    'تغ�?�?ر إعدادات ا�?س�?اج ا�?جغراف�?', null,
    jsonb_build_object(
      'code', new.code,
...
begin
  ...
  if p_report_date > (now() at time zone 'Africa/Cairo')::date then
    raise exception 'ا�?ت�?ر�?ر ا�?�?�?�?�? ا�?�?ست�?ب�?�? غ�?ر �?س�?�?ح' using errcode = '22023';
  end if;
  if length(trim(coalesce(p_achievements, ''))) < 3 then
    raise exception 'ا�?إ�?جازات �?ط�?�?بة' using errcode = '22023';
  end if;
  ...
  if v_id is null then
    ...
    if not found then
      raise exception 'ا�?ت�?ر�?ر ا�?�?ُراج�?ع �?ا �?ُعد�?�?�?' using errcode = '42501';
    end if;
  end if;
...
-- record_dispute_settlement(uuid,text,uuid,uuid,text,text,timestamp with time zone)
CREATE OR REPLACE FUNCTION public.record_dispute_settlement(p_case_id uuid, p_type text, p_from uuid, p_to uuid, p_text text DEFAULT NULL::text, p_publication_place text DEFAULT NULL::text, p_due_at timestamp with time zone DEFAULT NULL::timestamp with time zone)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
 ...
 if p_from is not null then perform public.enqueue_dispute_notification(p_case_id,p_from,'settlement:'||v_id::text,'تس�?�?ة ت�?تظر ا�?ت�?ف�?ذ','�?رج�? ت�?ف�?ذ ا�?تس�?�?ة ف�? ا�?�?�?عد ا�?�?حدد �?تسج�?�? ا�?تأ�?�?د.','high'); end if;
 perform public.log_audit_event('dispute.settlement_recorded','workflow','notice','dispute_settlements',v_id,'تسج�?�? تس�?�?ة �?�?�?ش�?�?ة',null,jsonb_build_object('caseId',p_case_id,'type',p_type));
 return v_id;
end $function$;

-- hard_delete_employee_guarded(uuid,text,text)
...
begin
  -- 1) ا�?حذف ا�?دائ�? �?�?ص�?ر ع�?�? ا�?�?د�?ر ا�?رئ�?س�? �?�?�?ص�?�? ا�?�?ا�?�?.
  ...
  -- 5) ا�?تح�?�? �?�? ر�?ز ا�?تأ�?�?د: إ�?ا ر�?ز ا�?�?�?ظف أ�? إدار�?.
  ...
  -- 6) �?�?ع حذف �?د�?ر/�?ائد فر�?�? �?د�?�? �?رؤ�?س�?�? �?شط�?�? (�?د�?ر �?باشر أ�? �?ائد فر�?�?).
  if exists (
       select 1 from public.manager_relations mr
  ...
  -- 7) �?�?ع ا�?حذف ا�?دائ�? ع�?د �?ج�?د سج�? تار�?خ�? (ا�?�?عت�?د: ا�?حذف عبر أرش�?ف).
  --    (إب�?اء ا�?ترح�?�? �?حافظا�?: سرد 9+ جدا�?�? FK �?�?�?ع ا�?حذف ا�?�?باشر.)
  ...
  -- 9) حذف ا�?�?�?ظف: FK �?عر�?فة تح�?�? ا�?ب�?ا�?ات ا�?تار�?خ�?ة ع�?د تفع�?�? ا�?أرشفة.
  begin
...
begin
  ...
  if not (public.can_manage_assignment_type(v_row.assignment_type)
          or v_row.created_by_employee_id = v_me) then
    raise exception 'غ�?ر �?صرح �?�? بإ�?غاء �?ذا ا�?ت�?�?�?ف' using errcode = '42501';
  end if;
  ...
  perform public.log_audit_event(
    ...
    '�?¥�?�?�?º�?§�?¡ �?ª�?�?�?�?�?�?�? �?¹�?�?�?�?', p_reason, jsonb_build_object('type', v_row.assignment_type));
  return v_row;
end $function$;
...
exception when others then
  -- �?ا تُفش�? ا�?ط�?ب بسبب فش�? ا�?�?بضة�? ا�?�?ر�?�? �?ب�?�? ا�?احت�?اط.
  return;
end;
$function$;
...
begin
  ...
  -- �?§�?�?�?µ�?�?�?§�?­�?�?�?©: �?µ�?§�?­�?¨ �?§�?�?�?·�?�?�?¨ (�?§�?�?�?�?�?�?�?¸�?) �?£�?�? �?�?�?�? �?�?�?�?�?�?�?�? view_response �?¹�?�?�?�?�?�? �?£�?�? full-access.
  if not (
    v_req.employee_id = public.current_employee_id()
    or v_req.requested_by = public.current_employee_id()
    or public.can_access_employee(v_req.employee_id,'live_location.view_response')
  ) then
    raise exception 'غ�?ر �?س�?�?ح �?�? بعرض �?ذ�? ا�?استجابة' using errcode='42501';
  end if;
  ...
  perform public.log_audit_event('live_location.response_viewed','security','info','live_location_requests',p_request_id,'�?§�?·�?�?�?�?�?§�?¹ �?¹�?�?�?�? �?�?�?ª�?�?�?¬�?© �?·�?�?�?¨ �?§�?�?�?�?�?�?�?�?�?¹',null,jsonb_build_object('hasVideo',v_has_video));
  if v_has_video then
...
begin
  if not (
    ...
    raise exception 'ص�?اح�?ة إدارة ا�?أج�?زة �?ط�?�?بة' using errcode = '42501';
  end if;
  if p_status not in ('pending','active','blocked','revoked','replaced') then
    raise exception 'حا�?ة ج�?از غ�?ر صا�?حة' using errcode = '22023';
  end if;
  if length(trim(coalesce(p_reason, ''))) < 5 then
    raise exception 'سبب حا�?ة ا�?ج�?از �?ط�?�?ب' using errcode = '22023';
  end if;
...
begin
  if auth.uid() is null then raise exception '�?�?ز�? �?ستخد�? �?سج�? ا�?دخ�?�?' using errcode='42501'; end if;
  if p_status not in ('delivered','opened') then raise exception 'حا�?ة تس�?�?�? غ�?ر صا�?حة' using errcode='22023'; end if;
  if not exists(select 1 from public.notifications n where n.id=p_notification_id and n.recipient_user_id=auth.uid()) then
    raise exception 'ا�?إشعار �?�?س �?�?' using errcode='42501';
  end if;
...
-- complete_dispute_action(uuid,text)
...
begin
 ...
 perform public.log_audit_event('dispute.action_completed','workflow','notice','dispute_actions',p_action_id,'ت�?ف�?ذ إجراء �?رار',trim(p_proof),jsonb_build_object('caseId',v.case_id));
 perform public.notify_dispute_admins(v.case_id,'action-completed:'||p_action_id::text,'ت�? ت�?ف�?ذ إجراء ف�? �?ش�?�?ة','ت�? تسج�?�? إثبات ا�?ت�?ف�?ذ�? �?�?�?�?�? �?راجعة ا�?�?ض�?ة �?�?إغ�?ا�?.','normal');
end $function$;

-- get_leave_requests_admin(integer,text,text,uuid,integer,integer)
...
-- get_executive_attendance_overview_fast(date)
...
begin
  ...
  -- ا�?�? MV تخص ا�?�?�?�? ا�?حا�?�? ف�?ط�? �?�?ت�?ار�?خ ا�?أخر�? ف�?�?ض ع�?�? ا�?دا�?ة ا�?ح�?ة ا�?أص�?�?ة.
  if v_date <> (now() at time zone 'Africa/Cairo')::date then
...
AS $function$
begin
  -- ف�?ط ع�?د تغ�?�?ر ا�?حا�?ة �?�? pending/blocked إ�?�? active أ�? blocked
  if old.status in ('pending','blocked')
    ...
    perform public.notify_employee(
      new.employee_id,
      case new.status
        when 'active'  then 'ت�? اعت�?اد ج�?از�?'
        else 'ت�? رفض ج�?از�?'
      end,
      case new.status
        when 'active'  then 'ت�? اعت�?اد ج�?از ' || coalesce(new.device_name, 'غ�?ر �?عر�?ف')
        else 'ت�? رفض ج�?از ' || coalesce(new.device_name, 'غ�?ر �?عر�?ف') ||
...
-- get_request_decision_context(uuid)
  ...
  if v_start is null or v_end is null then v_conflicts:='[]'::jsonb;
    ...
    from (
      select 'employee_overlap'::text kind,
        format('�?د�? ا�?�?�?ظف ط�?ب %s �?تداخ�? (%s إ�?�? %s)',r.request_number,r.payload->>'startDate',r.payload->>'endDate') message,
        r.id request_id
      ...
      select 'substitute_overlap',
        format('ا�?بد�?�? �?د�?�? ط�?ب �?تداخ�? ر�?�? %s',r.request_number),r.id
      from public.requests r
...
-- get_attendance_dashboard(date,uuid,uuid,uuid)
...
AS $function$
  with params as (
    ...
    select e.id, e.department_id, e.branch_id
     ...
     where e.is_active = true
       and coalesce(e.is_deleted, false) = false
       and not public.is_employee_executive(e.id)  -- 0444: �?ªº�?ª�?�?ª¬�?ª¿�?ª�?£�?ªº�?ª» �?ªº�?ä�?à�?ª»�?è�?ª�? �?ªº�?ä�?ª¬�?å�?ü�?è�?ª�?�?è
       and not (public.is_employee_isolated(e.id) and not public.can_view_isolated_employee(e.id))
       and (p_department_id is null or e.department_id = p_department_id)
       and (p_branch_id is null or e.branch_id = p_branch_id)
       and (
  ...
  select jsonb_build_object(
    ...
    -- �?à�?ü�?ªº�?ª¬�?è�?ª¡ 0444 �?ª¬�?ª¿�?é�?ë �?ä�?ä�?ª¬�?ê�?ªº�?ü�?é �?à�?ª�?£ �?ªº�?ä�?ê�?ªº�?ª¼�?ç�?ª�? �?ªº�?ä�?ªú�?ª¡�?ª»�?ª½:
...
CREATE OR REPLACE FUNCTION public.check_rate_limit(p_domain text, p_max_count integer, p_window_minutes integer DEFAULT 60)
 RETURNS void
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
  ...
  if v_count >= p_max_count then
    raise exception 'rate_limit_exceeded: % (% ف�? آخر % د�?�?�?ة�? ا�?حد %)',
...
begin
  ...
  if p_reaction_type not in ('like', 'celebrate', 'support', 'insightful') then
    raise exception '�?�?ع تفاع�? غ�?ر صا�?ح' using errcode = '22023';
  end if;
  ...
  if v_existing = p_reaction_type then
    ...
    if v_publisher_user_id is not null and v_publisher_employee_id is distinct from v_me then
      ...
      perform public.notify_user(
        v_publisher_user_id,
        '�?ª�?�?§�?¹�?�? �?¬�?¯�?�?�?¯ �?¹�?�?�?�? �?¥�?¹�?�?�?§�?�?�?�?',
        coalesce(v_actor_name, '�?£�?­�?¯ �?§�?�?�?�?�?�?�?¸�?�?�?�?�?') || ' �?ª�?�?§�?¹�?�? �?�?�?¹ �?«' || left(v_title, 120) || '�?».',
...
begin
  if v_employee_id is null or v_user_id is null then
    raise exception '�?�?ز�? �?�?ظف �?سج�? ا�?دخ�?�?' using errcode = '42501';
  end if;
...
-- extend_request_deadline(uuid,integer,text)
CREATE OR REPLACE FUNCTION public.extend_request_deadline(p_request_id uuid, p_hours integer, p_reason text)
 RETURNS requests
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
 ...
 return jsonb_build_object(
  ...
  'distribution',(select coalesce(jsonb_object_agg(coalesce(final_rating,'غ�?ر �?�?ت�?�?'),count),'{}'::jsonb) from (select final_rating,count(*) count from public.kpi_evaluations where cycle_id=p_cycle_id group by final_rating)x),
...
begin
  ...
  if p_slug is null or p_name is null then
    raise exception 'ا�?�?عر�?ف �?ا�?اس�? �?ط�?�?با�?';
  end if;
...
begin
  ...
  if not (public.current_is_full_access()
    ...
    raise exception 'غ�?ر �?صرح �?�? ب�?شر ا�?إع�?ا�?ات' using errcode = '42501';
  end if;

  -- �?§�?�?�?ª�?­�?�?�?�? �?�?�?�? �?·�?�?�?�? �?§�?�?�?¹�?�?�?�?�?§�?�? �?�?�?§�?�?�?�?�?­�?ª�?�?�?�?
  if length(trim(p_title)) < 3 or length(trim(p_body)) < 10 then
    raise exception 'ا�?ع�?�?ا�? أ�? ا�?�?حت�?�? �?ص�?ر جدا�?' using errcode = '22023';
  end if;
...
-- register_dispute_evidence(uuid,text,text,text,bigint,text,text)
CREATE OR REPLACE FUNCTION public.register_dispute_evidence(p_case_id uuid, p_title text, p_storage_path text, p_mime_type text, p_file_size_bytes bigint, p_visibility text DEFAULT 'committee_only'::text, p_description text DEFAULT NULL::text)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
 ...
 perform public.log_audit_event('dispute.evidence_added','data','notice','dispute_evidence',v_id,'إضافة د�?�?�? �?�?�?ش�?�?ة',null,jsonb_build_object('caseId',p_case_id,'mimeType',p_mime_type));
 return v_id;
end $function$;
...
begin
  ...
  if length(trim(coalesce(p_manager_comment, ''))) < 3 then
    raise exception 'تع�?�?�? ا�?�?د�?ر �?ط�?�?ب' using errcode = '22023';
  end if;
  ...
  if v_report.employee_id = v_manager_id then
    raise exception 'ا�?ت�?�?�?�? ا�?ذات�? غ�?ر �?س�?�?ح �?�?ا' using errcode = '42501';
  end if;
  if not (
    public.current_is_full_access()
    ...
    raise exception '�?طا�? �?راجعة ا�?ت�?ار�?ر �?رف�?ض' using errcode = '42501';
  end if;
...
-- save_shift_admin(uuid,text,text,time without time zone,time without time zone,integer,integer,integer,boolean)
CREATE OR REPLACE FUNCTION public.save_shift_admin(p_shift_id uuid, p_code text, p_name text, p_start time without time zone, p_end time without time zone, p_break_minutes integer DEFAULT 0, p_grace_in integer DEFAULT 0, p_grace_out integer DEFAULT 0, p_active boolean DEFAULT true)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
 ...
 perform public.log_audit_event('attendance.shift.saved','data','notice','shifts',v_id,'حفظ إعداد �?رد�?ة',null,jsonb_build_object('code',p_code)); return v_id;
end $function$;
...
begin
  if p_status not in ('pending','in_progress','completed','skipped') then
    raise exception 'حا�?ة �?�?�?ة ت�?�?ئة غ�?ر صا�?حة' using errcode = '22023';
  end if;
  if not (public.current_is_full_access() or public.has_permission('onboarding.journey.manage')) then
    raise exception 'ا�?ت�?ا�? �?�?�?ة ا�?ت�?�?ئة �?رف�?ض' using errcode = '42501';
  end if;
  ...
  if v_journey is null then raise exception '�?�?�?ة ا�?ت�?�?ئة غ�?ر �?�?ج�?دة' using errcode = 'P0002'; end if;
...
begin
  if not (public.current_is_full_access() or public.has_permission('live_location.manage_retention')) then
    raise exception 'ص�?اح�?ة إدارة ا�?استب�?اء �?ط�?�?بة' using errcode='42501';
  end if;
  if length(trim(coalesce(p_reason,'')))<5 then raise exception 'سبب ا�?حجز ا�?�?ا�?�?�?�? �?ط�?�?ب' using errcode='22023'; end if;
  ...
  update public.live_location_videos_meta
    ...
    returning * into v_row;
  if not found then raise exception 'ا�?ف�?د�?�? غ�?ر �?�?ج�?د' using errcode='P0002'; end if;
  ...
  perform public.log_audit_event(
    ...
    'security','warning','live_location_videos_meta',p_video_id,'�?­�?�?¸ �?¥�?¯�?§�?±�?�? �?�?�?�?�?�?¯�?�?�?�? �?§�?�?�?ª�?­�?�?�?�?',null,
...
AS $function$
begin
  -- ف�?ط ع�?د ا�?ا�?ت�?ا�? إ�?�? حا�?ة published
...
-- schedule_dispute_session_v2(uuid,text,timestamp with time zone,timestamp with time zone,text,text,jsonb)
...
begin
 ...
 for v_item in select * from jsonb_array_elements(coalesce(p_participants,'[]'::jsonb)) loop
  ...
  perform public.enqueue_dispute_notification(p_case_id,v_emp,'session:'||v_id::text,'ت�? تحد�?د ج�?سة �?�?�?ش�?�?ة','�?�?عد ا�?ج�?سة: '||(to_char(p_scheduled_at at time zone 'Africa/Cairo','YYYY-MM-DD hh12:mi') || case when extract(hour from (p_scheduled_at at time zone 'Africa/Cairo')) < 12 then ' ص' else ' �?' end),'high');
 end loop;
 ...
 perform public.log_audit_event('dispute.session_scheduled','workflow','notice','dispute_sessions',v_id,'تحد�?د ج�?سة �?�?�?ش�?�?ة',null,jsonb_build_object('caseId',p_case_id));
 return v_id;
end $function$;

-- request_attendance_correction(date,text,text,timestamp with time zone,timestamp with time zone,text,text)
...
begin
 ...
 perform public.notify_employees_with_permission(
   'attendance.correction.review',
   'ط�?ب تصح�?ح حض�?ر جد�?د',
   format('ط�?ب تصح�?ح حض�?ر بتار�?خ %s (%s)', p_work_date, coalesce(p_type, '')),
   'attendance', 'normal', 'attendance_corrections', v_id,
   '{}'::jsonb, v_emp);
 return v_id;
end $function$;

-- publish_roster_admin(text,date,date,uuid,uuid,uuid,jsonb,text)
CREATE OR REPLACE FUNCTION public.publish_roster_admin(p_name text, p_period_start date, p_period_end date, p_department_id uuid, p_team_id uuid, p_branch_id uuid, p_days jsonb, p_notes text DEFAULT NULL::text)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
 ...
 perform public.log_audit_event('attendance.roster.published','workflow','notice','work_rosters',v_id,'�?شر جد�?�? �?رد�?ات',null,jsonb_build_object('start',p_period_start,'end',p_period_end));
 foreach v_employee in array v_employees loop
  perform public.notify_employee(
   v_employee, 'جد�?�? �?رد�?ات جد�?د',
   format('�?ُشر جد�?�? ا�?�?رد�?ات «%s» �?�?فترة �?�? %s إ�?�? %s', trim(p_name), p_period_start, p_period_end),
...
begin
  perform public.notify_employees_with_permission(
    ...
    'ط�?ب دع�? جد�?د',
    format('ط�?ب دع�? �?رفا�?�?ة (تص�?�?ف %s).', coalesce(new.category, '')),
...
BEGIN
  ...
  -- ت�?ح�?د: استبد�? /object/public/ ب�? /object/authenticated/ ف�? �?�? رابط.
...
BEGIN
  ...
  IF NOT public.current_is_full_access() THEN
    RAISE EXCEPTION 'ERR_FORBIDDEN'
      USING HINT = 'revoke_credential �?تط�?ب ص�?اح�?ة full-access';
  END IF;
  ...
  IF v_found THEN
    PERFORM public.log_audit_event(
      ...
      p_summary_ar   := 'تعط�?�? اعت�?اد: ' || p_key_name,
...
BEGIN
  ...
  IF NOT public.current_is_full_access() THEN
    RAISE EXCEPTION 'ERR_FORBIDDEN'
      USING HINT = 'read_credential �?تط�?ب ص�?اح�?ة full-access';
  END IF;

  -- ج�?ب ا�?�?�?�?ة ا�?�?شف�?رة (ف�?ط ا�?سج�?ات ا�?�?شطة)
  ...
  IF v_enc_key IS NULL OR length(trim(v_enc_key)) = 0 THEN
    RAISE EXCEPTION 'ERR_MISSING_ENCRYPTION_KEY'
      USING HINT = 'app.credential_key غ�?ر �?ُعر�?�?ف �? اضبط�? �?�? Supabase secret';
  END IF;

  -- تسج�?�? تد�?�?�?�? (�?ب�? ف�? ا�?تشف�?ر �? حت�? �?�? فش�?)
  PERFORM public.log_audit_event(
    p_event_type   := 'credential.read',
    p_category     := 'security',
    p_severity     := 'notice',
    p_target_table := 'credential_vault',
    p_summary_ar   := '�?راءة اعت�?اد �?شف�?ر: ' || p_key_name,
    p_metadata     := jsonb_build_object('key_name', p_key_name)
  );
...
-- create_kpi_policy_version(text,jsonb,jsonb,boolean,date)
CREATE OR REPLACE FUNCTION public.create_kpi_policy_version(p_name text, p_attendance_rules jsonb, p_rating_bands jsonb, p_allow_target_overachievement boolean DEFAULT false, p_effective_from date DEFAULT CURRENT_DATE)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
 ...
 perform public.log_audit_event('kpi.policy.version_created','workflow','warning','kpi_policy_versions',v_id,'إ�?شاء إصدار جد�?د �?�? س�?اسة KPI',null,jsonb_build_object('version',v_version,'attendanceRules',p_attendance_rules,'ratingBands',p_rating_bands,'allowTargetOverachievement',p_allow_target_overachievement));
 return v_id;
end $function$;

-- set_employee_attendance_day_admin(uuid,date,text,time without time zone,time without time zone,boolean,boolean,text,text,text)
...
begin
  ...
  -- �?�? حارس ا�?�? backdating (0383) �? �?�?�?ع تز�?�?ر سج�?ات �?د�?�?ة �?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?
  -- service_role �?تجا�?ز ا�?حارس �?�?تصح�?حات ا�?رس�?�?ة/ا�?ترح�?�?ات.
  ...
  -- تطب�?ع �?�?ع ا�?إجازة �?ب�? ا�?تخز�?�? ف�? attendance_day_overrides.leave_type.
  ...
  -- �?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?
  -- تر�?�?ز إدار�? �?باشر �? �?�?شئ ط�?با�? �?عت�?دا�? (خص�? ا�?رص�?د �?�?ِإجازة/ا�?غ�?اب).
  -- �?�?�?ع إ�?شاء ط�?ب �?�?رر �?�?�?�?ٍ ب�? ط�?ب �?عت�?د �?سب�?ا�? �?غط�? �?فس ا�?�?�?�?.
  -- �?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?
  if p_day_type in ('leave','absent','mission','convoy','fundraising') then
    if p_day_type in ('leave','absent') then
      -- �?�?ع ا�?إجازة: سب�? تطب�?ع�? أع�?ا�? (v_leave_type) �?تح�?�?�?ا �?�? ص�?اح�?ت�?.
      ...
      if not exists (
        ...
        v_req := public._submit_request_for(
          ...
          null,
          v_manager,
          'تحد�?د �?�?�? إدار�? �? ' || (case when p_day_type = 'absent' then 'غ�?اب' else 'إجازة' end),
          btrim(p_reason),
          v_payload);
      ...
      -- �?أ�?�?ر�?ة/�?اف�?ة/فا�?د�?: ط�?ب تشغ�?�?�? �?عت�?د �? تر�?جر ا�?إعفاء �?�?تب present + استث�?اء
      if not exists (
        select 1
          from public.requests r
         where r.employee_id = p_employee_id
        ...
        v_payload := jsonb_build_object(
          ...
          'days', 1,
          'dayMark', true,
          'location', coalesce(nullif(trim(coalesce(p_notes, '')), ''), 'تحد�?د إدار�?'));
        ...
        v_req := public._submit_request_for(
          ...
          null,
          v_manager,
          'تحد�?د �?�?�? إدار�? �? ' || public.request_type_label(p_day_type),
          btrim(p_reason),
          v_payload);
...
-- get_universal_action_center(integer)
...
AS $function$
 with actions as (
  select 'request-'||r.id::text id,'request'::text kind,coalesce(r.title,'ط�?ب ر�?�? '||r.request_number::text) title,e.full_name_ar subtitle,
  ...
  union all
  select 'kpi-'||k.id::text,'kpi','ت�?�?�?�? '||e.full_name_ar||' �?حتاج إجراء',e.employee_code,
  ...
  union all
  select 'decision-'||d.id::text,'decision',d.title,'�?تابعة �?رار رس�?�?','normal',d.status,null::timestamptz,'/admin/official-feed',coalesce(d.updated_at,d.created_at)
...
begin
  if p_employee_id is null or not public.can_access_employee(p_employee_id, 'people.employee.read') then
    raise exception '�?طا�? ا�?�?�?ظف �?رف�?ض' using errcode = '42501';
  end if;
...
begin
  ...
  if not exists (select 1 from public.announcements where id = p_announcement_id) then
    raise exception 'ا�?إع�?ا�? غ�?ر �?�?ج�?د' using errcode = 'P0002';
  end if;
...
begin
  ...
  loop
    insert into public.notifications(
      ...
      'ج�?از جد�?د با�?تظار ا�?�?�?اف�?ة',
      'ا�?�?�?ظف ' || coalesce(v_emp_name, 'غ�?ر �?عر�?ف') || ' سج�?�? ج�?ازا�? جد�?دا�? (' || coalesce(NEW.device_name, 'ج�?از') || ') �?�?�?تظر �?�?اف�?ت�?.',
      'system', 'normal',
...
AS $function$
begin
  -- إبعاد �?�? ج�?از آخر �?شط �?�?فس ا�?�?�?ظف �? ا�?ج�?از ا�?حا�?�? �?�? ا�?�?ح�?د ا�?�?شط.
  update public.employee_devices
  set status = 'replaced',
      revoked_at = now(),
...
-- create_kpi_cycle_admin(date,uuid,timestamp with time zone,timestamp with time zone,timestamp with time zone,timestamp with time zone,boolean,boolean)
CREATE OR REPLACE FUNCTION public.create_kpi_cycle_admin(p_month date, p_template_id uuid, p_self_due timestamp with time zone, p_manager_due timestamp with time zone, p_secretary_due timestamp with time zone, p_executive_due timestamp with time zone, p_open_now boolean DEFAULT true, p_use_parallel_flow boolean DEFAULT false)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
 ...
 -- 0470: p_use_parallel_flow �?�?ب�?�? ت�?اف�?ا�? �?�?�?�? �?ُ�?�?�?�? �? ا�?�?سار ا�?�?ح�?د �?�? V24
 ...
 perform public.log_audit_event('kpi.cycle.created','workflow','notice','kpi_cycles',v_id,'إ�?شاء د�?رة KPI (�?سار �?بس�?ط 0470)',null,jsonb_build_object('month',v_month,'status',v_status));
 return v_id;
end $function$;

-- apply_leave_ledger_entry(uuid,uuid,integer,text,numeric,text,uuid,text,jsonb)
CREATE OR REPLACE FUNCTION public.apply_leave_ledger_entry(p_employee_id uuid, p_leave_type_id uuid, p_year integer, p_entry_type text, p_units numeric, p_source_key text, p_request_id uuid DEFAULT NULL::uuid, p_reason text DEFAULT NULL::text, p_metadata jsonb DEFAULT '{}'::jsonb)
 RETURNS leave_ledger_entries
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
AS $function$
...
begin
  ...
  -- �?�?�?ع سبا�?ات reserve/consume ا�?�?تزا�?�?ة (0382).
  ...
  -- �?�? insert audit entry (unique(source_key) �?�?�?ع ا�?ت�?رار ع�?د ا�?تزا�?�?) �?�?�?�?�?
  ...
  -- �?�? apply entry by type ع�?�? ا�?أع�?دة ا�?ح�?�?�?�?ة �?�?رص�?د �?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?
  if p_entry_type = 'opening' then
    ...
    -- رص�?د بد�? راحة أسب�?ع�? (0428): �?ُضاف إ�?�? adjusted_units ف�?ظ�?ر ض�?�? ا�?رص�?د ا�?�?تاح.
    update public.leave_balance_accounts set adjusted_units = adjusted_units + p_units, updated_at = now() where id = v_account.id;
    ...
    -- حارس 0382: �?ا �?ست�?�?�? أ�?ثر �?�?ا حُجز فع�?�?ا�?
...
-- store_credential(text,text,text,text,jsonb)
CREATE OR REPLACE FUNCTION public.store_credential(p_key_name text, p_value text, p_category text DEFAULT 'general'::text, p_hint text DEFAULT NULL::text, p_metadata jsonb DEFAULT '{}'::jsonb)
 RETURNS void
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'extensions', 'pg_temp'
...
BEGIN
  ...
  IF NOT public.current_is_full_access() THEN
    RAISE EXCEPTION 'ERR_FORBIDDEN'
      USING HINT = 'store_credential �?تط�?ب ص�?اح�?ة full-access';
  END IF;
  ...
  PERFORM public.log_audit_event(
    ...
    p_severity     := 'notice',
    p_target_table := 'credential_vault',
    p_summary_ar   := 'تخز�?�?/تحد�?ث اعت�?اد �?شف�?ر: ' || p_key_name,
...
DECLARE
  ...
  v_elapsed  numeric;
BEGIN
  -- ا�?تح�?�? �?�? ص�?اح�?ة ا�?�?ستخد�? (full-access ف�?ط)
  IF NOT public.current_is_full_access() THEN
    RAISE EXCEPTION 'تحد�?ث ا�?عر�?ض ا�?�?اد�?ة �?تط�?ب ص�?اح�?ة full-access.'
...
-- generate_kpi_cycle_notifications(timestamp with time zone)
CREATE OR REPLACE FUNCTION public.generate_kpi_cycle_notifications(p_at timestamp with time zone DEFAULT now())
 RETURNS integer
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
 ...
 for v_cycle in select * from public.kpi_cycles where status in ('open','locked') and period_month=date_trunc('month',p_at at time zone 'Africa/Cairo')::date loop
  if v_day>=20 then
   for v_eval in select e.id,e.employee_id,(select mr.manager_employee_id from public.manager_relations mr where mr.employee_id=e.employee_id and mr.relation_type='primary' and mr.effective_from<=current_date and (mr.effective_to is null or mr.effective_to>=current_date) limit 1) manager_id from public.kpi_evaluations e where e.cycle_id=v_cycle.id loop
    if public.enqueue_kpi_notification(v_cycle.id,v_eval.id,'OPENED_EMPLOYEE',v_eval.employee_id,'بدأت د�?رة ت�?�?�?�? ا�?أداء','أ�?�?�? ت�?�?�?�?�? ا�?ذات�? �?�?ب�?�?د ا�?سبعة �?ب�? �?�?ا�?ة ا�?د�?رة.','normal') is not null then v_count:=v_count+1; end if;
    if v_eval.manager_id is not null and public.enqueue_kpi_notification(v_cycle.id,v_eval.id,'OPENED_MANAGER',v_eval.manager_id,'بدأت د�?رة ت�?�?�?�? فر�?�?�?','ستص�?�? ت�?�?�?�?ات أعضاء فر�?�?�? �?�?�?راجعة ث�? ا�?اعت�?اد ا�?�?�?ائ�?.','normal') is not null then v_count:=v_count+1; end if;
   end loop;
  end if;
  if p_at>public.kpi_effective_deadline(v_cycle) then v_event:='OVERDUE';v_title:='ت�?�?�?�?ات أداء �?تأخرة';v_body:='ا�?ت�?�? ا�?�?�?عد �?�?ا زا�?ت ت�?�?�?�?ات غ�?ر �?�?ت�?�?ة.';
  elsif v_day>=25 then v_event:='REMINDER_25';v_title:='ا�?�?�?�? آخر �?�?عد �?ت�?�?�?�? ا�?أداء';v_body:='أ�?�?�? ا�?إجراء ا�?�?ط�?�?ب �?ب�? إغ�?ا�? ا�?د�?رة.';
  elsif v_day>=24 then v_event:='REMINDER_24';v_title:='غد�?ا آخر �?�?عد �?ت�?�?�?�? ا�?أداء';v_body:='�?�?جد ت�?�?�?�? �?�? �?�?ت�?�? بعد.';
  elsif v_day>=22 then v_event:='REMINDER_22';v_title:='تذ�?�?ر بت�?�?�?�? ا�?أداء';v_body:='أ�?�?�? ا�?�?رح�?ة ا�?�?س�?دة إ�?�?�? �?ب�? ا�?�?�?عد.';
...
begin
 ...
 perform public.log_audit_event('kpi.appeal.'||p_decision,'workflow','notice','kpi_appeals',p_appeal_id,'�?رار اعتراض KPI',trim(p_note),jsonb_build_object('evaluationId',v.evaluation_id));
 perform public.notify_employee(
   v.employee_id,
   case p_decision when 'accepted' then 'ت�? �?ب�?�? اعتراض�? ع�?�? ت�?�?�?�? KPI' else 'ت�? رفض اعتراض�? ع�?�? ت�?�?�?�? KPI' end,
   format('%s%s', case p_decision when 'accepted' then 'أُع�?د ا�?ت�?�?�?�? �?�?�?راجعة ا�?�?�?ائ�?ة.' else 'ب�?�?ت ا�?�?ت�?جة �?�?ا �?�?.' end, E'\n'||trim(p_note)),
...
begin
  ...
  loop
    insert into public.notifications(
      ...
      'عط�?ة رس�?�?ة: ' || NEW.name,
      'ت�? ا�?إع�?ا�? ع�? عط�?ة رس�?�?ة «' || NEW.name || '» بتار�?خ ' || NEW.holiday_date::text || '.',
      'announcement', 'normal',
...
BEGIN
  ...
  -- �?جب أ�? �?�?�?�? ا�?�? URL داخ�? bucket employee-avatars (authenticated أ�? public).
  IF NOT (
  ...
  -- ت�?ح�?د ع�?�? ص�?غة authenticated.
  v_normalized := replace(v_url, '/storage/v1/object/public/employee-avatars/',
                                '/storage/v1/object/authenticated/employee-avatars/');

  -- ا�?تحد�?ث عبر UPDATE ع�?�? employees �? RLS تس�?ح با�?تحد�?ث ا�?ذات�?.
  UPDATE public.employees
...
-- get_dispute_participant_directory(text,integer)
...
BEGIN
  ...
  IF NOT (
    ...
    RAISE EXCEPTION 'ERR_FORBIDDEN: ص�?اح�?ة غ�?ر �?اف�?ة �?�?�?ص�?�? �?د�?�?�? ا�?�?شار�?�?�?'
      USING ERRCODE = '42501';
  END IF;
...
-- tg_weekly_rest_credit_on_attendance()
...
begin
  ...
  -- ع�?�? فع�?�?: بص�?ة دخ�?�?/خر�?ج �?�?ج�?دة أ�? حا�?ة تش�?ر �?حض�?ر فع�?�?
  -- (ا�?�?ص�?�? أع�?ا�? �?تطاب�? �?ع تعر�?ف 0005+0169: present|late|partial|missing_checkout)
  ...
  where code = 'weekly_rest_comp';
  if v_type_id is null then
    return new; -- ا�?�?�?ع غ�?ر �?عر�?ف (ب�?ئة �?د�?�?ة) �? �?ا �?�?ف تر�?�?ة.
  end if;

  v_year := extract(year from new.work_date)::integer;

  -- source_key �?عرف�? �?�?�? (�?�?ظف + �?�?�?) �? idempotent �?�?�?ا ت�?ررت ا�?تحد�?ثات.
  perform public.apply_leave_ledger_entry(
    new.employee_id, v_type_id, v_year, 'credit', 1,
    'weekly-rest:credit:' || new.employee_id::text || ':' || new.work_date::text,
    null,
    'رص�?د بد�? راحة أسب�?ع�? ع�? ا�?ع�?�? �?�?�? ا�?ج�?عة ' || to_char(new.work_date, 'YYYY-MM-DD'),
...
begin
  ...
  if not coalesce(v_lt.affects_balance,false) then return new; end if;
  perform public.apply_leave_ledger_entry(new.employee_id,new.leave_type_id,v_year,'reserve',v_units,'leave:reserve:'||new.request_id,new.request_id,'حجز رص�?د ع�?د ت�?د�?�? ا�?ط�?ب',jsonb_build_object('durationUnit',new.duration_unit));
  return new;
end $function$;

-- reschedule_kpi_cycle(uuid,timestamp with time zone,timestamp with time zone,text)
CREATE OR REPLACE FUNCTION public.reschedule_kpi_cycle(p_cycle_id uuid, p_open_at timestamp with time zone, p_deadline_at timestamp with time zone, p_reason text)
 RETURNS kpi_cycles
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
 ...
 perform public.log_audit_event('kpi.cycle.rescheduled','workflow','warning','kpi_cycles',p_cycle_id,'تعد�?�? �?�?عد د�?رة KPI',trim(p_reason),jsonb_build_object('openAt',p_open_at,'deadlineAt',p_deadline_at));
 return v_cycle;
end $function$;

-- run_monthly_leave_accrual(integer,integer,integer)
CREATE OR REPLACE FUNCTION public.run_monthly_leave_accrual(p_year integer DEFAULT (EXTRACT(year FROM (now() AT TIME ZONE 'Africa/Cairo'::text)))::integer, p_month integer DEFAULT (EXTRACT(month FROM (now() AT TIME ZONE 'Africa/Cairo'::text)))::integer, p_limit integer DEFAULT 5000)
 RETURNS integer
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
  ...
  loop
    -- �?فتاح idempotent فر�?د �?�?�? �?�?ظف/�?�?ع/ش�?ر: �?ا استح�?ا�? �?زد�?ج �?�?�? ت�?رر ا�?تشغ�?�?
    v_key := format('leave:accrual:%s:%s:%s-%s',
                    v_row.employee_id, v_row.leave_type_id, p_year, lpad(p_month::text, 2, '0'));

    -- تجا�?ز ا�?حد ا�?س�?�?�?: �?ا �?�?�?ح �?ا �?تخط�? max_days_per_year (إ�? حُد�?د)
    v_grant := v_row.rate;
    ...
    if v_grant > 0 then
      -- apply_leave_ledger_entry �?تجا�?�? ا�?ت�?رار عبر unique(source_key)
      perform public.apply_leave_ledger_entry(
        v_row.employee_id, v_row.leave_type_id, p_year,
        'accrual', v_grant, v_key, null,
        format('استح�?ا�? ش�?ر�? ت�?�?ائ�? %s-%s', p_year, lpad(p_month::text, 2, '0')),
  ...
  perform public.log_audit_event(
    ...
    'تشغ�?�? ا�?استح�?ا�? ا�?ش�?ر�? �?�?إجازات',
    format('ا�?س�?ة %s ا�?ش�?ر %s', p_year, p_month),
    jsonb_build_object('year', p_year, 'month', p_month, 'granted', v_count)
  );
  return v_count;
end $function$;

-- trg_request_step_activated_notify()
...
begin
  if lower(p_kind) = 'announcement' then
    ...
    select jsonb_build_object(
      ...
      'postType', 'recognition', 'authorName', coalesce(nom.full_name_ar, '�?§�?�?�?¥�?¯�?§�?±�?©'),
    ...
    raise exception '�?�?ع ع�?صر غ�?ر �?دع�?�?' using errcode='22023';
  end if;

  if v_result is null then
    raise exception 'ا�?ع�?صر غ�?ر �?�?ج�?د أ�? غ�?ر �?رئ�?' using errcode='P0002';
  end if;
  return v_result;
end;
$function$;
...
begin
  ...
  if p_request_type not in ('leave','mission','convoy','fundraising','late_permit','early_permit','attendance_correction','attendance_permit','generic') then
    raise exception '�?�?ع ط�?ب غ�?ر صا�?ح' using errcode = '22023';
  end if;
  ...
  begin
    case p_request_type
      ...
      when 'mission', 'convoy', 'fundraising' then
        ...
        v_end_date := nullif(v_payload->>'endDate', '')::date;
        if v_start_date is null or v_end_date is null then
          raise exception 'تار�?خا بدا�?ة �?�?�?ا�?ة ا�?ت�?�?�?ف �?ط�?�?با�?' using errcode = '22023';
        end if;
        if v_end_date < v_start_date then
          raise exception 'تار�?خ �?�?ا�?ة ا�?ت�?�?�?ف �?ا �?سب�? تار�?خ ا�?بدا�?ة' using errcode = '22023';
        end if;
        if not v_day_mark and v_start_date < v_today then
          raise exception 'ا�?ت�?�?�?فات بأثر رجع�? غ�?ر �?س�?�?حة' using errcode = '22023';
        end if;
        if length(trim(coalesce(v_payload->>'location', ''))) < 2 then
          raise exception 'assignment location is required' using errcode = '22023';
        end if;
        -- �?�?�?�?�?ª �?�?�?®�?·�?· �?§�?®�?ª�?�?�?§�?±�?�? �?¨�?µ�?�?�?º�?© HH:MM â�?�? �?�?�?±�?�?¶ "9:00"
      ...
      -- â�?�?â�?�?â�?�? �?¥�?°�?�? �?ª�?£�?®�?�?�?± (V17 �?§8) â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?
      when 'late_permit' then
        ...
        if v_permit_date is null then
          raise exception 'تار�?خ ا�?إذ�? �?ط�?�?ب' using errcode = '22023';
        end if;
        ...
        if v_minutes is null or v_minutes < 1 or v_minutes > 240 then
          raise exception 'د�?ائ�? ا�?إذ�? �?جب أ�? ت�?�?�? ب�?�? 1 �?240' using errcode = '22023';
        end if;
        v_payload := v_payload || jsonb_build_object(
      ...
      -- â�?�?â�?�?â�?�? �?¥�?°�?�? �?§�?�?�?µ�?±�?§�? �?�?�?¨�?�?�?± (V17 �?§8) â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?
      ...
      -- â�?�?â�?�?â�?�? �?¥�?°�?�? �?­�?¶�?�?�?± �?�?�?�?�?­�?¯ (0379) â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?
      when 'attendance_permit' then
        ...
        if v_permit_date < v_today then
          raise exception 'إذ�? ا�?حض�?ر بأثر رجع�? غ�?ر �?س�?�?ح' using errcode = '22023';
        end if;
        if v_permit_kind not in ('late_arrival','early_departure') then
          raise exception '�?�?ع إذ�? غ�?ر �?دع�?�?' using errcode = '22023';
        end if;
        if v_minutes is null or v_minutes < 1 or v_minutes > 240 then
          raise exception 'د�?ائ�? ا�?إذ�? �?جب أ�? ت�?�?�? ب�?�? 1 �?240' using errcode = '22023';
        end if;
      ...
      -- â�?�?â�?�?â�?�? �?ª�?µ�?­�?�?�?­ �?­�?¶�?�?�?± (V17 �?§8) â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?
      when 'attendance_correction' then
        ...
        if v_correction_date is null then
          raise exception 'تار�?خ ا�?تصح�?ح �?ط�?�?ب' using errcode = '22023';
        end if;
        if v_correction_type not in ('check_in','check_out','both') then
          raise exception '�?�?ع ا�?تصح�?ح �?جب أ�? �?�?�?�? حض�?ر أ�? ا�?صراف أ�? �?�?ا�?�?ا' using errcode = '22023';
        end if;
  ...
  exception
    when invalid_text_representation or datetime_field_overflow then
      raise exception 'ت�?ار�?خ أ�? �?�?�? ر�?�?�?ة غ�?ر صا�?حة' using errcode = '22023';
  end;
...
AS $function$
  select case p_type
    ...
    when 'mission' then '�?أ�?�?ر�?ة'
    when 'convoy' then '�?اف�?ة'
    when 'fundraising' then 'فا�?د�?'
    when 'late_permit' then 'إذ�? تأخ�?ر'
    when 'early_permit' then 'إذ�? ا�?صراف �?ب�?ر'
    when 'attendance_correction' then 'تصح�?ح حض�?ر'
    else coalesce(p_type, '')
  end;
$function$;
...
begin
  ...
  if v_req.requested_by is distinct from v_me and not public.current_is_full_access() then
    raise exception '�?�?�?�?�? إ�?غاء ط�?بات �?�?�?ع�? ف�?ط' using errcode = '42501';
  end if;
  if v_req.status not in ('pending', 'accepted') then
    raise exception '�?ا �?�?�?�? إ�?غاء ا�?ط�?ب بحا�?ت�? ا�?حا�?�?ة' using errcode = '22023';
  end if;
  ...
  if v_req.employee_id is not null and v_req.employee_id <> v_me then
    perform public.notify_employee(
      v_req.employee_id, '�?£�?�?�?�?º�?�? �?·�?�?�?¨ �?�?�?´�?§�?±�?�?�?© �?�?�?�?�?�?�?¹�?�?',
      format('�?£�?�?�?�?º�?�? �?·�?�?�?¨ �?�?�?´�?§�?±�?�?�?© �?§�?�?�?�?�?�?�?�?�?¹ �?§�?�?�?­�?�?�?�? (�?§�?�?�?­�?§�?�?�?©: %s)', coalesce(v_req.status, '')),
...
-- approve_offboarding_case(uuid,text,text)
CREATE OR REPLACE FUNCTION public.approve_offboarding_case(p_case_id uuid, p_final_settlement_reference text DEFAULT NULL::text, p_exit_interview_notes text DEFAULT NULL::text)
 RETURNS void
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
 ...
 perform public.log_audit_event('offboarding.completed','workflow','warning','offboarding_cases',p_case_id,'ا�?ت�?ا�? إ�?�?اء خد�?ة �?�?ظف',null,jsonb_build_object('employeeId',v.employee_id));
 if v.handover_employee_id is not null and v.handover_employee_id <> public.current_employee_id() then
  perform public.notify_employee(
   v.handover_employee_id,
   'ا�?ت�?ا�? إ�?�?اء خد�?ة �? تس�?�?�? ا�?�?�?ا�?',
   'ا�?ت�?�? إ�?�?اء خد�?ة أحد ا�?ز�?�?اء ا�?�?س�?�?�?�?ة إ�?�?�?�? راجع �?�?ا�? ا�?تس�?�?�? �?أ�?�?�? إجراءات�?.',
...
begin
  ...
  -- �?ªº�?ä�?ª¬�?ª�?£�?ª�?�?è�?ü �?ªº�?ä�?ªº�?ü�?ª¬�?ª�?�?ªº�?ª�?¢�?è �?ä�?ª�?�?è�?ª�? �?ªº�?ä�?ª�?£�?à�?ä
  if p_workflow_definition_id is not null then
    ...
    -- 0474: �?�?ظف �?س�? �?عز�?�? (ا�?إدارة ا�?طب�?ة) �?ستخد�? تعر�?ف�? أحاد�? ا�?خط�?ة
  ...
  -- �?ª�?�?å�?ª�?¤�?ªº�?ªí �?ª«�?ª�?�?ê�?ªº�?ª¬ �?ªº�?ä�?ª¼�?ªº�?ª�?�?è�?ª�?
  if v_def.id is not null then
    insert into public.request_steps (
      request_id, workflow_step_id, step_order, name_ar, step_type,
      assignee_employee_id, assignee_role_slug, status, sla_hours,
  ...
  v_label := format('%s �?�?ö %s',
    public.request_type_label(v_row.request_type),
    coalesce(v_row.title, ''));

  -- �?ª�?�?ª�?¤�?ª�?£�?ªº�?ª�? �?ªº�?ä�?à�?ª»�?è�?ª�? �?ªº�?ä�?à�?ª¿�?ªº�?ª�?¤�?ª�? (�?ªú�?ê�?ä �?ª«�?ª�?�?ê�?ª�? �?å�?ª�?¤�?ª�?�?ª�?)
  select s.assignee_employee_id into v_first_approver
  from public.request_steps s
  ...
  if v_first_approver is not null and v_first_approver <> v_row.employee_id then
    perform public.notify_employee(
      v_first_approver,
      '�?ª�?�?ä�?ª¿ �?ª¼�?ª»�?è�?ª» �?ª¿�?ªº�?å�?ª¬�?ª�?�?ªº�?ª�? �?à�?ª�?�?ªº�?ª¼�?ª�?£�?ª¬�?â',
      v_label,
  ...
  -- �?ª�?�?ª�?¤�?ª�?£�?ªº�?ª�? �?ªº�?ä�?à�?ª»�?è�?ª�? �?ªº�?ä�?ª¬�?å�?ü�?è�?ª�?�?è �?�?ö �?ª�?�?å�?ª¿�?ªº�?ç �?â�?ªº�?à�?ä �?ªº�?ä�?ª�?¤�?ªº�?ª�?¤�?ª�? �?ª�?£�?ä�?ë �?â�?ä �?ª�?�?ä�?ª¿ �?ª¼�?ª»�?è�?ª»
  v_exec_emp := public.first_active_employee_for_role('executive-director');
  if v_exec_emp is not null
     and v_exec_emp <> v_row.employee_id
     and v_exec_emp is distinct from v_first_approver then
    perform public.notify_executive_fullscreen(
      '�?ª�?�?ä�?ª¿ �?ª¼�?ª»�?è�?ª» �?�?ö �?ä�?ä�?à�?ª�?�?ªº�?ª¼�?ª�?£�?ª�?',
      v_label,
      'request',
      'request', v_row.id,
      '/requests/' || v_row.id,
...
-- tg_fundraising_attendance_exempt()
...
begin
  ...
  while v_day <= v_end_date loop
    ...
    select v_employee_id, ad.id, v_day, 'manual_adjustment',
           'فا�?د�? �?عت�?د �? إعفاء �?�? ا�?تأخ�?ر/ا�?غ�?اب',
           'approved', auth.uid()
    from public.attendance_daily ad
  ...
  perform public.log_audit_event(
    ...
    'إعفاء حض�?ر بعد اعت�?اد فا�?د�?',
    format('�?�? %s إ�?�? %s', v_start_date, v_end_date),
...
-- get_employee_monthly_attendance_statement(uuid,integer,integer)
...
begin
  ...
  -- ا�?ص�?اح�?ة: full-access أ�? �?ص�?�? �?طا�?�? فع�?�? (ا�?�?د�?ر ا�?�?باشر/ا�?إدارة/HR/ا�?ت�?ف�?ذ�?)
  -- بص�?اح�?ة �?راءة ا�?حض�?ر أ�? ا�?ت�?ار�?ر �? ب�?طا�? self �?ا �?�?ر (�?ا �?ُر�? س�?�? ا�?�?�?ظف �?فس�?).
  if not (
    public.current_is_full_access()
    ...
    raise exception 'FORBIDDEN: �?ا ت�?�?�? ص�?اح�?ة رؤ�?ة �?شف �?ذا ا�?�?�?ظف' using errcode = '42501';
  end if;
...
begin
  ...
  if not v_has_cron then
    insert into public.system_alerts(
      ...
      'pg_cron �?ª�?�?è�?ª�? �?à�?ü�?ª�?£�?æ�?ä �?ü�?è �?ª¿�?è�?ªª�?ª�? �?ªº�?ä�?ª¬�?ª�?¤�?ª�?�?è�?ä',
      '�?ä�?ªº �?è�?à�?â�?å �?ª¼�?ª»�?ê�?ä�?ª�? �?ªº�?ä�?à�?ç�?ªº�?à �?ªº�?ä�?ª¡�?ª�?�?ª¼�?ª�? �?ª¡�?ª¬�?ë �?ª¬�?ü�?ª�?£�?è�?ä pg_cron �?ªú�?ê �?ª¬�?ê�?ª½�?è�?é �?ª¿�?ª»�?è�?ä �?ª«�?ªº�?ª�?�?ª¼�?è �?à�?ª�?£�?ª¬�?à�?ª».',
  ...
  if coalesce(cardinality(v_missing), 0) > 0 then
    insert into public.system_alerts(
      ...
      '�?à�?ç�?ªº�?à cron �?ª¡�?ª�?�?ª¼�?ª�? �?ª�?�?è�?ª�? �?à�?ª¼�?ª»�?ê�?ä�?ª�? �?ªú�?ê �?ª�?�?è�?ª�? �?å�?ª�?¤�?ª�?�?ª�?',
      '�?ªº�?ä�?à�?ç�?ªº�?à �?ªº�?ä�?à�?ü�?é�?ê�?ª»�?ª�?: ' || array_to_string(v_missing, ', '),
      'cron',
  ...
  -- �?ö�?�?ö�? 0467: �?ª¬�?ªú�?ª«�?ª�? �?ª�?�?ªº�?ª¡�?ª¿ �?ªº�?ä�?ª�?�?ª�?¤�?ª�?£�?ªº�?ª�?�?ªº�?ª¬ (�?è�?ª�?£�?à�?ä �?â�?ä �?ª»�?é�?è�?é�?ª�?) �?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?
  ...
  if coalesce(v_dispatch_last_success, '-infinity'::timestamptz)
    ...
    insert into public.system_alerts(
      ...
      '�?ª�?�?ªº�?ª¡�?ª¿ �?ªº�?ä�?ª�?�?ª�?¤�?ª�?£�?ªº�?ª�?�?ªº�?ª¬ �?à�?ª¬�?ê�?é�?ü �?ª�?£�?å �?ªº�?ä�?å�?ª¼�?ªº�?ª¡',
      '�?ä�?à �?è�?ª�?�?ª¼�?æ�?ä hr_notification_dispatch �?ªú�?è �?ª¬�?ª�?¤�?ª�?�?è�?ä �?å�?ªº�?ª¼�?ª¡ �?ª«�?ä�?ªº�?ä �?ªó�?ª«�?ª�? 10 �?ª»�?é�?ªº�?ªª�?é�?ª¢ �?ª�?�?ª�?¤�?ª�?£�?ªº�?ª�?�?ªº�?ª¬ �?ªº�?ä�?ª�?�?ªº�?ª¿�?ê�?ª�? �?é�?ª» �?ª¬�?ª¬�?ªú�?ª«�?ª�? �?ªú�?ê �?ª¬�?ª¬�?ª�?�?ªº�?â�?à.',
      'cron',
      jsonb_build_object(
  ...
  -- �?ö�?�?ö�? 0467: �?ª¬�?ªú�?ª«�?ª�? �?ª�?�?ªº�?ª¿�?ê�?ª�? �?ªº�?ä�?ª¬�?â�?ªº�?à�?ä�?ªº�?ª¬ (�?ªº�?ä�?ª�?£�?ªº�?à�?ä �?è�?ª�?£�?à�?ä �?â�?ä 5 �?ª»�?é�?ªº�?ªª�?é) �?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?
  ...
  if coalesce(v_outbox_oldest_pending, '-infinity'::timestamptz)
    ...
    insert into public.system_alerts(
      ...
      '�?ª�?�?ªº�?ª¿�?ê�?ª�? �?ªº�?ä�?ª¬�?â�?ªº�?à�?ä�?ªº�?ª¬ �?à�?ª¬�?ªú�?ª«�?ª�?',
      '�?ª¬�?ê�?ª¼�?ª» �?ª�?¡�?ü�?ê�?ü integration_outbox �?ª¿�?ªº�?å�?ª¬�?ª�?�?ªº�?ª�? �?ªº�?ä�?à�?ª�?£�?ªº�?ä�?ª¼�?ª�? �?à�?å�?ª�? �?ªú�?â�?ª½�?ª�? �?à�?å 15 �?ª»�?é�?è�?é�?ª�? �?�?ö �?ª¬�?ª¡�?é�?é �?à�?å worker �?ªú�?ê �?å�?é�?ª�?�?ª�? �?ªº�?ä�?ªº�?ª�?�?ª¬�?é�?ª¿�?ªº�?ä.',
      'cron',
      jsonb_build_object(
        'category', 'queue_health',
  ...
  -- �?ö�?�?ö�? 0467: �?ü�?è�?ª�?¢ �?ª�?�?ª�?¤�?ª�?£�?ªº�?ª�?�?ªº�?ª¬ push �?ªº�?ä�?ü�?ªº�?ª�?¤�?ä�?ª�? �?ª«�?ä�?ªº�?ä �?ªú�?ª�?�?ª¿�?ê�?ª�?£ �?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?�?ö�?
  select count(*)
  ...
  if v_failed_push_7d >= 50 then
    insert into public.system_alerts(
      ...
      '�?ª¬�?ª�?�?ªº�?â�?à �?ª�?�?ª�?¤�?ª�?£�?ªº�?ª�?�?ªº�?ª¬ push �?ü�?ªº�?ª�?¤�?ä�?ª�?',
      '�?ü�?ª�?¤�?ä ' || v_failed_push_7d::text || ' �?ª�?�?ª�?¤�?ª�?£�?ªº�?ª�? push �?ª«�?ä�?ªº�?ä �?ªó�?ª«�?ª�? 7 �?ªú�?è�?ªº�?à �?�?ö �?ª�?�?ªº�?ä�?ª¿�?ªº�?ï �?ª�?�?è�?ªº�?ª¿ �?ª¬�?ê�?â�?å�?ªº�?ª¬ FCM �?ª�?¡�?ªº�?ä�?ª¡�?ª�? �?ªú�?ê �?ª�?£�?ª�?�?ä �?ü�?è �?ªº�?ä�?ª¬�?ª�?�?ä�?è�?à.',
      'cron',
...
-- tg_request_approved_attendance_exempt()
...
begin
  ...
  -- تجا�?�? ا�?إجازات �? �?�?ا تر�?جر خاص (tg_leave_attendance_on_approval)
  ...
  -- �?�?�? ا�?�?أ�?�?ر�?ة/ا�?�?اف�?ة/ا�?فا�?د�?: �?راءة ا�?ت�?ار�?خ �?�? payload ا�?ط�?ب �?�?�?�?�?�?�?�?�?�?
  if new.request_type in ('mission', 'convoy', 'fundraising') then
    ...
    while v_day <= v_end_date loop
      ...
      -- سج�? استث�?اء: �?أ�?�?ر�?ة �?عت�?دة
      insert into public.attendance_exceptions (
        employee_id, attendance_daily_id, work_date, kind, description, status, created_by
      )
      select v_employee_id, ad.id, v_day, 'manual_adjustment',
             '�?أ�?�?ر�?ة �?عت�?دة �? إعفاء �?�? ا�?تأخ�?ر/ا�?غ�?اب',
             'approved', auth.uid()
      from public.attendance_daily ad
      where ad.employee_id = v_employee_id and ad.work_date = v_day
      on conflict do nothing;
  ...
  -- �?�?�? إذ�? تأخ�?ر/ا�?صراف: �?راءة permitDate �?�? payload �?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?�?
  if new.request_type in ('late_permit', 'early_permit') then
    ...
    if new.request_type = 'late_permit' then
      ...
      values (v_employee_id, v_work_date, 'late',
              'إذ�? تأخ�?ر �?عت�?د �? إعفاء �?�? د�?ائ�? ا�?تأخ�?ر',
              0, 'approved', auth.uid())
      on conflict do nothing;
    else
      -- إذ�? ا�?صراف �?ب�?ر: سج�? استث�?اء
      insert into public.attendance_exceptions (
        employee_id, work_date, kind, description, minutes_adjustment, status, created_by
      )
    ...
    perform public.log_audit_event(
      'request.attendance_exempted', 'workflow', 'info',
      'attendance_daily', v_employee_id,
      'إعفاء حض�?ر بعد اعت�?اد ط�?ب',
      format('ا�?�?�?ع: %s�? ا�?تار�?خ: %s', new.request_type, v_work_date),
      jsonb_build_object('requestId', new.id, 'requestType', new.request_type, 'workDate', v_work_date)
    );
    return new;
  end if;

  -- أ�?�?اع أخر�? (attendance_correction) �? �?ا �?عا�?ج�?ا
  return new;
end;
$function$;
...
begin
  if not (public.current_is_full_access() or public.has_permission('onboarding.journey.manage')) then
    raise exception 'إدارة ا�?ت�?�?ئة �?رف�?ضة' using errcode = '42501';
  end if;
  ...
  if exists(select 1 from public.onboarding_journeys j where j.employee_id = p_employee_id and j.status in ('not_started','in_progress')) then
    raise exception 'ا�?�?�?ظف �?د�?�? رح�?ة ت�?�?ئة �?شطة با�?فع�?' using errcode = '23505';
  end if;
...
-- notify_document_signature_request()
...
AS $function$
BEGIN
  -- ا�?حارس: ا�?�?ستدع�? إ�?�?ا صاحب ا�?سج�?�? أ�? �?ا�?�? ا�?�?ص�?�?�? أ�? HR�? أ�? �?�? �?ص�?�?
  -- إدار�? �?�?�?�?ظف ا�?�?ست�?دف. غ�?ر ذ�?�? �?ُرفض (تج�?�?ب �?شف ب�?ا�?ات �?�?ظف آخر).
  IF NOT (
    ...
    RAISE EXCEPTION 'ERR_FORBIDDEN: �?ا ص�?اح�?ة �?عرض أ�?سا�? �?ذا ا�?�?�?ظف'
      USING ERRCODE = '42501';
  END IF;
...
-- complete_live_location_response(uuid,double precision,double precision,numeric,text,timestamp with time zone)
CREATE OR REPLACE FUNCTION public.complete_live_location_response(p_request_id uuid, p_latitude double precision, p_longitude double precision, p_accuracy numeric, p_address text DEFAULT NULL::text, p_captured_at timestamp with time zone DEFAULT now())
 RETURNS live_location_requests
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
begin
  ...
  for v_rec in
    ...
    where ad.first_check_in is not null
      ...
      -- �?�?�? �?غط�?�? ب�?أ�?�?ر�?ة/�?اف�?ة/فا�?د�?/ت�?�?�?ف �?عت�?د = ع�?�? خارج�? �? �?ا �?ُصف�?�? �?�?�?ص
      and not exists (
        select 1 from public.requests r
    ...
    if v_now > v_deadline then
      ...
      if found then
        ...
        select
          ...
          v_rec.work_date,
          'missing_check_out',
          'بص�?ة خر�?ج �?ف�?�?دة �? أُ�?شئ ت�?�?ائ�?ا�? ب�?اسطة finalize_missing_checkouts'
        where not exists (
          select 1
        ...
        perform public.log_audit_event(
          ...
          'بص�?ة خر�?ج �?ف�?�?دة �? تصف�?ة ت�?�?ائ�?ة', null,
          jsonb_build_object(
...
-- _build_attendance_statement_v252(uuid,integer,integer)
  ...
  loop
    ...
    select jsonb_build_object(
             'kindLabel', case p.kind
                            when 'arrival'   then 'إذ�? حض�?ر �?تأخر'
                            when 'departure' then 'إذ�? ا�?صراف �?ب�?ر'
                            else 'إذ�? شخص�?'
                          end,
             'permitKind', p.kind,
    ...
    select jsonb_build_object(
             'typeLabel', case c.correction_type
                            when 'missing_check_in'  then 'تصح�?ح �?س�?ا�? بص�?ة حض�?ر'
                            when 'missing_check_out' then 'تصح�?ح �?س�?ا�? بص�?ة ا�?صراف'
                            when 'wrong_time'        then 'تصح�?ح �?�?ت بص�?ة'
                            when 'wrong_status'      then 'تصح�?ح حا�?ة ا�?�?�?�?'
                            when 'mission'           then 'تصح�?ح (�?أ�?�?ر�?ة)'
                            when 'leave'             then 'تصح�?ح (إجازة)'
                            else 'تصح�?ح حض�?ر'
                          end,
...
-- _build_attendance_statement_v251(uuid,integer,integer)
...
begin
  ...
  loop
    ...
    v_day_obj := v_day_obj || jsonb_build_object(
      ...
      'missingCheckOut', v_missing_out,
      'notes', case
        when v_is_open then 'ت�? تسج�?�? ا�?حض�?ر �?ا�?�?رد�?ة �?ا زا�?ت �?فت�?حة'
...
begin
  ...
  -- â�?�?â�?�? �?�?�?�?�?�? �?§�?�?�?�?�?£�?�?�?�?�?±�?�?�?© (0450 + 0452 �?£�?�?�?�?�?�?�?�?�?© �?ª�?¹�?¯�?¯ �?§�?�?�?�?�?£�?�?�?�?�?±�?�?�?§�?ª) â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?â�?�?
  select coalesce(s.shift_end_time, time '18:00') into v_cutoff
    from public.attendance_settings s where s.singleton_key;
  v_cutoff := coalesce(v_cutoff, time '18:00');
...
-- admin_create_task(text,text,uuid,text,date)
CREATE OR REPLACE FUNCTION public.admin_create_task(p_title text, p_description text DEFAULT NULL::text, p_assignee_id uuid DEFAULT NULL::uuid, p_priority text DEFAULT 'medium'::text, p_due_date date DEFAULT NULL::date)
 RETURNS uuid
 LANGUAGE plpgsql
 SET search_path TO 'public', 'pg_temp'
AS $function$
...
BEGIN
  IF NOT (
    ...
    RAISE EXCEPTION 'ERR_FORBIDDEN: إ�?شاء ا�?�?�?ا�? �?تط�?ب ص�?اح�?ة tasks.write أ�? operations.mission.manage'
      USING ERRCODE = '42501';
  END IF;
...
-- admin_transition_task(uuid,text)
CREATE OR REPLACE FUNCTION public.admin_transition_task(p_id uuid, p_status text)
 RETURNS void
 LANGUAGE plpgsql
 SET search_path TO 'public', 'pg_temp'
AS $function$
BEGIN
  IF NOT (
    ...
    RAISE EXCEPTION 'ERR_FORBIDDEN: تغ�?�?ر حا�?ة ا�?�?�?ا�? �?تط�?ب tasks.write أ�? operations.mission.manage'
      USING ERRCODE = '42501';
  END IF;
...
begin
  if p_latitude not between -90 and 90 or p_longitude not between -180 and 180 then
    raise exception 'إحداث�?ات غ�?ر صا�?حة' using errcode = '22023';
  end if;
  if p_accuracy is null or p_accuracy < 0 or p_accuracy > 10000 then
    raise exception 'د�?ة ا�?�?�?�?ع غ�?ر صا�?حة' using errcode = '22023';
  end if;
...
-- register_live_location_video(uuid,text,integer,bigint,text,double precision,double precision,double precision)
...
AS $function$
begin
  raise exception 'VIDEO_MODE_DISABLED: �?ضع ا�?ف�?د�?�? �?�?غ�? �?�?ائ�?�?ا بس�?اسة V12 §9'
    using errcode = '22023';
end $function$;

-- submit_my_service_request(uuid,text,text,text,jsonb)
CREATE OR REPLACE FUNCTION public.submit_my_service_request(p_catalog_item_id uuid, p_title text, p_description text, p_priority text DEFAULT 'normal'::text, p_payload jsonb DEFAULT '{}'::jsonb)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'auth'
AS $function$ declare v_emp uuid:=public.current_employee_id(); v_id uuid; v_sla integer; begin if v_emp is null then raise exception 'EMPLOYEE_CONTEXT_REQUIRED'; end if; select sla_hours into v_sla from public.service_catalog_items where id=p_catalog_item_id and active; if not found then raise exception 'SERVICE_NOT_AVAILABLE'; end if; insert into public.service_requests(catalog_item_id,requester_employee_id,title,description,payload,priority,due_at,created_by) values(p_catalog_item_id,v_emp,trim(p_title),nullif(trim(p_description),''),coalesce(p_payload,'{}'::jsonb),p_priority,now()+make_interval(hours=>v_sla),auth.uid()) returning id into v_id; perform public.notify_employees_with_permission('service.request.manage','ط�?ب خد�?ة جد�?د',format('ط�?ب خد�?ة: %s', trim(p_title)),'service','normal','service_requests',v_id,'{}'::jsonb,v_emp); return v_id; end $function$;

-- _build_attendance_statement_v287(uuid,integer,integer)
...
begin
  ...
  loop
    ...
    v_day_obj := v_day_obj || jsonb_strip_nulls(jsonb_build_object(
      ...
      'status', case
        when extract(isodow from v_day) = 5 then 'راحة أسب�?ع�?ة'
        when v_type = 'holiday' then 'عط�?ة رس�?�?ة'
        when v_type = 'rest' then 'راحة أسب�?ع�?ة'
        when (v_override.id is null) and coalesce((v_day_obj->>'hasMission')::boolean, false) then '�?أ�?�?ر�?ة'
        when (v_override.id is null) and coalesce((v_day_obj->>'hasConvoyFundi')::boolean, false)
             and v_day_obj->>'status' = 'فا�?د�?' then 'فا�?د�?'
        when (v_override.id is null) and coalesce((v_day_obj->>'hasConvoyFundi')::boolean, false) then '�?اف�?ة'
        when v_type = 'leave' then 'إجازة �?عت�?دة'
        when v_type = 'mission' then '�?أ�?�?ر�?ة'
        when v_type = 'convoy' then '�?اف�?ة'
        when v_type = 'fundraising' then 'فا�?د�?'
        when v_type = 'absent' then 'غائب د�?�? إذ�?'
        ...
        when v_is_future then '�?�?�? �?اد�?'
        when v_check_in is not null and v_check_out is null then 'حاضر �? با�?تظار ا�?ا�?صراف'
        when v_check_in is not null and v_check_out is not null and v_work_minutes < v_required_minutes then 'حاضر �? ساعات غ�?ر �?�?ت�?�?ة'
