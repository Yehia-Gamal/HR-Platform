-- ============================================================================
-- 0361: إصلاح منطق excused_absent في get_attendance_dashboard
-- ============================================================================
-- المشكلة (0355):
...
as $function$
  with params as (
    ...
    -- غائب لكن لديه event (بصمة جزئية) = مبرر
    -- ملاحظة: من لديه approved_leave لا يصل هنا أصلاً (مُصنَّف 'on_leave' في derived)
