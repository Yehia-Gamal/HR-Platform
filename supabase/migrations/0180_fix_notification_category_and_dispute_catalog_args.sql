-- 0178: إصلاح مشكلتين:
--   1) notifications_category_check لا يشمل 'device' → إضافته
--   2) get_dispute_operations_catalog يتجاوز حد 100 وسيط → تقسيم jsonb_build_object بـ ||

begin;

-- ═══════════════════════════════════════════════════════════════════════
-- 1. إضافة 'device' إلى notifications category CHECK
-- ═══════════════════════════════════════════════════════════════════════

-- الـ CHECK الأصلي (mig 0008) مجهول الاسم — PostgreSQL يسميه notifications_category_check تلقائياً
...
-- ═══════════════════════════════════════════════════════════════════════
-- 2. إصلاح get_dispute_operations_catalog: تقسيم jsonb_build_object
--    الدالة الحالية تمرر أكثر من 100 وسيط — الحل: تقسيم إلى جزئين بـ ||
-- ═══════════════════════════════════════════════════════════════════════
