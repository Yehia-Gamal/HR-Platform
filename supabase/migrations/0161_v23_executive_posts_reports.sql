-- Migration 0161: V23 Task-10 — Extended post types, author info, attendance overview, HR reports
begin;
...
begin
  ...
  perform public.log_audit_event(
    ...
    jsonb_build_object('title',v_row.title,'priority',v_row.priority,'postType',v_row.post_type,'hasBanner', v_row.banner_url is not null)
  );
  return v_row;
end;
$fn$;
