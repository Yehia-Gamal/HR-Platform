-- 0143: تصحيح سياسة البصمة — تظهر لجميع المستخدمين ما عدا المدير التنفيذي فقط
-- سابقاً كانت مخفية عن HR والأدمين الرئيسي أيضاً.
-- التغييرات:
--   1. selfPunchEnabled / attendanceRequired / liveLocationResponseEnabled → تستثني التنفيذي فقط
--   2. مساحة عمل employee تُمنح لكل من لديه employee_id (بما فيهم HR والأدمين)
