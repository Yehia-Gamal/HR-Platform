-- 0196: السكرتير التنفيذي موظف يحتاج بصمة — أزل استثناء main_admin من سياسة الحضور.
-- الأدوار الإدارية (executive-secretary, admin, ...) موظفين عاديين من ناحية الحضور.
-- فقط المدير التنفيذي (executive/executive-director) لا يحتاج بصمة.
