...
class MobileStatusPill extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final meta = switch (value) {
      ...
      'manager_review' => ('مراجعة المدير', AppColors.statusViolet),
      'hr_review' => ('مراجعة HR', AppColors.statusInfo),
      'manager_final' => ('اعتماد المدير (قديم)', AppColors.statusWarning),
      'secretary' => ('عند السكرتير', AppColors.statusInfo),
      'executive' => ('مراجعة تنفيذية', AppColors.statusWarning),
...
/// صفحة "ويب فقط" — تُعرض عندما يحاول المدير الوصول إلى ميزة إدارية
/// متاحة فقط عبر لوحة الويب.
class MobileWebOnlyPage extends StatelessWidget {
  const MobileWebOnlyPage({required this.featureName, super.key});
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'هذه الميزة متاحة فقط عبر لوحة الويب.\nافتح النظام من المتصفح على الحاسوب للوصول إليها.',
