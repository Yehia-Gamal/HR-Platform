...
class PasskeyAttendanceService {
  ...
  String _humanize(String code) => switch (code) {
    ...
    'device_not_active' =>
      'هذا الجهاز غير مفعّل. سجّل بصمة الجهاز من صفحة الحضور أو تواصل مع المسؤول.',
    'device_revoked' =>
      'تم إلغاء صلاحية هذا الجهاز. سجّل جهازاً جديداً أو تواصل مع المسؤول.',
    'device_replaced' =>
      'تم استبدال هذا الجهاز بجهاز آخر. استخدم الجهاز الجديد.',
    'no_active_device' =>
      'لا يوجد جهاز نشط مرتبط بحسابك. سجّل جهازاً من صفحة أجهزة البصمة.',
