...
const ERROR_PATTERNS: Array<[RegExp, string]> = [
  // تقييد زمني — مراحل الموافقة على الطلبات
  [
    /not_authorized.*مهلة المدير|لا يزال في مهلة المدير/i,
    'الطلب في مهلة المدير المباشر (ساعتان). يمكنك اتخاذ إجراء بعد انقضاء الوقت أو إذا صعّد النظام الطلب إلى مرحلتك.',
  ],
  [/not_authorized.*مرحلة المدير/i, 'الطلب لا يزال في مرحلة المدير المباشر. ستصلك إشعار عند تصعيده.'],
  ...
  [/INSUFFICIENT_LEAVE_BALANCE/i, 'رصيد الإجازة غير كافٍ لهذا الطلب — اربط يوم البدل بعمل يوم الجمعة أو تواصل مع الموارد البشرية.'],
  [/CONSUME_EXCEEDS_RESERVE/i, 'تعارض في رصيد الإجازات. أعد المحاولة بعد لحظات.'],
  [/LEAVE_UNITS_ZERO/i, 'مدة الإجازة المطلوبة تساوي صفرًا.'],
  [/INVALID_LEAVE_DURATION/i, 'مدة الإجازة المطلوبة غير صالحة.'],
  ...
  // أخطاء إدارة الأدوار (rpc_assign_role / rpc_revoke_role / rpc_upsert_role)
  [/not authorized to assign roles/i, 'ليس لديك صلاحية إسناد الأدوار. تواصل مع مدير النظام.'],
  [/not authorized to revoke roles/i, 'ليس لديك صلاحية سحب الأدوار. تواصل مع مدير النظام.'],
  [/only super.admin may assign a full.access role/i, 'إسناد الأدوار الكاملة محصور بالمدير الأعلى (super-admin) فقط.'],
  [/cannot self.grant full access/i, 'لا يمكنك منح نفسك صلاحية كاملة.'],
  [/HR may only assign employee, manager, or operations roles/i, 'قسم الموارد البشرية لا يُسند سوى أدوار الموظف/المدير/التشغيل فقط.'],
  [/role not found/i, 'الدور المطلوب غير موجود. أعد تحميل الصفحة.'],
