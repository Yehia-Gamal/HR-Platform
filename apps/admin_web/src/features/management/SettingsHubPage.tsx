...
/**
 * مركز الإعدادات الموحّد — إعدادات النظام العامة + إعدادات التشغيل
 * بتبويبات. المسار القديم system-settings يُحوَّل هنا.
 */

const TABS = [
  { key: 'general', label: 'عام' },
  { key: 'operations', label: 'إعدادات التشغيل' },
] as const;
...
export function SettingsHubPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      {tab === 'operations' ? <SystemSettingsPage /> : <SettingsPage />}
    </div>
  );
}
