...
const mockCatalog = {
  objectives: [
    { id: 'obj-1', code: 'OBJ-001', title: 'الهدف الأول', progress: 50, status: 'active' },
  ],
  projects: [
    { id: 'proj-1', code: 'PRJ-001', name: 'مشروع التطوير', openTasks: 3, progress: 25, status: 'active' },
  ],
  risks: [
    { id: 'risk-1', title: 'مخاطرة تشغيلية', score: 8, category: 'تشغيلي', status: 'open' },
  ],
  serviceRequests: [
    { id: 'sr-1', title: 'طلب خدمة', status: 'open' },
  ],
  qualityCases: [
    { id: 'qc-1', title: 'حالة جودة', number: 'QC-001', severity: 'medium', status: 'open' },
  ],
  meetings: [],
  audits: [],
  incidents: [],
...
describe('EnterpriseManagementPage', () => {
  it('يُعرض بدون أخطاء', () => {
    ...
    const { container } = render(<Wrapper><EnterpriseManagementPage /></Wrapper>);
    expect(container.firstChild).toBeTruthy();
  });

  it('يعرض عنوان الصفحة', () => {
    catalogReturn = dataQuery;
    render(<Wrapper><EnterpriseManagementPage /></Wrapper>);
