...
export function PerformancePage() {
  ...
  return <div className="space-y-6">
    ...
    {counts.overdue > 0 ? <section className="flex items-center gap-3 rounded-2xl border border-amber-300 bg-amber-50 p-4 text-amber-950"><AlertTriangle className="size-5 shrink-0" aria-hidden="true" /><p className="font-bold">{counts.overdue} تقييم متأخر عن الموعد النهائي — يُرجى المتابعة مع المديرين والموظفين المعنيين.</p></section> : null}
