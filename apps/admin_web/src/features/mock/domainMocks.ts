...
export const mockAttendanceStatement: AttendanceStatement = {
  ...
  days: [
    { date: '2026-07-01', dayNameAr: 'الأربعاء', checkIn: '08:02:00', checkOut: '16:05:00', shiftName: 'الفترة الصباحية', workHours: 8.0, lateMinutes: 2, earlyLeaveMinutes: 0, overtimeMinutes: 5, status: 'حاضر', isAbsent: false, isOfficialHoliday: false, hasLeave: false, hasMission: false, hasLatePermit: false, hasEarlyPermit: false, hasPermit: false, hasConvoyFundi: false, missingCheckIn: false, missingCheckOut: false, hasCorrection: false, correctionNote: null, penalties: 0 },
    { date: '2026-07-02', dayNameAr: 'الخميس', checkIn: null, checkOut: null, shiftName: null, workHours: null, lateMinutes: 0, earlyLeaveMinutes: 0, overtimeMinutes: 0, status: 'راحة أسبوعية', isAbsent: false, isOfficialHoliday: false, hasLeave: false, hasMission: false, hasLatePermit: false, hasEarlyPermit: false, hasPermit: false, hasConvoyFundi: false, missingCheckIn: false, missingCheckOut: false, hasCorrection: false, correctionNote: null, penalties: 0 },
    { date: '2026-07-03', dayNameAr: 'الجمعة', checkIn: null, checkOut: null, shiftName: null, workHours: null, lateMinutes: 0, earlyLeaveMinutes: 0, overtimeMinutes: 0, status: 'راحة أسبوعية', isAbsent: false, isOfficialHoliday: false, hasLeave: false, hasMission: false, hasLatePermit: false, hasEarlyPermit: false, hasPermit: false, hasConvoyFundi: false, missingCheckIn: false, missingCheckOut: false, hasCorrection: false, correctionNote: null, penalties: 0 },
  ],
  summary: {
    totalDays: 31, scheduledDays: 22, presentDays: 18, absentDays: 1,
    leaveDays: 2, permitCount: 1, missionDays: 1, convoyFundiDays: 0,
    holidayDays: 0, restDays: 9, totalWorkHours: 142.5, totalRequiredHours: 176,
    averageWorkHours: 7.9, totalLateMinutes: 28, totalEarlyLeaveMinutes: 12,
    totalOvertimeMinutes: 35, missingCheckInCount: 1, missingCheckOutCount: 0,
    correctionCount: 1, attendanceRate: 81.8, hoursComplianceRate: 80.9,
  },
};
...
export const mockAttendanceStatement: AttendanceStatement = {
  ...
  days: [
    { date: '2026-07-01', dayNameAr: 'الأربعاء', shiftName: 'الوردية الصباحية', checkIn: '08:02:00', checkOut: '16:05:00', status: 'حاضر', workHours: 8.0, lateMinutes: 2, earlyLeaveMinutes: 0, overtimeMinutes: 5, isAbsent: false, isOfficialHoliday: false, hasLeave: false, hasMission: false, hasLatePermit: false, hasEarlyPermit: false, hasPermit: false, hasConvoyFundi: false, missingCheckIn: false, missingCheckOut: false, hasCorrection: false, correctionNote: null, penalties: 0 },
    { date: '2026-07-02', dayNameAr: 'الخميس', shiftName: 'الوردية الصباحية', checkIn: '08:00:00', checkOut: '16:00:00', status: 'حاضر', workHours: 8.0, lateMinutes: 0, earlyLeaveMinutes: 0, overtimeMinutes: 0, isAbsent: false, isOfficialHoliday: false, hasLeave: false, hasMission: false, hasLatePermit: false, hasEarlyPermit: false, hasPermit: false, hasConvoyFundi: false, missingCheckIn: false, missingCheckOut: false, hasCorrection: false, correctionNote: null, penalties: 0 },
    { date: '2026-07-03', dayNameAr: 'الجمعة', shiftName: null, checkIn: null, checkOut: null, status: 'راحة أسبوعية', workHours: null, lateMinutes: 0, earlyLeaveMinutes: 0, overtimeMinutes: 0, isAbsent: false, isOfficialHoliday: false, hasLeave: false, hasMission: false, hasLatePermit: false, hasEarlyPermit: false, hasPermit: false, hasConvoyFundi: false, missingCheckIn: false, missingCheckOut: false, hasCorrection: false, correctionNote: null, penalties: 0 },
  ],
  summary: {
    totalDays: 31, scheduledDays: 26, presentDays: 22, absentDays: 1,
    leaveDays: 2, permitCount: 1, missionDays: 1, convoyFundiDays: 0,
    holidayDays: 0, restDays: 5, totalWorkHours: 174.5, totalRequiredHours: 208,
    averageWorkHours: 7.9, totalLateMinutes: 18, totalEarlyLeaveMinutes: 5,
    totalOvertimeMinutes: 45, missingCheckInCount: 0, missingCheckOutCount: 1,
    correctionCount: 0, attendanceRate: 84.6, hoursComplianceRate: 83.9,
  },
};
