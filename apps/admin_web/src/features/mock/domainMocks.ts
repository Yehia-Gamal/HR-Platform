...
const rosterItem = (
  ...
  employeeCode: string,
  status: string | null,
  partial: Partial<AttendanceRosterItem> = {},
): AttendanceRosterItem => ({
  employeeId,
  employeeName,
  employeeCode,
...
export const mockAttendanceRoster: Record<AttendanceRosterCategory, AttendanceRosterItem[]> = {
  scheduled: [
    rosterItem('30000000-0000-4000-8000-000000000001', 'أحمد محمود', 'EMP-104', 'present', {
      firstCheckIn: iso(-7),
      lastCheckOut: iso(-1),
      departmentName: 'الحسابات',
    }),
    rosterItem('30000000-0000-4000-8000-000000000002', 'محمود علي', 'EMP-087', 'late', {
      lateMinutes: 25,
      firstCheckIn: iso(-6),
      lastCheckOut: iso(-1),
      departmentName: 'البرامج الميدانية',
    }),
    rosterItem('30000000-0000-4000-8000-000000000003', 'سارة حسن', 'EMP-132', 'absent', { departmentName: 'الموارد البشرية' }),
    rosterItem('30000000-0000-4000-8000-000000000004', 'ليلى إبراهيم', 'EMP-041', 'present', {
      firstCheckIn: iso(-8),
      lastCheckOut: iso(-1),
      departmentName: 'الإعلام والتوثيق',
    }),
  ],
  present: [
    rosterItem('30000000-0000-4000-8000-000000000001', 'أحمد محمود', 'EMP-104', 'present', {
    ...
    rosterItem('30000000-0000-4000-8000-000000000005', 'خالد سعيد', 'EMP-118', 'present', {
      firstCheckIn: iso(-9),
      lastCheckOut: iso(-1),
      departmentName: 'خدمات الشباب',
    }),
  ...
  late: [
    ...
    rosterItem('30000000-0000-4000-8000-000000000006', 'نور هاني', 'EMP-076', 'late', {
      lateMinutes: 12,
      firstCheckIn: iso(-5),
      lastCheckOut: iso(-1),
      departmentName: 'خدمات الشباب',
  ...
  unexcused_absent: [rosterItem('30000000-0000-4000-8000-000000000007', 'عمر فتحي', 'EMP-053', 'absent', { departmentName: 'البرامج الميدانية' })],
  incomplete: [
  ...
  location_responded: [
    rosterItem('30000000-0000-4000-8000-000000000001', 'أحمد محمود', 'EMP-104', 'present', {
      locationRequestStatus: 'accepted',
      firstCheckIn: iso(-7),
      lastCheckOut: iso(-1),
      departmentName: 'الحسابات',
    }),
  ...
  on_leave: [
    rosterItem('30000000-0000-4000-8000-000000000009', 'هند سمير', 'EMP-140', 'on_leave', {
      hasApprovedLeave: true,
      leaveCode: 'annual',
      leaveIsPaid: true,
      departmentName: 'الموارد البشرية',
    }),
    rosterItem('30000000-0000-4000-8000-000000000010', 'ياسر كامل', 'EMP-151', 'on_leave', {
      hasApprovedLeave: true,
      leaveCode: 'casual',
      leaveIsPaid: true,
      departmentName: 'البرامج الميدانية',
  ...
  employees: [
    {
      ...
      avatarUrl: null,
      assignmentType: null,
      managerName: 'عبد الرحمن سالم',
      activeRequestStatus: 'accepted',
      activeRequestId: '41000000-0000-4000-8000-000000000101',
      lateMinutes: null,
      lastLatitude: 30.0444,
      lastLongitude: 31.2357,
      lastAccuracy: 12,
      lastAddressAr: 'القاهرة — وسط البلد',
      lastLocationAt: iso(-1),
      checkInAt: iso(-7),
      checkOutAt: null,
    },
    {
      ...
      jobTitle: 'مصورة صحفية',
      status: 'present',
      avatarUrl: null,
      assignmentType: null,
      managerName: 'سامح فؤاد',
      activeRequestStatus: 'active',
      activeRequestId: '41000000-0000-4000-8000-000000000102',
      lateMinutes: null,
      lastLatitude: 30.0549,
      lastLongitude: 31.2403,
      lastAccuracy: 9,
      lastAddressAr: 'القاهرة — الأوبرا',
      lastLocationAt: iso(-1),
      checkInAt: iso(-8),
      checkOutAt: null,
    },
    {
      ...
      managerName: 'سامح فؤاد',
      activeRequestStatus: 'accepted',
      activeRequestId: '41000000-0000-4000-8000-000000000103',
      lateMinutes: null,
      lastLatitude: 30.0609,
      lastLongitude: 31.2201,
      lastAccuracy: 15,
      lastAddressAr: 'الجيزة — المنيل',
      lastLocationAt: iso(-1),
      checkInAt: iso(-9),
      checkOutAt: null,
    },
    ...
    },
    {
      ...
      jobTitle: 'منسق ميداني',
      status: 'late',
      avatarUrl: null,
      assignmentType: null,
      managerName: 'طارق زيدان',
      activeRequestStatus: 'pending',
      activeRequestId: '41000000-0000-4000-8000-000000000104',
      lateMinutes: 25,
      lastLatitude: 30.034,
      lastLongitude: 31.204,
      lastAccuracy: 20,
      lastAddressAr: 'الجيزة — فيصل',
      lastLocationAt: iso(-1),
      checkInAt: iso(-6),
      checkOutAt: null,
    },
    {
      ...
      name: 'نور هاني',
      employeeCode: 'EMP-076',
      department: 'خدمات الشباب',
      jobTitle: 'أخصائي أنشطة',
      status: 'late',
      avatarUrl: null,
      assignmentType: null,
      managerName: 'سامح فؤاد',
      ...
      lastLongitude: 31.23,
      lastAccuracy: 11,
      lastAddressAr: 'القاهرة — مدينة نصر',
      lastLocationAt: iso(-1),
      checkInAt: iso(-5),
      checkOutAt: null,
    },
...
// entityType/entityId/metadata تطابق ما تكتبه دوال الخلفية فعلاً — بدونها
// كانت المعاينة المحلية لا تُظهر سلوك الروابط العميقة للإشعارات.
export const mockNotifications = [
  ...
  },
  {
    ...
    actionUrl: null,
    entityType: 'decision',
    entityId: '44000000-0000-4000-8000-000000000002',
    metadata: {},
    isRead: false,
    createdAt: iso(-6),
  },
  {
    ...
    title: 'غرامة تأخير جديدة',
    body: 'سُجِّلت غرامة تأخير بقيمة 50 ج.م.',
    category: 'system',
    priority: 'high' as const,
    actionUrl: null,
    entityType: 'instant_penalty',
    entityId: '35000000-0000-4000-8000-000000000001',
    metadata: { amount: 50, workDate: '2026-09-18' },
    isRead: false,
    createdAt: iso(-3),
  },
  {
    ...
    entityId: '36000000-0000-4000-8000-000000000001',
    metadata: { workDate: '2026-09-18', employeeId: '10000000-0000-4000-8000-000000000001' },
    isRead: false,
    createdAt: iso(-9),
  },
  {
