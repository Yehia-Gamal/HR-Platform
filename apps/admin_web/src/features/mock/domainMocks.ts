...
export const mockAttendanceStatement: AttendanceStatement = {
  ...
  days: [
    { date: '2026-07-01', dayNameAr: 'الأربعاء', checkIn: '08:02:00', checkOut: '16:05:00', shiftName: 'الفترة الصباحية', workHours: 8.0, requiredHours: 8, lateMinutes: 2, earlyLeaveMinutes: 0, overtimeMinutes: 5, status: 'حاضر', isAbsent: false, isOfficialHoliday: false, hasLeave: false, hasMission: false, hasLatePermit: false, hasEarlyPermit: false, hasPermit: false, hasConvoyFundi: false, missingCheckIn: false, missingCheckOut: false, hasCorrection: false, correctionNote: null, notes: null, penalties: 0 },
    { date: '2026-07-02', dayNameAr: 'الخميس', checkIn: null, checkOut: null, shiftName: '', workHours: 0, requiredHours: 0, lateMinutes: 0, earlyLeaveMinutes: 0, overtimeMinutes: 0, status: 'راحة أسبوعية', isAbsent: false, isOfficialHoliday: false, hasLeave: false, hasMission: false, hasLatePermit: false, hasEarlyPermit: false, hasPermit: false, hasConvoyFundi: false, missingCheckIn: false, missingCheckOut: false, hasCorrection: false, correctionNote: null, notes: null, penalties: 0 },
    { date: '2026-07-03', dayNameAr: 'الجمعة', checkIn: null, checkOut: null, shiftName: '', workHours: 0, requiredHours: 0, lateMinutes: 0, earlyLeaveMinutes: 0, overtimeMinutes: 0, status: 'راحة أسبوعية', isAbsent: false, isOfficialHoliday: false, hasLeave: false, hasMission: false, hasLatePermit: false, hasEarlyPermit: false, hasPermit: false, hasConvoyFundi: false, missingCheckIn: false, missingCheckOut: false, hasCorrection: false, correctionNote: null, notes: null, penalties: 0 },
  ],
  summary: {
