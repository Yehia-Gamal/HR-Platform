        ...
        <div className="space-y-8 text-sm text-[var(--text)] leading-relaxed">
          ...
          <section className="space-y-2">
            ...
            <p className="text-[var(--text-muted)]">
              يُعد استخدامك لمنصة الويب أو تطبيق الهاتف المحمول الخاص بنظام «أحلى شباب» إقراراً وموافقة صريحة على الالتزام بكافة الشروط والأحكام واللوائح
              التنظيمية الموضحة أدناه، بالإضافة إلى السياسات الداخلية للمؤسسة.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p className="text-[var(--text-muted)]">
              الحساب الممنوح لكل موظف هو حساب شخصي ومخصص لأغراض العمل الرسمية فقط. يُحظر مشاركة بيانات الدخول أو كلمات المرور أو مفاتيح المرور (Passkeys) مع أي
              شخص آخر، ويتحمل صاحب الحساب المسؤولية القانونية والإدارية الكاملة عن أي إجراء أو توقيع أو تسجيل يتم من خلال حسابه.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p className="text-[var(--text-muted)]">
              تُعتبر التوقيعات الرقمية المنفذة عبر موديول التوقيع بالمنظومة أو الموافقات الصادرة عبر حسابات المدراء والإدارة ذات حجية قانونية وإدارية ملزمة
              ونافذة، ويتم توثيق كل حركة بالوقت والتاريخ وعنوان الـ IP وسجل التدقيق غير القابل للتعديل (Immutable Audit Trail).
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p className="text-[var(--text-muted)]">
              تحتفظ المنشأة بالحق في إيقاف أو تعليق وصول أي حساب فور إنهاء علاقة العمل أو انتهاء العقد أو بناءً على قرار من لجنة الانضباط والحوكمة، مع تسوية
              كافة العهد والمستحقات عبر نموذج إخلاء الطرف المعتمد.
            </p>
          </section>
