    ...
    <div className="min-h-screen bg-[var(--surface-muted)] py-12 px-4 sm:px-6 lg:px-8 text-right font-sans" dir="rtl">
      <div className="max-w-4xl mx-auto bg-[var(--surface)] p-8 sm:p-12 rounded-3xl shadow-xl border border-[var(--border)]">
        ...
        <div className="flex items-center justify-between border-b border-[var(--border)] pb-6 mb-8">
          ...
          <button type="button" onClick={() => navigate(-1)} className="btn-secondary text-xs flex items-center gap-1.5 py-2 px-3">
        ...
        <div className="space-y-8 text-sm text-[var(--text)] leading-relaxed">
          ...
          <section className="space-y-2">
            ...
            <p className="text-[var(--text-muted)]">
              تلتزم منظومة «أحلى شباب» بحماية خصوصية وأمان بيانات الموظفين والمستخدمين بأعلى المعايير المهنية والقانونية. تهدف هذه السياسة إلى توضيح كيفية جمع
              واستخدام وتخزين وحماية بياناتكم عند استخدام منصة الويب وتطبيق الهاتف الذكي المخصص للموظفين.
            </p>
          </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
              <div className="p-4 rounded-2xl border border-[var(--border)] bg-[var(--surface-muted)]/50 space-y-2">
                ...
                <p className="text-xs text-[var(--text-muted)]">
                  تُطلب إحداثيات الموقع (GPS) حصراً عند قيام الموظف بتسجيل الحضور والانصراف (Punch) للتحقق من التواجد الفعلي داخل النطاق الجغرافي المعتمد للفرع
                  أو موقع العمل الميداني. لا يتم تتبع الموقع بشكل مستمر في الخلفية إلا عند تفعيل جلسة تتبع المهام الميدانية الرسمية المصرح بها من الإدارة.
                </p>
              </div>
              ...
              <div className="p-4 rounded-2xl border border-[var(--border)] bg-[var(--surface-muted)]/50 space-y-2">
                ...
                <p className="text-xs text-[var(--text-muted)]">
                  تُستخدم الكاميرا حصراً لالتقاط صورة التحقق الحية (Selfie Verification) أثناء إثبات الحضور ومطابقة الهوية لمنع تسجيل الحضور بالنيابة، أو لرفع
                  صور المستندات والتقارير والعهد.
                </p>
              </div>
              ...
              <div className="p-4 rounded-2xl border border-[var(--border)] bg-[var(--surface-muted)]/50 space-y-2">
                ...
                <p className="text-xs text-[var(--text-muted)]">
                  تُستخدم إشعارات FCM وإشعارات الويب لإرسال التنبيهات التشغيلية الحيوية مثل: قرارات قبول أو رفض الإجازات، إشعارات الورديات، وقسائم الرواتب،
                  والتعاميم الإدارية العاجلة.
                </p>
              </div>
              ...
              <div className="p-4 rounded-2xl border border-[var(--border)] bg-[var(--surface-muted)]/50 space-y-2">
                ...
                <p className="text-xs text-[var(--text-muted)]">
                  يدعم التطبيق المصادقة بالبصمة الحيوية (TouchID/FaceID) أو Passkeys المخزنة محلياً في شريحة الهاتف الآمنة (Secure Enclave). لا تُرسل بيانات
                  بصمة الإصبع أو الوجه إلى خوادمنا إطلاقاً.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p className="text-[var(--text-muted)]">
              تُخزن جميع البيانات داخل خوادم مؤمنة بتشفير AES-256 أثناء التخزين، وتشفير TLS 1.3 أثناء النقل. تخضع قواعد البيانات لسياسات أمان صارمة على مستوى
              الصف (Row-Level Security) بحيث لا يمكن لأي مستخدم الوصول إلى بيانات غير مصرح له بها.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p className="text-[var(--text-muted)]">
              نحن لا نبيع أو نؤجر أو نشارك أي بيانات شخصية للموظفين مع أي أطراف إعلانية أو تجارية خارجية. البيانات مخصصة حصرياً لإدارة العمليات الداخلية وتنظيم
              شؤون الموظفين وفقاً للوائح العمل.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p className="text-[var(--text-muted)]">
              يحق للموظف طلب تصحيح بياناته أو تقديم طلب حذف الحساب الشخصي من خلال التواصل مع مسؤول الموارد البشرية بالمنشأة، أو عبر خيار تقديم التماس في بوابة
              النزاعات والخدمة الذاتية بالتطبيق.
            </p>
          </section>
