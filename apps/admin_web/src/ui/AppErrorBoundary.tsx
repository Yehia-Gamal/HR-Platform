    ...
    return (
      <main className="grid min-h-screen place-items-center bg-[var(--page-bg)] p-5" dir="rtl">
        <section className="card w-full max-w-xl p-7 text-center sm:p-9" role="alert">
          ...
          <span className="mx-auto grid size-14 place-items-center rounded-2xl bg-[var(--danger-soft)] text-[var(--danger)]"><AlertTriangle className="size-6" /></span>
          ...
          <button type="button" className="btn-primary mx-auto mt-6" onClick={this.recover}><RefreshCcw className="size-4" />إعادة تحميل المنصة</button>
        </section>
      </main>
    );
  }
