...
const ITEMS: CommandItem[] = [
  ...
  { label: 'تفاصيل الحضور', path: 'attendance/details', group: 'الحضور' },
  { label: 'تشغيل الحضور', path: 'attendance/operations', group: 'الحضور' },
  { label: 'تقرير الحضور', path: 'attendance/report', group: 'الحضور' },
  ...
  { label: 'التقارير', path: 'reports', group: 'الأداء والتقارير' },
  { label: 'جدولة التقارير', path: 'reports/scheduler', group: 'الأداء والتقارير', adminOnly: true },
  { label: 'التحليلات', path: 'analytics', group: 'الأداء والتقارير' },
  ...
  { label: 'استوديو المستندات', path: 'documents/studio', group: 'المعرفة والتعلم' },
  ...
  { label: 'الغرامات', path: 'finance/penalties', group: 'المالية', adminOnly: true },
  { label: 'إنستاباي', path: 'finance/instapay', group: 'المالية', adminOnly: true },
