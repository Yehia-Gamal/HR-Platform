...
describe('FilterBar', () => {
  it('يعرض حقل البحث مع placeholder', () => {
    render(
      <FilterBar searchValue="" onSearchChange={() => {}} searchPlaceholder="ابحث عن موظف..." />,
    );
  ...
  it('يستدعي onSearchChange عند الكتابة', () => {
    ...
    render(
      <FilterBar searchValue="" onSearchChange={onChange} searchPlaceholder="ابحث..." />,
    );
  ...
  it('يحتوي على aria-label للوصولية', () => {
    const { container } = render(
      <FilterBar searchValue="" onSearchChange={() => {}} searchPlaceholder="ابحث..." />,
    );
